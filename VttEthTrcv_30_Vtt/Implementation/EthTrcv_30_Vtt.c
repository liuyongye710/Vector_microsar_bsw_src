...
# define ETHTRCV_30_VTT_TESTSUITE_SUPPORT_DISABLED_COMMENT
/**********************************************************************************************************************
 *  VERSION CHECK
 *********************************************************************************************************************/
/* Check consistency of source and header file. */
#if (                                                 \
      (ETHTRCV_30_VTT_SW_MAJOR_VERSION != 5u) || \
      (ETHTRCV_30_VTT_SW_MINOR_VERSION != 1u) || \
      (ETHTRCV_30_VTT_SW_PATCH_VERSION != 0u)    \
    )
...
STATIC VAR(EthTrcv_StateType, ETHTRCV_30_VTT_VAR_ZERO_INIT) EthTrcv_30_Vtt_State = ETHTRCV_STATE_UNINIT;
#endif
...
{
#if ( ETHTRCV_30_VTT_DEV_ERROR_DETECT == STD_ON )
  EthTrcv_30_Vtt_State = ETHTRCV_STATE_UNINIT;
#endif
  /* ETHTRCV_30_VTT_DEV_ERROR_DETECT == STD_ON */
}
...
#if ( ETHTRCV_30_VTT_DEV_ERROR_DETECT == STD_ON )
  EthTrcv_30_Vtt_State = ETHTRCV_STATE_INIT;
#endif

  for(trcvIdx = 0; trcvIdx < ETHTRCV_30_VTT_MAX_TRCVS_TOTAL; trcvIdx++)
  {
...
#if ( ETHTRCV_30_VTT_DEV_ERROR_DETECT == STD_ON )
  EthTrcv_30_Vtt_State = ETHTRCV_STATE_ACTIVE;
#endif
  /* ETHTRCV_30_VTT_DEV_ERROR_DETECT == STD_ON */
  EthTrcv_30_Vtt_Mode[TrcvIdx] = ETHTRCV_MODE_DOWN;
  ...
  P2VAR(uint8, AUTOMATIC, ETHTRCV_30_VTT_APPL_DATA) SignalQualityPtr)
{
  EthTrcv_30_Vtt_CheckDetErrorReturnValue(
    (ETHTRCV_30_VTT_MAX_TRCVS_TOTAL > TrcvIdx),
    TrcvIdx,
    ETHTRCV_30_VTT_API_ID_GET_PHY_SIGNAL_QUALITY,
    ETHTRCV_30_VTT_E_INV_TRCV_IDX,
    E_NOT_OK);
  EthTrcv_30_Vtt_CheckDetErrorReturnValue(
    (EthTrcv_30_Vtt_State == ETHTRCV_STATE_ACTIVE),
    ...
    E_NOT_OK);
  EthTrcv_30_Vtt_CheckDetErrorReturnValue(
    (EthTrcv_30_Vtt_Mode[TrcvIdx] == ETHTRCV_MODE_ACTIVE),
    TrcvIdx,
    ETHTRCV_30_VTT_API_ID_GET_PHY_SIGNAL_QUALITY,
    ETHTRCV_30_VTT_E_NOT_INITIALIZED,
    E_NOT_OK);
  EthTrcv_30_Vtt_CheckDetErrorReturnValue(
    (NULL_PTR != SignalQualityPtr),
    TrcvIdx,
    ETHTRCV_30_VTT_API_ID_GET_PHY_SIGNAL_QUALITY,
    ETHTRCV_30_VTT_E_INV_POINTER,
    E_NOT_OK);
  ...
  ETHTRCV_30_VTT_DUMMY_STATEMENT(TrcvIdx); /* PRQA S 3199 */ /* MD_MSR_14.2  */
  ETHTRCV_30_VTT_DUMMY_STATEMENT(SignalQualityPtr); /* PRQA S 3199 */ /* MD_MSR_14.2  */
    ...
    EthTrcv_PhyTxModeType TxMode)
{
  EthTrcv_30_Vtt_CheckDetErrorReturnValue(
    (ETHTRCV_30_VTT_MAX_TRCVS_TOTAL > TrcvIdx),
    TrcvIdx,
    ETHTRCV_30_VTT_API_ID_SET_PHY_TX_MODE,
    ETHTRCV_30_VTT_E_INV_TRCV_IDX,
    E_NOT_OK);
  EthTrcv_30_Vtt_CheckDetErrorReturnValue(
    (EthTrcv_30_Vtt_State == ETHTRCV_STATE_ACTIVE),
  ...
  ETHTRCV_30_VTT_DUMMY_STATEMENT(TrcvIdx); /* PRQA S 3199 */ /* MD_MSR_14.2  */
  ETHTRCV_30_VTT_DUMMY_STATEMENT(TxMode); /* PRQA S 3199 */ /* MD_MSR_14.2  */
    ...
    P2VAR(EthTrcv_CableDiagResultType, AUTOMATIC, ETHTRCV_30_VTT_APPL_DATA) CableDiagResultPtr)
{
  EthTrcv_30_Vtt_CheckDetErrorReturnValue(
    (ETHTRCV_30_VTT_MAX_TRCVS_TOTAL > TrcvIdx),
    TrcvIdx,
    ETHTRCV_30_VTT_API_ID_GET_CABLE_DIAGNOSTIC_RESULT,
    ETHTRCV_30_VTT_E_INV_TRCV_IDX,
    E_NOT_OK);
  EthTrcv_30_Vtt_CheckDetErrorReturnValue(
    (EthTrcv_30_Vtt_State == ETHTRCV_STATE_ACTIVE),
  ...
  ETHTRCV_30_VTT_DUMMY_STATEMENT(TrcvIdx); /* PRQA S 3199 */ /* MD_MSR_14.2  */
  ETHTRCV_30_VTT_DUMMY_STATEMENT(CableDiagResultPtr); /* PRQA S 3199 */ /* MD_MSR_14.2  */
  ...
  EthTrcv_PhyTestModeType TestMode)
{
  EthTrcv_30_Vtt_CheckDetErrorReturnValue(
    (ETHTRCV_30_VTT_MAX_TRCVS_TOTAL > TrcvIdx),
    TrcvIdx,
    ETHTRCV_30_VTT_API_ID_SET_PHY_TEST_MODE,
    ETHTRCV_30_VTT_E_INV_TRCV_IDX,
    E_NOT_OK);
  EthTrcv_30_Vtt_CheckDetErrorReturnValue(
    (EthTrcv_30_Vtt_State == ETHTRCV_STATE_ACTIVE),
  ...
  ETHTRCV_30_VTT_DUMMY_STATEMENT(TrcvIdx); /* PRQA S 3199 */ /* MD_MSR_14.2  */
  ETHTRCV_30_VTT_DUMMY_STATEMENT(TestMode); /* PRQA S 3199 */ /* MD_MSR_14.2  */
     ...
     EthTrcv_PhyLoopbackModeType LoopbackMode)
{
  EthTrcv_30_Vtt_CheckDetErrorReturnValue(
    (ETHTRCV_30_VTT_MAX_TRCVS_TOTAL > TrcvIdx),
    TrcvIdx,
    ETHTRCV_30_VTT_API_ID_SET_PHY_LOOPBACK_MODE,
    ETHTRCV_30_VTT_E_INV_TRCV_IDX,
    E_NOT_OK);
  EthTrcv_30_Vtt_CheckDetErrorReturnValue(
    (EthTrcv_30_Vtt_State == ETHTRCV_STATE_ACTIVE),
  ...
  ETHTRCV_30_VTT_DUMMY_STATEMENT(TrcvIdx); /* PRQA S 3199 */ /* MD_MSR_14.2  */
  ETHTRCV_30_VTT_DUMMY_STATEMENT(LoopbackMode); /* PRQA S 3199 */ /* MD_MSR_14.2  */
  return E_NOT_OK;
}
     ...
     P2VAR(uint8, AUTOMATIC, ETHTRCV_30_VTT_APPL_DATA)  RevisionNrPtr)
{
  EthTrcv_30_Vtt_CheckDetErrorReturnValue(
    (ETHTRCV_30_VTT_MAX_TRCVS_TOTAL > TrcvIdx),
    TrcvIdx,
    ETHTRCV_30_VTT_API_ID_GET_PHY_IDENTIFIER,
    ETHTRCV_30_VTT_E_INV_TRCV_IDX,
    E_NOT_OK);
  EthTrcv_30_Vtt_CheckDetErrorReturnValue(
    (NULL_PTR != OrgUniqueIdPtr),
    TrcvIdx,
    ETHTRCV_30_VTT_API_ID_GET_PHY_IDENTIFIER,
    ETHTRCV_30_VTT_E_INV_POINTER,
    E_NOT_OK);
  ...
  ETHTRCV_30_VTT_DUMMY_STATEMENT(TrcvIdx); /* PRQA S 3199 */ /* MD_MSR_14.2  */
  ETHTRCV_30_VTT_DUMMY_STATEMENT(OrgUniqueIdPtr); /* PRQA S 3199 */ /* MD_MSR_14.2  */
  ETHTRCV_30_VTT_DUMMY_STATEMENT(ModelNrPtr); /* PRQA S 3199 */ /* MD_MSR_14.2  */
  ETHTRCV_30_VTT_DUMMY_STATEMENT(RevisionNrPtr); /* PRQA S 3199 */ /* MD_MSR_14.2  */
  return E_NOT_OK;
}
  ...
  P2VAR(EthTrcv_LinkStateType, AUTOMATIC, ETHTRCV_30_VTT_APPL_DATA) LinkStatePtr)
{
  ...
  if(EthTrcv_30_Vtt_Mode[TrcvIdx] == ETHTRCV_MODE_ACTIVE)
  {
    ...
    {
      /* internal error - Status of VTTEth invalid */
      *LinkStatePtr = ETHTRCV_LINK_STATE_DOWN;
      retVal = E_NOT_OK;
    }
  }
...
#endif /* ETHTRCV_30_VTT_VERSION_INFO_API */
