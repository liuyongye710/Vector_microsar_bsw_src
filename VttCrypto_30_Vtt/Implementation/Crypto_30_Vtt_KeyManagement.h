 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*      \file  Crypto_30_Vtt_KeyManagement.h
...
#ifndef _CRYPTO_30_VTT_KEYMANAGEMENT_H_
# define _CRYPTO_30_VTT_KEYMANAGEMENT_H_
# include "Csm_Types.h"
 ...
 *  \trace         CREQ-131140
 *********************************************************************************************************************/
extern FUNC(Std_ReturnType, CRYPTO_30_VTT_CODE) Crypto_30_Vtt_KeyCopy(
  uint32 cryptoKeyId,
 ...
 *  \trace         CREQ-131141
 *********************************************************************************************************************/
extern FUNC(Std_ReturnType, CRYPTO_30_VTT_CODE) Crypto_30_Vtt_KeyElementCopy(
  uint32 cryptoKeyId,
  uint32 keyElementId,
  uint32 targetCryptoKeyId,
 ...
 *  \trace         CREQ-131139
 *********************************************************************************************************************/
extern FUNC(Std_ReturnType, CRYPTO_30_VTT_CODE) Crypto_30_Vtt_KeyElementIdsGet(
  uint32 cryptoKeyId,
 ...
 *                 The key element can only be set, if the write access right is WA_ALLOWED or WA_ENCRYPTED for she key update.
 ...
 *  \trace         CREQ-131144
 *********************************************************************************************************************/
extern FUNC(Std_ReturnType, CRYPTO_30_VTT_CODE) Crypto_30_Vtt_KeyElementSet(
  uint32 cryptoKeyId,
  uint32 keyElementId,
 ...
 *  \trace         CREQ-131143
 *********************************************************************************************************************/
extern FUNC(Std_ReturnType, CRYPTO_30_VTT_CODE) Crypto_30_Vtt_KeyValidSet(
  uint32 cryptoKeyId);
 ...
 *  \trace         CREQ-131137
 *********************************************************************************************************************/
extern FUNC(Std_ReturnType, CRYPTO_30_VTT_CODE) Crypto_30_Vtt_RandomSeed(
  uint32 cryptoKeyId,
 ...
 *  \synchronous   TRUE
 *********************************************************************************************************************/
extern FUNC(Std_ReturnType, CRYPTO_30_VTT_CODE) Crypto_30_Vtt_KeyGenerate(
  uint32 cryptoKeyId);
 ...
 *                 For CRYPTO_30_VTT_KDF_ALGO_KDF_SYM_NIST_800_108_CNT_MODE_SHA256 and
 ...
 *                 For CRYPTO_30_VTT_KDF_ALGO_KDF_NIST_800_56_A_ONE_PASS_C1E1S_SINGLE_STEP_KDF_SHA256:
 ...
 *                 For CRYPTO_30_VTT_KDF_ALGO_KDF_ISO_15118_CERTIFICATE_HANDLING:
 ...
 *  \synchronous   TRUE
 *********************************************************************************************************************/
extern FUNC(Std_ReturnType, CRYPTO_30_VTT_CODE) Crypto_30_Vtt_KeyDerive(
  uint32 cryptoKeyId,
  uint32 targetCryptoKeyId);
 ...
 *  \trace         CREQ-132409
 *********************************************************************************************************************/
extern FUNC(Std_ReturnType, CRYPTO_30_VTT_CODE) Crypto_30_Vtt_KeyExchangeCalcPubVal(
  uint32 cryptoKeyId,
 ...
 *  \trace         CREQ-132408
 *********************************************************************************************************************/
extern FUNC(Std_ReturnType, CRYPTO_30_VTT_CODE) Crypto_30_Vtt_KeyExchangeCalcSecret(
  uint32 cryptoKeyId,
 ...
 *  \synchronous   TRUE
 *********************************************************************************************************************/
extern FUNC(Std_ReturnType, CRYPTO_30_VTT_CODE) Crypto_30_Vtt_CertificateParse(
  uint32 cryptoKeyId);
 ...
 *  \synchronous   TRUE
 *********************************************************************************************************************/
extern FUNC(Std_ReturnType, CRYPTO_30_VTT_CODE) Crypto_30_Vtt_CertificateVerify(
  uint32 cryptoKeyId,
  uint32 verifyCryptoKeyId,
  P2VAR(Crypto_VerifyResultType, AUTOMATIC, CRYPTO_30_VTT_APPL_VAR) verifyPtr);

# define CRYPTO_30_VTT_STOP_SEC_CODE
# include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */

#endif /* _CRYPTO_30_VTT_KEYMANAGEMENT_H_ */
/**********************************************************************************************************************
*  END OF FILE: Crypto_30_Vtt_KeyManagement.h
*********************************************************************************************************************/
