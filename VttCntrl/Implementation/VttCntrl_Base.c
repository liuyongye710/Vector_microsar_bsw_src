...
#if (  (VTTCNTRL_SW_MAJOR_VERSION != (12u)) \
...
#if (STD_ON == VTTCNTRL_MODULE_VTTVMEM_EXISTS)
# if (VMEM_30_VTT_SW_MAJOR_VERSION < 3u)       /* Breaking change in DrvMem_vMem_30_VttCanoe01Asr, remove in next major release. */
 vMem_30_Vtt_InitMemory();
# endif
#endif
