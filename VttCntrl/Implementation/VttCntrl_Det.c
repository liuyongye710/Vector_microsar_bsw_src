...
/* vendor specific version information is BCD coded */
    ...
    || (VTTCNTRL_DET_PATCH_VERSION != (0x01)) )
...
/* Initialize DET codes for module vMem*/
STATIC void VTTCntrl_DetInitialization_vMem(void)
{
  CANoeAPI_DetSetModule(255, "vMem");
  CANoeAPI_DetSetFunction(255, 0x00, "vMem_30_Vtt_Init");
  CANoeAPI_DetSetFunction(255, 0x02, "vMem_30_Vtt_Read");
  CANoeAPI_DetSetFunction(255, 0x03, "vMem_30_Vtt_Write");
  CANoeAPI_DetSetFunction(255, 0x04, "vMem_30_Vtt_Erase");
  CANoeAPI_DetSetFunction(255, 0x05, "vMem_30_Vtt_MainFunction");
  CANoeAPI_DetSetFunction(255, 0x06, "vMem_30_Vtt_IsBlank");
  CANoeAPI_DetSetFunction(255, 0x0A, "vMem_30_Vtt_GetJobResult");
  CANoeAPI_DetSetFunction(255, 0x10, "vMem_30_Vtt_GetVersionInfo");
  CANoeAPI_DetSetError(255, 0x00, "VMEM_30_VTT_E_NO_ERROR");
  CANoeAPI_DetSetError(255, 0x0A, "VMEM_30_VTT_E_PARAM_CONFIG");
  CANoeAPI_DetSetError(255, 0x0B, "VMEM_30_VTT_E_PARAM_POINTER");
  CANoeAPI_DetSetError(255, 0x0C, "VMEM_30_VTT_E_PARAM_ADDRESS");    
  CANoeAPI_DetSetError(255, 0x0D, "VMEM_30_VTT_E_PARAM_LENGTH");
  CANoeAPI_DetSetError(255, 0x0E, "VMEM_30_VTT_E_PARAM_BUFFER_ALIGNMENT");
  CANoeAPI_DetSetError(255, 0x10, "VMEM_30_VTT_E_UNINIT");
  CANoeAPI_DetSetError(255, 0x11, "VMEM_30_VTT_E_INITIALIZATION_FAILED");
  CANoeAPI_DetSetError(255, 0x12, "VMEM_30_VTT_E_PARAM_INSTANCE_ID");
  CANoeAPI_DetSetError(255, 0x13, "VMEM_30_VTT_E_PENDING");
}
...
{
  CANoeAPI_DetSetModule(212, "Xcp");
  CANoeAPI_DetSetFunction(212, 0x00, "Xcp_Init");
  CANoeAPI_DetSetFunction(212, 0x03, "Xcp_SendEvent");
  CANoeAPI_DetSetFunction(212, 0x04, "Xcp_PutChar");
  CANoeAPI_DetSetFunction(212, 0x05, "Xcp_Print");
  CANoeAPI_DetSetFunction(212, 0x06, "Xcp_Disconnect");
  CANoeAPI_DetSetFunction(212, 0x07, "Xcp_SendCrm");
  CANoeAPI_DetSetFunction(212, 0x08, "Xcp_GetXcpDataPointer");
  CANoeAPI_DetSetFunction(212, 0x0A, "Xcp_GetVersionInfo");
  CANoeAPI_DetSetFunction(212, 0x0B, "Xcp_TlRxIndication");
  CANoeAPI_DetSetFunction(212, 0x0C, "Xcp_TlTxConfirmation");
  CANoeAPI_DetSetFunction(212, 0x0D, "Xcp_TlQueryMessagePending");
  CANoeAPI_DetSetFunction(212, 0x0E, "Xcp_GetSessionStatus");
  CANoeAPI_DetSetFunction(212, 0x0F, "Xcp_SetActiveTl");
  CANoeAPI_DetSetFunction(212, 0x10, "Xcp_GetActiveTl");
  CANoeAPI_DetSetFunction(212, 0x11, "Xcp_SetStimMode");
  CANoeAPI_DetSetFunction(212, 0x14, "Xcp_ModifyProtectionStatus");
  CANoeAPI_DetSetFunction(212, 0x15, "Xcp_DaqConfigInit");
  CANoeAPI_DetSetFunction(212, 0x16, "Xcp_DaqSetComplementaryChannel");
  CANoeAPI_DetSetFunction(212, 0x17, "Xcp_EventGetDaqSize");
  CANoeAPI_DetSetFunction(212, 0xC8, "Xcp_MainFunction");
  CANoeAPI_DetSetFunction(212, 0xC9, "Xcp_Event");
  CANoeAPI_DetSetFunction(212, 0xFD, "Xcp_StimEventStatus");
  CANoeAPI_DetSetError(212, 0x00, "XCP_E_NO_ERROR");
  CANoeAPI_DetSetError(212, 0x0A, "XCP_E_PARAM_CONFIG");
  CANoeAPI_DetSetError(212, 0x0B, "XCP_E_PARAM_CHANNEL");
  CANoeAPI_DetSetError(212, 0x0C, "XCP_E_PARAM_EVENTCHANNEL");
  CANoeAPI_DetSetError(212, 0x0D, "XCP_E_PARAM_POINTER");
  CANoeAPI_DetSetError(212, 0x0E, "XCP_E_PARAM_VALUE");
  CANoeAPI_DetSetError(212, 0x10, "XCP_E_UNINIT");
  CANoeAPI_DetSetError(212, 0x11, "XCP_E_ALREADY_INITIALIZED");
  CANoeAPI_DetSetError(212, 0x12, "XCP_E_INVALID_CORE_ID");
}
...
STATIC void VTTCntrl_DetInitialization(void) 
{
  ...
  VTTCntrl_DetInitialization_vMem();  
