 ...
 *  Elvan Caliskan                visenc        Vector Informatik GmbH
 *  Max Engelhardt                vismxe        Vector Informatik GmbH
 *  -------------------------------------------------------------------------------------------------------------------
 *  REVISION HISTORY
 *  -------------------------------------------------------------------------------------------------------------------
 ...
 *  \details       This function is referenced in the crypto functions array if the underyling Crypto Driver does not support
 *                 KeyElementCopyPartial Service. This function should never be called and is only existent to overcome
