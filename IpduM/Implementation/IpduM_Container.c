 ...
 *  \synchronous  TRUE
*******************************************************************************************/
IPDUM_LOCAL_INLINE FUNC(Std_ReturnType, IPDUM_CODE) IpduM_ContainerTx_DataQueueInstance_Put(IpduM_CDataQueueInstanceIterType dataQueueInstanceIdx, P2CONST(PduInfoType, AUTOMATIC, IPDUM_APPL_DATA) PduInfoPtr, uint16 writeOffset);
#endif
 ...
 *  \synchronous  TRUE
*******************************************************************************************/
IPDUM_LOCAL_INLINE FUNC(Std_ReturnType, IPDUM_CODE) IpduM_ContainerTx_DataQueueInstance_PutHeader(IpduM_CDataQueueInstanceIterType dataQueueInstanceIdx, uint16 writeOffset, uint32 headerId, uint32 dlc, uint8 headerSize);
#endif
...
/*******************************************************************************************
 *  IpduM_ContainerTx_DataQueueInstance_CopyContainePduIDs2TxConfBuffer()
*******************************************************************************************/
 ...
 *  \synchronous  TRUE
*******************************************************************************************/
IPDUM_LOCAL_INLINE FUNC(void, IPDUM_CODE) IpduM_ContainerTx_DataQueueInstance_CopyContainePduIDs2TxConfBuffer(IpduM_CDataQueueInstanceIterType dataQueueInstanceIdx, IpduM_CTxContainerPduIterType txContainerId);
#endif
...
# if (IPDUM_TXCONFIRMATIONOFTXCONTAINEDPDU == STD_ON)
    IpduM_ContainerTx_DataQueueInstance_CopyContainePduIDs2TxConfBuffer(dataQueueInstanceReadIdx, txContainerId);
# endif
