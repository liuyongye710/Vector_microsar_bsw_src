...
*********************************************************************************************************************/
#if !defined(ETH_30_VTT_CBK_H)
# define ETH_30_VTT_CBK_H
 ...
 **********************************************************************************************************************/
# ifndef ETH_30_VTT_CBK_LOCAL_INLINE
#  define ETH_30_VTT_CBK_LOCAL_INLINE                                LOCAL_INLINE
# endif
/**********************************************************************************************************************
 *  LOCAL FUNCTIONS
 **********************************************************************************************************************/
 ...
 *  \pre          -
 */
ETH_30_VTT_CBK_LOCAL_INLINE FUNC (void, ETH_30_VTT_CODE) Appl_Eth_30_Vtt_MemoryBarrier(void);
...
ETH_30_VTT_CBK_LOCAL_INLINE FUNC (void, ETH_30_VTT_CODE) Appl_Eth_30_Vtt_MemoryBarrier(void)
{
# ifndef ETH_30_VTT_CBK_ACCEPT_EMPTY_IMPLEMENTATION
# error "Please give a proper definition for Appl_Eth_30_Vtt_MemoryBarrier to implement a memory barrier!"
  /* Example implementation:
   * __asm("syncm");
   * __asm("syncp");
   */
# endif /* ETH_30_VTT_CBK_ACCEPT_EMPTY_IMPLEMENTATION */
}
#endif /* ETH_30_VTT_CBK_H */
/**********************************************************************************************************************
 *  END OF FILE: Eth_30_Vtt_Cbk.h
 *********************************************************************************************************************/
