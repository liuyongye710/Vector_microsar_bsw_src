...
#if !defined (ETH_30_TC3XX_HW_ACCESS_INT_H)
# define ETH_30_TC3XX_HW_ACCESS_INT_H
...
# if !defined (ETH_30_TC3XX_HW_ACCESS_LOCAL_INLINE) /* COV_ETH_COMPATIBILITY */
#  define ETH_30_TC3XX_HW_ACCESS_LOCAL_INLINE                        LOCAL_INLINE
# endif /* ETH_30_TC3XX_HW_ACCESS_LOCAL_INLINE */
 ...
 */
ETH_30_TC3XX_HW_ACCESS_LOCAL_INLINE FUNC(Eth_30_Tc3xx_RegBaseAddrType, ETH_30_TC3XX_CODE) Eth_30_Tc3xx_GetRegBaseAddress(
  uint8 ctrlIdx);
 ...
 *  \pre         -
 */
ETH_30_TC3XX_HW_ACCESS_LOCAL_INLINE FUNC(void, ETH_30_TC3XX_CODE) Eth_30_Tc3xx_Reg_Write(
  uint8                     ctrlIdx,
  Eth_30_Tc3xx_RegOffsetType regOffset,
 ...
 *  \pre         -
 */
ETH_30_TC3XX_HW_ACCESS_LOCAL_INLINE FUNC(void, ETH_30_TC3XX_CODE) Eth_30_Tc3xx_Reg_Write_Protected(
  uint8                     ctrlIdx,
  Eth_30_Tc3xx_RegOffsetType regOffset,
  Eth_30_Tc3xx_RegWidthType  regValue);
 ...
 *  \pre         -
 */
ETH_30_TC3XX_HW_ACCESS_LOCAL_INLINE FUNC(Eth_30_Tc3xx_RegWidthType, ETH_30_TC3XX_CODE) Eth_30_Tc3xx_Reg_Read(
  uint8                     ctrlIdx,
  Eth_30_Tc3xx_RegOffsetType regOffset);
 ...
 *  \pre         -
 */
ETH_30_TC3XX_HW_ACCESS_LOCAL_INLINE FUNC(Eth_30_Tc3xx_RegWidthType, ETH_30_TC3XX_CODE) Eth_30_Tc3xx_Reg_Read_Protected(
  uint8                     ctrlIdx,
  Eth_30_Tc3xx_RegOffsetType regOffset);
 ...
 *  \pre         -
 */
ETH_30_TC3XX_HW_ACCESS_LOCAL_INLINE FUNC(Eth_30_Tc3xx_RegWidthType, ETH_30_TC3XX_CODE) Eth_30_Tc3xx_Reg_ReadBits(
  uint8                     ctrlIdx,
  Eth_30_Tc3xx_RegOffsetType regOffset,
 ...
 *  \pre         -
 */
ETH_30_TC3XX_HW_ACCESS_LOCAL_INLINE FUNC(Eth_30_Tc3xx_RegWidthType, ETH_30_TC3XX_CODE) Eth_30_Tc3xx_Reg_ReadBits_Protected(
  uint8                     ctrlIdx,
  Eth_30_Tc3xx_RegOffsetType regOffset,
  Eth_30_Tc3xx_RegWidthType bitMask);
 ...
 *  \pre         -
 */
ETH_30_TC3XX_HW_ACCESS_LOCAL_INLINE FUNC(void, ETH_30_TC3XX_CODE) Eth_30_Tc3xx_Reg_SetBitMask(
  uint8                     ctrlIdx,
  Eth_30_Tc3xx_RegOffsetType regOffset,
  Eth_30_Tc3xx_RegWidthType  bitMask);
 ...
 *  \pre         -
 */
ETH_30_TC3XX_HW_ACCESS_LOCAL_INLINE FUNC(void, ETH_30_TC3XX_CODE) Eth_30_Tc3xx_Reg_SetBitMask_Protected(
  uint8                     ctrlIdx,
  Eth_30_Tc3xx_RegOffsetType regOffset,
  Eth_30_Tc3xx_RegWidthType  bitMask);
 ...
 *  \pre         -
 */
ETH_30_TC3XX_HW_ACCESS_LOCAL_INLINE FUNC(void, ETH_30_TC3XX_CODE) Eth_30_Tc3xx_Reg_ClearBitMask(
  uint8                     ctrlIdx,
  Eth_30_Tc3xx_RegOffsetType regOffset,
  Eth_30_Tc3xx_RegWidthType  bitMask);
 ...
 *  \pre         -
 */
ETH_30_TC3XX_HW_ACCESS_LOCAL_INLINE FUNC(void, ETH_30_TC3XX_CODE) Eth_30_Tc3xx_Reg_ClearBitMask_Protected(
  uint8                     ctrlIdx,
  Eth_30_Tc3xx_RegOffsetType regOffset,
  Eth_30_Tc3xx_RegWidthType  bitMask);
 ...
 *  \pre         -
 */
ETH_30_TC3XX_HW_ACCESS_LOCAL_INLINE FUNC(boolean, ETH_30_TC3XX_CODE) Eth_30_Tc3xx_Reg_IsBitMaskSet_Protected(
  uint8                     ctrlIdx,
  Eth_30_Tc3xx_RegOffsetType regOffset,
  Eth_30_Tc3xx_RegWidthType  bitMask);

/**********************************************************************************************************************
 *  Eth_30_Tc3xx_Reg_Initialize
 *********************************************************************************************************************/
/*! \brief       Initializes the given value in the addressed register with the given access mode
 *  \details     -
 *  \param[in]   ctrlIdx    Identifier of the Ethernet controller
 *               [range: 0 <= ctrlIdx < Eth_30_Tc3xx_GetSizeOfEthCtrl()]
 *  \param[in]   regOffset  Offset in bytes into the Ethernet controllers register space
 *  \param[in]   regValue   Value to be initialized to the register
 *  \param[in]   accessMode Access mode of the to be initialized to register 
 *  \context     ANY
 *  \reentrant   TRUE for different registers
 *  \synchronous TRUE
 *  \pre         -
 */
ETH_30_TC3XX_HW_ACCESS_LOCAL_INLINE FUNC(void, ETH_30_TC3XX_CODE) Eth_30_Tc3xx_Reg_Initialize(
  uint8                     ctrlIdx,
  Eth_30_Tc3xx_RegOffsetType regOffset,
  Eth_30_Tc3xx_RegWidthType  regValue,
  Eth_30_Tc3xx_AccessModeOfRegDataType accessMode);

# ifndef ETH_30_TC3XX_UNIT_TEST_HWACCESS /* COV_ETH_TEST_SUITE_UNIT_TESTS */
...
ETH_30_TC3XX_HW_ACCESS_LOCAL_INLINE FUNC(void, ETH_30_TC3XX_CODE) Eth_30_Tc3xx_Reg_Initialize(
  ...
  Eth_30_Tc3xx_AccessModeOfRegDataType accessMode)
{
  /* #10 Check if user access mode was requested for this initialization */
  if (accessMode == ETH_30_TC3XX_USER_MODE_ACCESSMODEOFREGDATA)
  {
    /* #110 Initialize the given value to the register at the given address offset with user access mode */
      Eth_30_Tc3xx_Reg_Write(ctrlIdx, regOffset, regValue);
  }
  /* #20 Otherwise use protected mode to initialize the register */
  else
  {
    /* #210 Iniatilize the given value to the register at the given address offset with protected access mode */
      Eth_30_Tc3xx_Reg_Write_Protected(ctrlIdx, regOffset, regValue);
  }
}
...
#endif /* ETH_30_TC3XX_HW_ACCESS_INT_H */
