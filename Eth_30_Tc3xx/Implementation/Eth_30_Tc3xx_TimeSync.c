  ...
  uint8 bufIdx)
{
  ...
  if (Eth_30_Tc3xx_IsBusyOfTxBufferState(bufIdx) == TRUE)
  {
    ...
    Eth_30_Tc3xx_SetTsRequestedOfTxBufferState(bufIdx, (boolean)ETH_30_TC3XX_TIMESYNC_TS_REQUESTED);                               /* SBSW_ETH_30_TC3XX_INT_FCT_IDX_PASS */
    retVal = E_OK;
  }
  ...
  P2VAR(Eth_TimestampQualityType, AUTOMATIC, AUTOMATIC) timestampQualityPtr)
{
  ...
  globalRingIdx       = Eth_30_Tc3xx_GetRingIdxOfTxTsContext(bufIdx);
  globalDescrIdx      = Eth_30_Tc3xx_GetDescrIdxOfTxTsContext(bufIdx);
  isBufferBusy  = (Eth_30_Tc3xx_BusyOfTxBufferStateType) Eth_30_Tc3xx_IsBusyOfTxBufferState(bufIdx);
  isTsRequested = (Eth_30_Tc3xx_TsRequestedOfTxBufferStateType) Eth_30_Tc3xx_IsTsRequestedOfTxBufferState(bufIdx);

  if ((isBufferBusy == TRUE) && (isTsRequested == (boolean)ETH_30_TC3XX_TIMESYNC_TS_REQUESTED))
  {
    /* #110 Call the hardware dependent interface to retrieve the egress timestamp if the requested buffer */
    retVal = Eth_30_Tc3xx_LL_TimeSync_GetTxTimeStamp(ctrlIdx, globalRingIdx, globalDescrIdx, timestampPtr);             /* SBSW_ETH_30_TC3XX_INT_FCT_PARAM_PTR_PASS */
  ...
  P2VAR(Eth_TimestampQualityType, AUTOMATIC, AUTOMATIC) timestampQualityPtr)
{
  ...
  if (rxTsContextStackIdx < Eth_30_Tc3xx_GetRxTsContextStackEndIdxOfTsHandling(ctrlIdx))
  {
    ...
    globalRingIdx  = Eth_30_Tc3xx_GetRingIdxOfRxTsContextStack(rxTsContextStackIdx);
    globalDescrIdx = Eth_30_Tc3xx_GetDescrIdxOfRxTsContextStack(rxTsContextStackIdx);
    /* #210 Call the hardware dependent interface to retrieve the ingress timestamp */
    retVal = Eth_30_Tc3xx_LL_TimeSync_GetRxTimeStamp(ctrlIdx, globalRingIdx, globalDescrIdx, timestampPtr);                          /* SBSW_ETH_30_TC3XX_INT_FCT_PARAM_PTR_PASS */
  }
...
# endif /* ETH_30_TC3XX_DEV_ERROR_DETECT */
  {
    ...
    retVal = Eth_30_Tc3xx_Internal_GetGlobalTime(localCtrlIdx, TimestampPtr, TimestampQualityPtr);                            /* SBSW_ETH_30_TC3XX_INT_FCT_PUB_PARAM_PTR_PASS */
  }
...
# if (ETH_30_TC3XX_DEV_ERROR_REPORT == STD_ON)
  ...
  if (errorId != ETH_30_TC3XX_E_NO_ERROR)
  {
    (void)Det_ReportError(
        ETH_30_TC3XX_MODULE_ID, CtrlIdx, ETH_30_TC3XX_TIME_SYNC_SID_GET_GLOBAL_TIME, errorId);
  }
# else
...
# if (ETH_30_TC3XX_DEV_ERROR_DETECT == STD_ON)
  ...
  else if (BufIdx >= Eth_30_Tc3xx_GetBufferNumOfTxBufferHandling(localCtrlIdx))
  {
...
# endif /* ETH_30_TC3XX_DEV_ERROR_DETECT */
  {
    ...
    retVal = Eth_30_Tc3xx_Internal_EnableEgressTimestamp(localCtrlIdx, BufIdx);
  }
...
# if (ETH_30_TC3XX_DEV_ERROR_REPORT == STD_ON)
  ...
  {
    (void)Det_ReportError(
        ETH_30_TC3XX_MODULE_ID, CtrlIdx, ETH_30_TC3XX_TIME_SYNC_SID_ENABLE_EGRESS_TIMESTAMP, errorId);
  }
# else
  ETH_30_TC3XX_DUMMY_STATEMENT(errorId); /* PRQA S 3112 */ /* MD_MSR_DummyStmt */
# endif /* ETH_30_TC3XX_DEV_ERROR_REPORT */
...
# endif /* ETH_30_TC3XX_DEV_ERROR_DETECT */
  {
    ...
    retVal = Eth_30_Tc3xx_Internal_GetEgressTimestamp(localCtrlIdx, BufIdx, TimestampPtr, TimestampQualityPtr);               /* SBSW_ETH_30_TC3XX_INT_FCT_PUB_PARAM_PTR_PASS */
  }
...
# if (ETH_30_TC3XX_DEV_ERROR_REPORT == STD_ON)
  ...
  {
    (void)Det_ReportError(
        ETH_30_TC3XX_MODULE_ID, CtrlIdx, ETH_30_TC3XX_TIME_SYNC_SID_GET_EGRESS_TIMESTAMP, errorId);
  }
# else
  ETH_30_TC3XX_DUMMY_STATEMENT(errorId); /* PRQA S 3112 */ /* MD_MSR_DummyStmt */
# endif /* ETH_30_TC3XX_DEV_ERROR_REPORT */
...
FUNC(Std_ReturnType, ETH_30_TC3XX_CODE) Eth_30_Tc3xx_GetIngressTimestamp(
        uint8                                           CtrlIdx,
  P2VAR(Eth_DataType,             AUTOMATIC, AUTOMATIC) DataPtr, /* PRQA S 3673 */ /* MD_MSR_Rule8.13 */
  P2VAR(Eth_TimeStampType,        AUTOMATIC, AUTOMATIC) TimestampPtr,
  P2VAR(Eth_TimestampQualityType, AUTOMATIC, AUTOMATIC) TimestampQualityPtr)
{
  /* ----- Local Variables ---------------------------------------------- */
  ...
  ETH_30_TC3XX_DUMMY_STATEMENT(DataPtr); /* PRQA S 3112 */ /* MD_MSR_DummyStmt */
...
# endif /* ETH_30_TC3XX_DEV_ERROR_DETECT */
  {
    ...
    retVal = Eth_30_Tc3xx_Internal_GetIngressTimestamp(localCtrlIdx, TimestampPtr, TimestampQualityPtr);                      /* SBSW_ETH_30_TC3XX_INT_FCT_PUB_PARAM_PTR_PASS */
  }
...
# if (ETH_30_TC3XX_DEV_ERROR_REPORT == STD_ON)
  ...
  {
    (void)Det_ReportError(
        ETH_30_TC3XX_MODULE_ID, CtrlIdx, ETH_30_TC3XX_TIME_SYNC_SID_GET_INGRESS_TIMESTAMP, errorId);
  }
# else
  ETH_30_TC3XX_DUMMY_STATEMENT(errorId); /* PRQA S 3112 */ /* MD_MSR_DummyStmt */
# endif /* ETH_30_TC3XX_DEV_ERROR_REPORT */
