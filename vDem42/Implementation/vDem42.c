...
#if (  (VDEM42_SW_MAJOR_VERSION != (2u)) \
    || (VDEM42_SW_MINOR_VERSION != (0u)) \
    || (VDEM42_SW_PATCH_VERSION != (0u)) )
# error "Vendor specific version numbers of vDem42.c and vDem42.h are inconsistent"
#endif

#if (  (VDEM42_TYPES_MAJOR_VERSION != 2u) \
    || (VDEM42_TYPES_MINOR_VERSION != 0u) \
...
#if (  (VDEM42_CFG_SW_MAJOR_VERSION != (2u)) \
    || (VDEM42_CFG_SW_MINOR_VERSION != (0u)) )
# error "Version numbers of vDem42.c and vDem42_Cfg.h are inconsistent!"
#endif

/* Check the version of the generator */
#if (  (VDEM42_CFG_GEN_MAJOR_VERSION != (2u)) \
    || (VDEM42_CFG_GEN_MINOR_VERSION != (0u)) )
# error "Version numbers of vDem42.c and vDem42_Cfg.h are inconsistent!"
#endif
...
VDEM42_LOCAL VDem42_ClearDTC_SelectionState vDem42_ClearDTC_SelectionState =
  ...
  {  VDEM42_UINT32_MAX, VDEM42_UINT8_MAX,        VDEM42_UINT8_MAX,        FALSE }; /* initialize as not selected */
