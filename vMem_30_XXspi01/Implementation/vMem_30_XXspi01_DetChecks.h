 ...
 *  FILE DESCRIPTION
 *  ------------------------------------------------------------------------------------------------------------------*/
/*!        \file  vMem_30_XXspi01_DetChecks.h
 *        \brief  Header file for declaration of DET checks functions for vMem_30_XXspi01.
 *      \details  Provides the declarations for DET check functions of API parameters. These checks may be useful for
 *                hardware specific services for all subcomponents of vMem_30_XXspi01.
 *********************************************************************************************************************/
 ...
 **********************************************************************************************************************/
#if !defined (VMEM_30_XXSPI01_DETCHECKS_H)
# define VMEM_30_XXSPI01_DETCHECKS_H
 ...
 * \details     -
 * \param[in]   InstanceId       id equal to index of the related vMem_30_XXspi01 instance in configuration structure.
 ...
 * \synchronous TRUE
 */
FUNC(boolean, VMEM_30_XXSPI01_CODE) vMem_30_XXspi01_IsBlankLengthCheck(vMem_30_XXspi01_InstanceIdType InstanceId, vMem_30_XXspi01_AddressType Address, vMem_30_XXspi01_LengthType Length);
 ...
 * \synchronous TRUE
 */
FUNC(boolean, VMEM_30_XXSPI01_CODE) vMem_30_XXspi01_EraseLengthCheck(vMem_30_XXspi01_InstanceIdType InstanceId, vMem_30_XXspi01_AddressType Address, vMem_30_XXspi01_LengthType Length);
/**********************************************************************************************************************
...
#endif /* VMEM_30_XXSPI01_DETCHECKS_H */
/**********************************************************************************************************************
 *  END OF FILE: vMem_30_XXspi01_DetChecks.h
 *********************************************************************************************************************/
