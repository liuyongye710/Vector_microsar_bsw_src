 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file  Eth_30_Vtt_TrafficHandling.h
...
#if !defined (ETH_30_VTT_TRAFFIC_HANDLING_H)
# define ETH_30_VTT_TRAFFIC_HANDLING_H
 ...
 *********************************************************************************************************************/
/* ----- ETH API service IDs ----- */
/*!< Service ID: Eth_30_Vtt_SetBandwidthLimit() */
#  define ETH_30_VTT_SID_SET_BANDWIDTH_LIMIT                         (0x40u)
/*!< Service ID: Eth_30_Vtt_GetBandwidthLimit() */
#  define ETH_30_VTT_SID_GET_BANDWIDTH_LIMIT                         (0x41u)
...
#endif /* ETH_30_VTT_TRAFFIC_HANDLING_H */

/**********************************************************************************************************************
 *  END OF FILE: Eth_30_Vtt_TrafficHandling.h
 *********************************************************************************************************************/
