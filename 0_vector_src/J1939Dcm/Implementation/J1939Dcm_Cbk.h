...
# define J1939DCM_CBK_MAJOR_VERSION                                  (15u)
# define J1939DCM_CBK_MINOR_VERSION                                  (1u)
# define J1939DCM_CBK_PATCH_VERSION                                  (0u)
 ...
 *  \reentrant    TRUE
 *  \synchronous  TRUE
 *  \trace        DSGN-J1939Dcm20833, DSGN-J1939Dcm20835
 *  \pre          -
 **********************************************************************************************************************/
 ...
 *  \reentrant    TRUE
 *  \synchronous  TRUE
 *  \trace        DSGN-J1939Dcm20833, DSGN-J1939Dcm20822
 *  \pre          -
 **********************************************************************************************************************/
FUNC(void, J1939DCM_CODE)
J1939Dcm_RxIndication(
 ...
 *  \param[in]    info->SduLength   Length of the received SF / FF payload (not supported)
 *                info->SduDataPtr  pointer to buffer containing the FF / SF payload + meta data  (not supported)
 ...
 *  \reentrant    TRUE
 *  \synchronous  TRUE
 *  \trace        DSGN-J1939Dcm20833, DSGN-J1939Dcm20836
 *  \pre          -
 **********************************************************************************************************************/
...
J1939Dcm_StartOfReception(
  ...
  P2VAR(PduLengthType, AUTOMATIC, J1939DCM_APPL_DATA) bufferSizePtr
  ); /* SWS_J1939Dcm_00102 */
 ...
 *  \reentrant    TRUE
 *  \synchronous  TRUE
 *  \trace        DSGN-J1939Dcm20833, DSGN-J1939Dcm20837
 ...
 **********************************************************************************************************************/
/*! \brief        Indicates a reception of I-PDU via the TP API.
 *  \details      Informes the application with the new indication and resets the Rx handler.
 *  \param[in]    id      ID of the received I-PDU
 *  \param[in]    result  Result of the reception.
 *  \context      ISR1|ISR2
 *  \reentrant    TRUE
 *  \synchronous  TRUE
 *  \trace        DSGN-J1939Dcm20833, DSGN-J1939Dcm20823
 *  \pre          -
 **********************************************************************************************************************/
FUNC(void, J1939DCM_CODE)
J1939Dcm_TpRxIndication(
 ...
 *  \param[in]    info->SduLength   Length of the data to be copied
 *                info->SduDataPtr  pointer to the data to be copied
 *  \param[in]    retry             parameter to request a retransmit in case transmission fails
 ...
 *  \return       BUFREQ_E_NOT_OK   Application failed to copy the data from PduR buffer
 *  \context      ISR1|ISR2
 *  \reentrant    FALSE
 *  \synchronous  TRUE
 *  \pre          Transmission must be in progress
 *  \trace        DSGN-J1939Dcm20833, DSGN-J1939Dcm20840
 **********************************************************************************************************************/
FUNC(BufReq_ReturnType, J1939DCM_CODE)
J1939Dcm_CopyTxData(
  PduIdType id,
 ...
 *  \reentrant    TRUE
 *  \synchronous  TRUE
 *  \trace        DSGN-J1939Dcm20833, DSGN-J1939Dcm20839
 ...
 *  \reentrant    TRUE
 *  \synchronous  TRUE
 *  \trace        DSGN-J1939Dcm20833, DSGN-J1939Dcm20838
 *  \pre          Transmission must have been started
 **********************************************************************************************************************/
FUNC(void, J1939DCM_CODE)
J1939Dcm_TxConfirmation(
 ...
 **********************************************************************************************************************/
/*! \brief        Indicates a change in the status byte of an UDS DTC.
 *  \details      Updates the queue of events of DM1.
 *  \param[in]    DTC       Diagnostic Trouble Code in UDS format
 *  \param[in]    ClientId  DEM client Id
 *  \context      ISR1|ISR2
 *  \reentrant    FALSE
 *  \synchronous  TRUE
 *  \trace        DSGN-J1939Dcm21299
 *  \pre          -
 **********************************************************************************************************************/
FUNC(void, J1939DCM_CODE)
J1939Dcm_DemTriggerOnDTCStatus(
