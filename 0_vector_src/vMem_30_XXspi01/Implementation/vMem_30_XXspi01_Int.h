 ...
 *
 *      \details  This file contains the declarations of the common vMem_30_XXspi01 API Read, Write, Erase, IsBlank and GetJobResult.
 ...
 *  \details     vMem_30_XXspi01_IsBlank() checks if the page with the given address and length is blank, i.e valid to write to.
