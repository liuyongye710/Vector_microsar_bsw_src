...
# error "Version numbers of vMem_30_XXspi01.c and vMemAccM_vMemApi.h are inconsistent!"
#endif
...
#if !defined (VMEM_30_XXSPI01_LOCAL) /* COV_VMEM_COMPATIBILITY */
...
# define VMEM_30_XXSPI01_ID_MASK_VALUE  0x000FFFFFuL

/**********************************************************************************************************************
 *  GLOBAL CONSTANT MACROS
 *********************************************************************************************************************/
/*! Unique identifier of the vMem_30_XXspi01 based on the below identifiers.
 * VMEM_30_XXSPI01_DRIVER_ID -> Unique vMem_30_XXspi01 driver identifier. This value is generated.
 * VMEMACCM_VMEMAPI_MAJOR_VERSION -> vMemAccM to vMem_30_XXspi01 interface version. */

# define VMEM_30_XXSPI01_UNIQUEID (uint32)(0u | (((uint32)VMEMACCM_VMEMAPI_MAJOR_VERSION) << 24u) | (VMEM_30_XXSPI01_DRIVER_ID & VMEM_30_XXSPI01_ID_MASK_VALUE))

/**********************************************************************************************************************
 *  GLOBAL DATA
 *********************************************************************************************************************/
#define VMEM_30_XXSPI01_START_SEC_FOOTER_CONST_32BIT
#include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_MemMap */
/*! The vMem footer will be placed at the end of the vMem (after the code, data, etc.) and marks the end of the driver.
 * Since, this variable is not used outside of vMem and accessed only via FPT, this can be made static. */
VMEM_30_XXSPI01_LOCAL CONST(uint32, AUTOMATIC) vMem_30_XXspi01_Footer = VMEM_30_XXSPI01_UNIQUEID;

#define VMEM_30_XXSPI01_STOP_SEC_FOOTER_CONST_32BIT
#include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_MemMap */
...
CONST(vMemAccM_vMemApiType, AUTOMATIC) vMem_30_XXspi01_FunctionPointerTable = {
  VMEM_30_XXSPI01_UNIQUEID,
  &vMem_30_XXspi01_FunctionPointerTable.Header,
  &vMem_30_XXspi01_Footer,
  {
  ...
  )
{
  ...
  if (vMem_30_XXspi01_IsInstanceIdValid(InstanceId) == FALSE)
  {
...
#else
  VMEM_30_XXSPI01_DUMMY_STATEMENT(errorId); /* PRQA S 2983 */ /* MD_MSR_DummyStmt */
#endif
  ...
  )
{
  ...
  else if(vMem_30_XXspi01_IsAddressPageAligned(InstanceId, TargetAddress) == FALSE)
  {
      errorId = VMEM_30_XXSPI01_E_PARAM_ADDRESS;
  }
  ...
  )
{
  ...
  else if(vMem_30_XXspi01_IsAddressSectorAligned(InstanceId, TargetAddress) == FALSE)
  {
      errorId = VMEM_30_XXSPI01_E_PARAM_ADDRESS;
  }
 ...
 *
 */
FUNC(Std_ReturnType, VMEM_30_XXSPI01_CODE) vMem_30_XXspi01_IsBlank(
  vMem_30_XXspi01_InstanceIdType InstanceId,
  vMem_30_XXspi01_AddressType TargetAddress,
  vMem_30_XXspi01_LengthType Length
  )
{
  ...
  else if (vMem_30_XXspi01_IsBlankLengthCheck(InstanceId, TargetAddress, Length) == FALSE)
  {
      errorId = VMEM_30_XXSPI01_E_PARAM_LENGTH;
  }
  else
  ...
  {
    /* ----- Implementation ----------------------------------------------- */
    retVal = vMem_30_XXspi01_LLIsBlank(InstanceId, TargetAddress, Length);
  }
  ...
  if (errorId != VMEM_30_XXSPI01_E_NO_ERROR)
  {
    (void)Det_ReportError(VMEM_30_XXSPI01_MODULE_ID, VMEM_30_XXSPI01_INSTANCE_ID_DET, VMEM_30_XXSPI01_SID_IS_BLANK, errorId);
  }
#else
  VMEM_30_XXSPI01_DUMMY_STATEMENT(errorId); /* PRQA S 2983 */ /* MD_MSR_DummyStmt */
#endif
  ...
  return retVal;
} /* vMem_30_XXspi01_IsBlank() */ /* PRQA S 6080 */ /* MD_MSR_STMIF */
 ...
 *
 */
FUNC(void, VMEM_30_XXSPI01_CODE) vMem_30_XXspi01_Init(vMem_30_XXspi01_ConfigPtrType ConfigPtr)
{
  /* ----- Local Variables ---------------------------------------------- */
  uint8 errorId = VMEM_30_XXSPI01_E_NO_ERROR;
  ...
  VMEM_30_XXSPI01_DUMMY_STATEMENT(errorId); /* PRQA S 2983 */ /* MD_MSR_DummyStmt */
#endif
  VMEM_30_XXSPI01_DUMMY_STATEMENT(ConfigPtr); /* PRQA S 1338, 2983 */ /* MD_MSR_DummyStmt */
} /* vMem_30_XXspi01_Init() */
...
MD_VMEM_30_XXSPI01_CORE_13.5_queries:
...
\ID COV_VMEM_30_XXSPI01_UTILITYCODE_UNUSED
 \ACCEPT X
 \REASON vMem_30_XXspi01_core is the hardware independent base (and template) for all hardware dependent versions. It provides a
         header file vMem_30_XXspi01_IntShared.h with shared utility code that may be used from all subcomponents of vMem_30_XXspi01. The
