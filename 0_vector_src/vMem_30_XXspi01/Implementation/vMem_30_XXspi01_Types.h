...
typedef vMemAccM_vMemConfigPtrType        vMem_30_XXspi01_ConfigPtrType;
...
# define VMEM_30_XXSPI01_SOLUTION_ID                         (0x56u)    /*!< vMem_30_XXspi01 solution identifier. Same for all vMems. */
...
# define VMEM_30_XXSPI01_SID_IS_BLANK                        (0x06u)     /*!< Service ID: vMem_30_XXspi01_IsBlank() */
