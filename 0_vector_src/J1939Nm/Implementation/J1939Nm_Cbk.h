 ...
 *  \details      -
 *  \param[in]   RxPduId         ID of the received NM-PDU.
 *  \param[in]   info            Contains the length (SduLength) of the received NM-PDU and a pointer to a buffer
 ...
 *  \details      -
 *  \param[in]   TxPduId         ID of the NM-PDU that has been transmitted.
 ...
 *  \details      -
 *  \param[in]   RxPduId         Identification of the N-SDU.
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
FUNC(BufReq_ReturnType, J1939NM_CODE)
J1939Nm_StartOfReception(PduIdType RxPduId, P2CONST(PduInfoType, AUTOMATIC, J1939NM_APPL_VAR) info,
                         PduLengthType TpSduLength, P2VAR(PduLengthType, AUTOMATIC, J1939NM_APPL_VAR) bufferSizePtr);
 ...
 *  \details      -
 *  \param[in]   RxPduId           Identification of the received N-SDU.
 ...
 *  \param[out]  availableDataPtr  Available receive buffer after data has been copied.
 ...
 *********************************************************************************************************************/
FUNC(BufReq_ReturnType, J1939NM_CODE)
J1939Nm_CopyRxData(PduIdType RxPduId, P2VAR(PduInfoType, AUTOMATIC, J1939NM_APPL_VAR) info,
                   P2VAR(PduLengthType, AUTOMATIC, J1939NM_APPL_VAR) availableDataPtr);
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
FUNC(void, J1939NM_CODE) J1939Nm_TpRxIndication(PduIdType RxPduId, Std_ReturnType result);

/**********************************************************************************************************************
 *  J1939Nm_CopyTxData()
 *********************************************************************************************************************/
/*! \brief       This function is called to get the data for an N-SDU segment (N-PDU) from the upper layer.
 *               Each call to this function returns the next part of the N-SDU data. The size of the remaining data is
 *               written to the position indicated by bufferSizePtr. The retryInfo is currently not supported.
 *  \details      -
 *  \param[in]   TxPduId           Identification of the transmitted N-SDU.
 *  \param[in]   info              Provides the destination buffer (SduDataPtr) and the number of bytes to be copied
 *                                 (SduLength).
 *  \param[in]   retryInfo         Currently ignored.
 *  \param[out]  availableDataPtr  Available transmit data after data has been copied.
 *  \return      BUFREQ_OK:      Data copied successfully.
 *               BUFREQ_E_NOT_OK: Data was not copied because an error occurred.
 *  \pre         The transmission of the N-SDU with this id was previously accepted by the lower layer.
 *  \context     TASK|ISR
 *  \reentrant   TRUE
 *  \synchronous TRUE
 *  \spec
 ...
 *********************************************************************************************************************/
FUNC(BufReq_ReturnType, J1939NM_CODE)
J1939Nm_CopyTxData(PduIdType TxPduId, P2CONST(PduInfoType, AUTOMATIC, J1939NM_APPL_VAR) info,
                   P2CONST(RetryInfoType, AUTOMATIC, PDUR_APPL_DATA) retryInfo,
                   P2VAR(PduLengthType, AUTOMATIC, J1939NM_APPL_VAR) availableDataPtr);

/**********************************************************************************************************************
 *  J1939Nm_TpTxConfirmation()
 *********************************************************************************************************************/
/*! \brief       Called after a CommandedAddress N-SDU has been transmitted via the TP API, the result indicates whether
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
FUNC(void, J1939NM_CODE) J1939Nm_TpTxConfirmation(PduIdType TxPduId, Std_ReturnType result);
