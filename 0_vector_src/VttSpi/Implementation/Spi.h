 ...
 *  02.06.00  2017-12-21  virgmi  STORY-3133    Detect and Create Define Macros for 3rd-party API Infixes in Dualtarget Projects
 *  02.06.01  2020-02-05  virbmz  ESCAN00100223 Parameter ModeId (Spi_SetAsyncMode) is not used if SPI_DEV_ERROR_DETECT is STD_OFF
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
#define DRVSPI_VTTCANOE01ASR_VERSION            (0x0206u)
#define DRVSPI_VTTCANOE01ASR_RELEASE_VERSION    (0x01u)
