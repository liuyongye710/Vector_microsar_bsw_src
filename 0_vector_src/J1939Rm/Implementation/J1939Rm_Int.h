...
# define J1939RM_UNUSED_NODE_CHANNEL_STATE_IDX  (0xFFFFu)
...
# define J1939RM_MDL_SIZE_11BIT                 (1u)
...
/* RQST BC */
# define J1939RM_RQST_BC_PDU_LENGTH             (J1939RM_RQST_FRAME_LENGTH + J1939RM_MDL_SIZE_11BIT)
/* RQST2 */
...
/* RQST2 BC */
# define J1939RM_RQST2_BC_PDU_LENGTH            (J1939RM_RQST2_FRAME_LENGTH + J1939RM_MDL_SIZE_11BIT)
/* ACKM */
...
# define J1939Rm_AssembleThreeBytes(lo, md, hi) ((((uint32) (hi)) << 16)  | ((uint16)(md) << 8) | (uint8)(lo))
...
# define J1939Rm_PGN_IsPDU2(pgn)                (J1939Rm_PGN_GetPDUF(pgn) >= 0xF0u)
