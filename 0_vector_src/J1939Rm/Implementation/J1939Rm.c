...
#if (J1939RM_GATEWAY_SUPPORT == STD_ON)
# include "J1939Nm.h"
#endif
...
#define J1939RM_MAJOR_SOURCE_VERSION            (5u)
#define J1939RM_MINOR_SOURCE_VERSION            (0u)
#define J1939RM_PATCH_SOURCE_VERSION            (2u)

/* Vendor specific BSW generator version information */
#define J1939RM_MAJOR_GENERATOR_VERSION         (2u)
#define J1939RM_MINOR_GENERATOR_VERSION         (4u)
 ...
 *********************************************************************************************************************/
/* Global module state */
#define J1939RM_UNINIT (0u)
#define J1939RM_INIT (1u)

#if !defined (J1939RM_LOCAL) /* COV_J1939RM_LOCAL_TESTSUITE_INSTRUMENTATION */
# define J1939RM_LOCAL static
#endif

#if !defined (J1939RM_LOCAL_INLINE) /* COV_J1939RM_LOCAL_TESTSUITE_INSTRUMENTATION */
 ...
 *********************************************************************************************************************/
/*======================================= J1939RM_START_SEC_VAR_CLEARED_8 ======================================*/
#define J1939RM_START_SEC_VAR_CLEARED_8
#include "J1939Rm_MemMap.h" /* PRQA S 5087 */ /* MD_MSR_MemMap */

/*! Initialization state of the J1399Rm */
J1939RM_LOCAL VAR(uint8, J1939RM_VAR_CLEARED) J1939Rm_ModuleInitialized = J1939RM_UNINIT;

#define J1939RM_STOP_SEC_VAR_CLEARED_8
#include "J1939Rm_MemMap.h" /* PRQA S 5087 */ /* MD_MSR_MemMap */
/*======================================== J1939RM_STOP_SEC_VAR_CLEARED_8 ======================================*/
/**********************************************************************************************************************
 *  INTERNAL DATA
 *********************************************************************************************************************/
/*=================================== J1939RM_START_SEC_VAR_NO_INIT_UNSPECIFIED ===================================*/
#define J1939RM_START_SEC_VAR_NO_INIT_UNSPECIFIED
#include "J1939Rm_MemMap.h" /* PRQA S 5087 */ /* MD_MSR_MemMap */

/*! Post-build configuration data of the J1939Rm */
#if (J1939RM_USE_INIT_POINTER == STD_ON)
/*!
* \spec
*   strong invariant J1939Rm_ConfigDataPtr == J1939Rm_Config_Ptr;
* \endspec
*/
J1939RM_LOCAL P2CONST(J1939Rm_ConfigType, J1939RM_VAR_NO_INIT, J1939RM_PBCFG) J1939Rm_ConfigDataPtr;
#endif

#define J1939RM_STOP_SEC_VAR_NO_INIT_UNSPECIFIED
#include "J1939Rm_MemMap.h" /* PRQA S 5087 */ /* MD_MSR_MemMap */
/*==================================== J1939RM_STOP_SEC_VAR_NO_INIT_UNSPECIFIED ===================================*/
/**********************************************************************************************************************
...
#if ((J1939RM_SUPPORT_COM_USER == STD_ON) && (J1939RM_SUPPORT_REQUEST2 == STD_ON))
/**********************************************************************************************************************
 ...
 *  \synchronous TRUE
 *  \spec
 *    requires   channelIdx < J1939Rm_GetSizeOfChannel();
 *  \endspec
 *********************************************************************************************************************/
...
#if (J1939RM_SUPPORT_REQUEST_TRANSMISSION == STD_ON) || (J1939RM_GATEWAY_SUPPORT == STD_ON)
/**********************************************************************************************************************
...
#if (J1939RM_GATEWAY_SUPPORT == STD_ON)
/**********************************************************************************************************************
 *  J1939Rm_InternalRequestRoutingTransmit
 *********************************************************************************************************************/
/*! \brief       Handles the transmission of routed Request or Request2 PGs.
 *  \details     -
 *  \param[in]   channelIdx           Internal index of the channel on which the Request PG shall be sent.
 *  \param[in]   sourceAddress        Source address of the transmitted Request PG.
 *  \param[in]   destAddress          Address of the destination node or 0xFF for broadcast.
 *  \param[in]   requestedPgn         PGN of the requested PG.
 *  \param[in]   priority             Priority of the Request PG.
 *  \param[in]   specInstr            Special Instruction.
 *  \param[in]   extIdInfo            Extended Identifier Bytes.
 *  \param[in]   isRequest2           Flag that indicats if it is a Request2 (TRUE) or Request (FALSE)
 *  \pre         Module is initialized.
 *  \context     TASK|ISR
 *  \reentrant   TRUE
 *  \synchronous TRUE
 *  \config      This function is only available if J1939RM_GATEWAY_SUPPORT == STD_ON.
 *********************************************************************************************************************/
J1939RM_LOCAL_INLINE FUNC(void, J1939RM_CODE) J1939Rm_InternalRequestRoutingTransmit(J1939Rm_ChannelIterType channelIdx,
                                                                                     uint8 sourceAddress,
                                                                                     uint8 destAddress,
                                                                                     uint32 requestedPgn,
                                                                                     uint8 priority, uint8 specInstr,
                                                                                     const J1939Rm_ExtIdInfoType *
                                                                                     extIdInfo, boolean isRequest2);
#endif

#if (J1939RM_GATEWAY_SUPPORT == STD_ON)
/**********************************************************************************************************************
 *  J1939Rm_InternalRequestRouting
 *********************************************************************************************************************/
/*! \brief       Routing of a Request or Request2 PG.
 *  \details     -
 *  \param[in]   srcChannelIdx        Internal index of the channel on which the Request PG shall be sent.
 *  \param[in]   sourceAddress        Source address of the transmitted Request PG.
 *  \param[in]   destAddress          Address of the destination node or 0xFF for broadcast.
 *  \param[in]   requestedPgn         PGN of the requested PG.
 *  \param[in]   priority             Priority of the Request PG.
 ...
 *  \param[in]   specInstr            Special Instruction.
 *  \param[in]   isRequest2           Flag that indicats if it is a Request2 (TRUE) or Request (FALSE)
 *  \param[in]   isGatewayUseCase     Flag that indicats if the message shall be routed
 *  \param[in]   isCalledFromExternal Flag that indicats if the Request is external or internal
 *  \pre         Module is initialized.
 *  \context     TASK|ISR
 *  \reentrant   TRUE
 *  \synchronous TRUE
 ...
 *********************************************************************************************************************/
J1939RM_LOCAL_INLINE FUNC(void,
                          J1939RM_CODE) J1939Rm_InternalRequestRouting(J1939Rm_ChannelIdxOfRxPduType srcChannelIdx,
                                                                       uint8 sourceAddress, uint8 destAddress,
                                                                       uint32 requestedPgn, uint8 priority,
                                                                       uint8 specInstr,
                                                                       const J1939Rm_ExtIdInfoType * extIdInfo,
                                                                       boolean isRequest2, boolean isGatewayUseCase,
                                                                       boolean isCalledFromExternal);
#endif

#if (J1939RM_GATEWAY_SUPPORT == STD_ON)
/**********************************************************************************************************************
 *  J1939Rm_InternalAckRouting
 *********************************************************************************************************************/
/*! \brief       Routing of a Acknowledgment.
 *  \details     -
 *  \param[in]   channelIdx           Internal index of the channel on which the Acknowledgment was received.
 ...
 *  \param[in]   da                   Address of the destination node or 0xFF for broadcast.
 *  \param[in]   ackAddress           Acknowledge address
 *  \param[in]   pgn                  PGN of the Acknowledgment.
 *  \param[in]   ackCb                Acknowledgment control byte.
 *  \param[in]   IsGatewayUseCase     Flag that indicates if the Acknowledgement shall be routed or not.
 *  \param[in]   isCalledFromExternal Flag that indicats if the Request is external or internal
 *  \param[in]   extFrameFormat       Flag that indicates if pdu is in extended frame format
 *  \pre         Module is initialized.
 *  \context     TASK|ISR
 *  \reentrant   TRUE
 *  \synchronous TRUE
 *  \config      This function is only available if J1939RM_GATEWAY_SUPPORT == STD_ON.
 *********************************************************************************************************************/
J1939RM_LOCAL_INLINE FUNC(void, J1939RM_CODE) J1939Rm_InternalAckRouting(J1939Rm_ChannelIdxOfRxPduType channelIdx,
                                                                         P2CONST(PduInfoType, AUTOMATIC,
                                                                                 J1939RM_APPL_DATA) PduInfoPtr,
                                                                         uint8 da, uint8 ackAddress,
                                                                         uint32 pgn, uint8 ackCb,
                                                                         boolean isGatewayUseCase,
                                                                         boolean isCalledFromExternal,
                                                                         boolean extFrameFormat);
#endif
 ...
 *                                   or in J1939Rm_SendRequest (intern, FALSE) context.
 *  \return      TRUE:               Request/Request2 shall be routed.
 *  \return      FALSE:              Request/Request2 shall not be routed.
 *  \pre         Module is initialized.
 *  \context     TASK|ISR
 *  \reentrant   TRUE
 *  \synchronous TRUE
 ...
 *  \endspec
 *********************************************************************************************************************/
J1939RM_LOCAL FUNC(boolean, J1939RM_CODE) J1939Rm_InternalProcessRequest(J1939Rm_ChannelIdxOfRxPduType channelIdx,
                                                                         uint32 requestedPgn,
                                                                         const J1939Rm_ExtIdInfoType * extIdInfo,
                                                                         uint8 sourceAddress, uint8 destAddress,
 ...
 *  \param[in]   PduInfoPtr          Contains the length (SduLength) of the received I-PDU and a pointer to a buffer
 *                                   (SduDataPtr) containing the I-PDU and MetaData.
 *  \param[in]   isCalledFromExtern  Flag that indicates if the function is called in J1939Rm_RxIndication (extern, TRUE)
 *                                   or in J1939Rm_SendRequest (intern, FALSE) context.
 *  \param[in]   extFrameFormat      Flag that indicates if pdu is in extended frame format
 *  \pre         Module is initialized.
 *  \context     TASK|ISR
 ...
 *  \reentrant   TRUE
 *  \synchronous TRUE
 *  \config      This function is only available if J1939RM_SUPPORT_REQUEST2 == STD_ON.
 *  \spec
 *    requires   channelIdx < J1939Rm_GetSizeOfChannel();
 *  \endspec
 *********************************************************************************************************************/
...
#if ((J1939RM_SUPPORT_ACK_INDICATION == STD_ON) || (J1939RM_GATEWAY_SUPPORT == STD_ON))
/**********************************************************************************************************************
 ...
 *  \param[in]   extFrameFormat      Flag that indicates if pdu is in extended frame format
 *  \return      TRUE:               Acknowledgment shall be routed.
 *  \return      FALSE:              Acknowledgment shall not be routed.
 *  \pre         Module is initialized.
 *  \context     TASK|ISR
 *  \reentrant   TRUE
 *  \synchronous TRUE
 *  \config      This function is only available if J1939RM_SUPPORT_ACK_INDICATION == STD_ON.
 *********************************************************************************************************************/
J1939RM_LOCAL_INLINE FUNC(boolean, J1939RM_CODE) J1939Rm_InternalProcessAck(J1939Rm_ChannelIdxOfRxPduType channelIdx,
                                                                            P2CONST(PduInfoType, AUTOMATIC,
                                                                                    J1939RM_APPL_DATA) PduInfoPtr,
                                                                            J1939Rm_AckCode ackCode, uint8 extIdCode,
                                                                            uint32 pgn, boolean extFrameFormat);
#endif
...
#if ((J1939RM_REQQUEUEINDUSEDOFCHANNEL == STD_ON) && ((J1939RM_SUPPORT_REQUEST_TRANSMISSION == STD_ON) || (J1939RM_GATEWAY_SUPPORT == STD_ON)))
/**********************************************************************************************************************
...
#if ((J1939RM_REQ2QUEUEINDUSEDOFCHANNEL == STD_ON) && ((J1939RM_SUPPORT_REQUEST_TRANSMISSION == STD_ON) || (J1939RM_GATEWAY_SUPPORT == STD_ON)) && (J1939RM_SUPPORT_REQUEST2 == STD_ON))
/**********************************************************************************************************************
 ...
 *  \config      This function is only available if J1939RM_SUPPORT_REQUEST_TRANSMISSION == STD_ON.
 *  \spec
 *    requires    J1939Rm_Channel_Valid(channel);
 *  \endspec
 *********************************************************************************************************************/
 ...
 *  \param[in]   PduInfoPtr   Contains the length (SduLength) of the received I-PDU and a pointer to a buffer
 *                            (SduDataPtr) containing the I-PDU and MetaData.
 *  \param[in]   isRxIndicationExtern  Flag that indicates if the function is called from J1939Rm_RxIndication (TRUE)
 *                                     or from J1939Rm_SendRequest (FALSE)
 *  \pre         Module is initialized.
 *  \context     TASK|ISR
 *  \reentrant   TRUE
 *  \synchronous TRUE
 *  \spec
 *    requires    RxPduId < J1939Rm_GetSizeOfRxPdu();
 *  \endspec
 */
#if (J1939RM_INVALIDHNDOFRXPDU == STD_ON)
/*!
 *  \spec
 *    requires   !J1939Rm_IsInvalidHndOfRxPdu(RxPduId);
 *  \endspec
 */
#endif
 /*********************************************************************************************************************/
 ...
 *  \synchronous TRUE
 *  \spec
 *    requires    TxPduId < J1939Rm_GetSizeOfTxPdu();
 *  \endspec
 */
#if (J1939RM_INVALIDHNDOFTXPDU == STD_ON)
/*!
 *  \spec
 *    requires   !J1939Rm_IsInvalidHndOfTxPdu(TxPduId);
 *  \endspec
 */
#endif
 /*********************************************************************************************************************/
 ...
 *
 */
J1939RM_LOCAL_INLINE FUNC(boolean, J1939RM_CODE)
J1939Rm_InternalCheckExtIdUsage(J1939Rm_ComIPduIndType comIPduIdx, const J1939Rm_ExtIdInfoType * extIdInfo)
{
 ...
 */
J1939RM_LOCAL_INLINE FUNC(boolean, J1939RM_CODE)
J1939Rm_InternalProcessRequestIndication(J1939Rm_ChannelIdxOfRxPduType channelIdx,
                                         J1939Rm_NodeNodeIdxOfChannelNodeType nodeIdx,
                                         J1939Rm_UserUserIdxOfNodeUserType userIdx, uint32 requestedPgn,
                                         const J1939Rm_ExtIdInfoType * extIdInfo,
                                         uint8 sourceAddress, uint8 destAddress, uint8 priority)
{
  boolean found = FALSE;
         ...
         reqPgnIdx < J1939Rm_GetUserPGNIndEndIdxOfUser(userIdx); reqPgnIdx++)
    {
      ...
      if (requestedPgn == (uint32) J1939Rm_GetPGNOfUserPGN(J1939Rm_GetUserPGNInd(reqPgnIdx)))
      {
        ...
        if (J1939Rm_GetUserTypeOfUser(userIdx) == J1939RM_USER_RTE_USERTYPEOFUSER)
        {
          ...
          (void) J1939Rm_GetRteRequestIndication(J1939Rm_GetRteRequestIndicationIdxOfUser(userIdx)) /* VCA_J1939RM_UNDEF_FCTCALL */
          ...
          /* #60 If it is not an RTE user: \trace SPEC-2167407 */
        {
          ...
          J1939Rm_GetRequestIndication(J1939Rm_GetRequestIndicationIdxOfUser(userIdx)) /* VCA_J1939RM_UNDEF_FCTCALL */
            ((uint8) J1939Rm_GetNodeIdOfNode(nodeIdx), J1939Rm_GetComMChannelIdOfChannel(channelIdx),
             requestedPgn, extIdInfo, sourceAddress, destAddress, priority);
        }
      }
 ...
 */
J1939RM_LOCAL_INLINE FUNC(void, J1939RM_CODE)
J1939Rm_InternalProcessRequestComUserTriggerSend(J1939Rm_ComIPduIndType comIPduIdx, uint8 nodeAddr,
                                                 uint8 destAddress, uint8 sourceAddress, uint8 priority)
{
 ...
 */
J1939RM_LOCAL_INLINE FUNC(boolean, J1939RM_CODE)
J1939Rm_InternalProcessRequestForComIPdu(J1939Rm_ChannelIdxOfRxPduType channelIdx,
                                         J1939Rm_UserUserIdxOfNodeUserType userIdx, uint32 requestedPgn,
                                         const J1939Rm_ExtIdInfoType * extIdInfo, uint8 nodeAddr,
                                         uint8 sourceAddress, uint8 destAddress, uint8 priority)
{
  boolean found = FALSE;
  ...
  if (sourceAddress != J1939RM_NULL_ADDRESS)
  {
    ...
    /* PRQA S 4558, 4116 2 */ /* MD_MSR_AutosarBoolean, MD_MSR_AutosarBoolean */
    for (userComIPduIdx = J1939Rm_GetComIPduIndStartIdxOfUser(userIdx);
         (userComIPduIdx < J1939Rm_GetComIPduIndEndIdxOfUser(userIdx)) && (!found); userComIPduIdx++)
    {
      J1939Rm_ComIPduIndType comIPduIdx = J1939Rm_GetComIPduInd(userComIPduIdx);
      J1939Rm_ComIPduDestIterType comIPduDestIdx;

      /* #30 Go through all channels of the current evaluated ComIPdu: */
      /* PRQA S 4558, 4116 2 */ /* MD_MSR_AutosarBoolean */
      for (comIPduDestIdx = J1939Rm_GetComIPduDestStartIdxOfComIPdu(comIPduIdx);
           (comIPduDestIdx < J1939Rm_GetComIPduDestEndIdxOfComIPdu(comIPduIdx)) && (!found); comIPduDestIdx++)
      {
        /* #40 If the current evaluated channel is equal to the given channel and the ComIPdu has the requested PGN: */
        if ((channelIdx == J1939Rm_GetChannelIdxOfComIPduDest(comIPduDestIdx)) &&
...
# if (J1939RM_SUPPORT_REQUEST2 == STD_ON)
          ...
          /* #50 If the extended id bytes from the Request and the current evaluated ComIPdu match: */
          if (extIdMatch == TRUE)
# else
          if (extIdInfo->ExtIdType == J1939RM_EXTID_NONE)
# endif
          {
            uint8 pduDa = J1939Rm_GetDAOfComIPduDest(comIPduDestIdx);

            /*
             * #60 If the destination of the PDU is the null address, it is either freely choosable or immutable but OK
                ...
                ((destAddress != J1939RM_BROADCAST_ADDRESS) && (pduDa == sourceAddress)))
            {
              ...
              /* #70 Use the COM API to send the requested PG message. */
                                  ...
                                  uint8 ackAddress, uint8 sa, uint8 priority, J1939Rm_AckCode ackCode, uint32 pgn)
{
  ...
  J1939RM_DUMMY_STATEMENT(channelIdx); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
  J1939RM_DUMMY_STATEMENT(nodeIdx); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
  J1939RM_DUMMY_STATEMENT(extIdInfo); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
  J1939RM_DUMMY_STATEMENT(ackAddress); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
  J1939RM_DUMMY_STATEMENT(sa); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
  J1939RM_DUMMY_STATEMENT(priority); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
  J1939RM_DUMMY_STATEMENT(ackCode); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
...
# if (J1939RM_RTEACKINDICATION == STD_ON)
      ...
      if (J1939Rm_GetUserTypeOfUser(userIdx) == J1939RM_USER_RTE_USERTYPEOFUSER) /* COV_J1939RM_RTEUSERTYPE */
      {
        /*
         * #40 Use the ack indication service API to inform the user about the received acknowledgment.
         * \trace SPEC-2167424
         */
        (void) J1939Rm_GetRteAckIndication(J1939Rm_GetRteAckIndicationIdxOfUser(userIdx)) /* VCA_J1939RM_UNDEF_FCTCALL */
...
# if (J1939RM_ACKINDICATION == STD_ON)
      {
        /*
         * #60 Use the ack indication API of the user to inform the user about the received acknowledgment.
         * \trace SPEC-2167423
         */
        J1939Rm_GetAckIndication(J1939Rm_GetAckIndicationIdxOfUser(userIdx)) /* VCA_J1939RM_UNDEF_FCTCALL */
          ((uint8) J1939Rm_GetNodeIdOfNode(nodeIdx), J1939Rm_GetComMChannelIdOfChannel(channelIdx), pgn,
           extIdInfo, ackCode, ackAddress, sa, priority);
      }
# endif
                                                                             ...
                                                                             uint16 nodeChannelStateIdx)
{
  ...
  J1939Rm_TxPduStateType *txPduState = &J1939Rm_GetTxPduState(J1939Rm_GetTxPduStateIdxOfTxPdu(txPduIdx));

  J1939RM_DUMMY_STATEMENT(broadcast); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
  J1939RM_DUMMY_STATEMENT(nodeChannelStateIdx); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
  ...
  if (txPduState->Locked == FALSE)
  {
    ...
    J1939Rm_MetaDataLengthOfTxPduType mdlSize = J1939Rm_GetMetaDataLengthOfTxPdu(txPduIdx);
    uint8 data[J1939RM_ACKM_PDU_LENGTH];
    PduInfoType pdu;

    txPduState->ConfTimeout = J1939Rm_GetTxConfTimeout(); /* VCA_J1939RM_TXPDUSTATE_VIA_CHANNEL_CSL03 */
    txPduState->Locked = TRUE; /* VCA_J1939RM_TXPDUSTATE_VIA_CHANNEL_CSL03 */

    /* #40 Leave J1939RM_EXCLUSIVE_AREA_TXPDULOCK. */
    SchM_Exit_J1939Rm_J1939RM_EXCLUSIVE_AREA_TXPDULOCK();

    pdu.SduDataPtr = data;
    pdu.SduLength = (uint8)(J1939RM_ACKM_FRAME_LENGTH + mdlSize);
    ...
    data[J1939RM_ACKM_PGN_MD] = J1939Rm_Make_PGN_MD(ackPgn); /* PRQA S 2985 */ /* MD_J1939Rm_2.2 */
    data[J1939RM_ACKM_PGN_HI] = J1939Rm_Make_PGN_HI(ackPgn);
    data[J1939RM_ACKM_SA_POS] = sourceAddress;
#if (J1939RM_CANFDCHANNELOFCHANNEL == STD_ON)
    if (mdlSize == J1939RM_MDL_SIZE)
#endif
    {
#if (J1939RM_ISOBUSCHANNELOFCHANNEL == STD_ON)
      if (J1939Rm_IsIsobusChannelOfChannel(channelIdx) && (!broadcast)) /* PRQA S 4558, 4116 */ /* MD_MSR_AutosarBoolean */
      {
    ...
    /*
     * #60 If the transmit was successful report the transmitted Acknowledgment internal, otherwise release the PDU
     * lock.
     */
    if (result == E_OK)
    {
#if (J1939RM_ACKINDICATION == STD_ON)
      /* @ assert $external(pdu.SduDataPtr); */ /* VCA_J1939RM_PTR2LOCAL */
      J1939Rm_InternalRxIndication((PduIdType) J1939Rm_GetRxPduAckmIdxOfChannel(channelIdx), &pdu, FALSE);
#endif
    }
    else
    {
      txPduState->Locked = FALSE; /* VCA_J1939RM_TXPDUSTATE_VIA_CHANNEL_CSL03 */
    }
  }
  ...
  if (result != E_OK)
  {
    J1939Rm_ChannelStateType *channelState = &J1939Rm_GetChannelState(channelIdx);
    /* @ assert channelState; */ /* VCA_J1939RM_CHANNELSTATE_VIA_CHANNEL_CSL03 */
    ...
    if (channelState->AckQueueFree > 0u)
    {
      /* #110 Get an element of the Acknowledgment queue and set the data to transmit. */
      J1939Rm_AckQueueElementType *elem = &J1939Rm_GetAckQueue(channelState->AckQueueWrite);
      /* @ assert $external(elem); */ /* VCA_J1939RM_QUEUE */
      ...
      channelState->AckQueueWrite++;

      if (channelState->AckQueueWrite == J1939Rm_GetAckQueueIndEndIdxOfChannel(channelIdx))
      {
        channelState->AckQueueWrite = J1939Rm_GetAckQueueIndStartIdxOfChannel(channelIdx);
      }
      channelState->AckQueueFree--;
...
J1939RM_LOCAL FUNC(Std_ReturnType, J1939RM_CODE) J1939Rm_InternalTransmitRequest(J1939Rm_ChannelIterType channelIdx,
                                                                                 ...
                                                                                 uint16 nodeChannelStateIdx)
{
  J1939Rm_TxPduRqstIdxOfChannelType txPduIdx;
  J1939Rm_TxPduStateType * txPduState;
  Std_ReturnType result = E_NOT_OK;
  uint8 pduLength = J1939RM_RQST_PDU_LENGTH;

# if (J1939RM_TXPDURQSTBCIDXOFCHANNEL == STD_ON)
  boolean extFrameFormat = TRUE;

  if (J1939Rm_IsCanFDChannelOfChannel(channelIdx) && (destAddress == J1939RM_BROADCAST_ADDRESS))
  {
    txPduIdx = J1939Rm_GetTxPduRqstBcIdxOfChannel(channelIdx);
    extFrameFormat = FALSE;
    pduLength = J1939RM_RQST_BC_PDU_LENGTH;
  }
  else
# endif
  {
    txPduIdx = J1939Rm_GetTxPduRqstIdxOfChannel(channelIdx);
  }
  txPduState = &J1939Rm_GetTxPduState(J1939Rm_GetTxPduStateIdxOfTxPdu(txPduIdx));
...
# endif
    ...
    /*
     * #60 If the transmit was successful, report the transmitted request internal, otherwise release the PDU lock.
     * \trace SPEC-2167420
     */
    if (result == E_OK)
    {
      /* @ assert $external(pdu.SduDataPtr); */ /* VCA_J1939RM_PTR2LOCAL */
# if (J1939RM_TXPDURQSTBCIDXOFCHANNEL == STD_ON)
      if (extFrameFormat == FALSE)
      {
        J1939Rm_InternalRxIndication((PduIdType) J1939Rm_GetRxPduRqstBcIdxOfChannel(channelIdx), &pdu, FALSE);
      }
      else
# endif
      {
        J1939Rm_InternalRxIndication((PduIdType) J1939Rm_GetRxPduRqstIdxOfChannel(channelIdx), &pdu, FALSE);
      }
    }
    else
    {
...
# if (J1939RM_REQQUEUEINDUSEDOFCHANNEL == STD_ON)
  if (result != E_OK)
  {
    ...
    if (channelState->ReqQueueFree > 0u)
    {
      /* #110 Get an element of the Request queue and set the data to transmit. */
      J1939Rm_ReqQueueElementType *elem = &J1939Rm_GetReqQueue(channelState->ReqQueueWrite);
      /* @ assert $external(elem); */ /* VCA_J1939RM_QUEUE */
      ...
      /* #120 If the queue is full now, handle queue pointer wrap around. */
      channelState->ReqQueueWrite++;
      if (channelState->ReqQueueWrite == J1939Rm_GetReqQueueIndEndIdxOfChannel(channelIdx))
      {
        channelState->ReqQueueWrite = J1939Rm_GetReqQueueIndStartIdxOfChannel(channelIdx);
      }
      channelState->ReqQueueFree--;
...
J1939RM_LOCAL FUNC(Std_ReturnType, J1939RM_CODE) J1939Rm_InternalTransmitRequest2(J1939Rm_ChannelIterType channelIdx,
                                                                                  ...
                                                                                  uint16 nodeChannelStateIdx)
{
  J1939Rm_TxPduRqst2IdxOfChannelType txPduIdx;
  J1939Rm_TxPduStateType * txPduState;
  Std_ReturnType result = E_NOT_OK;
  uint8 pduLength = J1939RM_RQST2_PDU_LENGTH;

# if (J1939RM_TXPDURQST2BCIDXOFCHANNEL == STD_ON)
  boolean extFrameFormat = TRUE;

  if (J1939Rm_IsCanFDChannelOfChannel(channelIdx) && (destAddress == J1939RM_BROADCAST_ADDRESS))
  {
    txPduIdx = J1939Rm_GetTxPduRqst2BcIdxOfChannel(channelIdx);
    extFrameFormat = FALSE;
    pduLength = J1939RM_RQST2_BC_PDU_LENGTH;
  }
  else
# endif
  {
    txPduIdx = J1939Rm_GetTxPduRqst2IdxOfChannel(channelIdx);
  }
  txPduState = &J1939Rm_GetTxPduState(J1939Rm_GetTxPduStateIdxOfTxPdu(txPduIdx));
  ...
  if (txPduState->Locked == FALSE)
  {
    ...
    data[J1939RM_RQST2_PGN_MD] = J1939Rm_Make_PGN_MD(requestedPgn); /* PRQA S 2985 */ /* MD_J1939Rm_2.2 */
...
# endif
    ...
    /*
     * #60 If the transmit was successful report the transmitted Request2 internal, otherwise release the state of the
     * Pdu.
     */
    if (result == E_OK)
    {
...
# if (J1939RM_TXPDURQST2BCIDXOFCHANNEL == STD_ON)
      if (extFrameFormat == FALSE)
      {
        J1939Rm_InternalRxIndication((PduIdType) J1939Rm_GetRxPduRqst2BcIdxOfChannel(channelIdx), &pdu, FALSE);
      }
      else
# endif
      {
        J1939Rm_InternalRxIndication((PduIdType) J1939Rm_GetRxPduRqst2IdxOfChannel(channelIdx), &pdu, FALSE);
      }
    }
    else
    {
...
#  if (J1939RM_REQ2QUEUEINDUSEDOFCHANNEL == STD_ON)
  if (result != E_OK)
  {
    ...
    if (channelState->Req2QueueFree > 0u)
    {
      /* #110 Get an element of the Request2 queue and set the data to transmit. */
      J1939Rm_Req2QueueElementType *elem = &J1939Rm_GetReq2Queue(channelState->Req2QueueWrite);
      /* @ assert $external(elem); */ /* VCA_J1939RM_QUEUE */
      ...
      /* #120 If the queue is full now, handle queue pointer wrap around. */
      channelState->Req2QueueWrite++;
      if (channelState->Req2QueueWrite == J1939Rm_GetReq2QueueIndEndIdxOfChannel(channelIdx))
      {
        channelState->Req2QueueWrite = J1939Rm_GetReq2QueueIndStartIdxOfChannel(channelIdx);
      }
      channelState->Req2QueueFree--;
 ...
 */
J1939RM_LOCAL_INLINE FUNC(void, J1939RM_CODE)
J1939Rm_InternalRequestRoutingTransmit(J1939Rm_ChannelIterType channelIdx, uint8 sourceAddress, uint8 destAddress,
                                       uint32 requestedPgn, uint8 priority, uint8 specInstr,
                                       const J1939Rm_ExtIdInfoType * extIdInfo, boolean isRequest2)
{
# if (J1939RM_SUPPORT_REQUEST2 == STD_OFF)
  J1939RM_DUMMY_STATEMENT(extIdInfo); /* PRQA S 1338, 2983 */ /* MD_MSR_DummyStmt */
  J1939RM_DUMMY_STATEMENT(isRequest2); /* PRQA S 1338, 2983 */ /* MD_MSR_DummyStmt */
  J1939RM_DUMMY_STATEMENT(specInstr); /* PRQA S 1338, 2983 */ /* MD_MSR_DummyStmt */
# endif

  /* #10 If it is a Request2 message: */
# if (J1939RM_SUPPORT_REQUEST2 == STD_ON)
  if (isRequest2 == TRUE)
  {
    /* #20 Trigger the transmission of the Request2 message. */
    (void) J1939Rm_InternalTransmitRequest2(channelIdx, requestedPgn, specInstr, extIdInfo->ExtId1, extIdInfo->ExtId2,
                                            extIdInfo->ExtId3, sourceAddress, destAddress, priority,
                                            J1939RM_UNUSED_NODE_CHANNEL_STATE_IDX);
...
# endif
  {
    /* #40 Trigger the transmission of the Request message. */
    (void) J1939Rm_InternalTransmitRequest(channelIdx, requestedPgn, sourceAddress, destAddress, priority,
                                           J1939RM_UNUSED_NODE_CHANNEL_STATE_IDX);
  }
} /* J1939Rm_InternalRequestRoutingTransmit() */ /* PRQA S 6060 */ /* MD_MSR_STPAR */
#endif
 ...
 */
J1939RM_LOCAL_INLINE FUNC(void, J1939RM_CODE)
J1939Rm_InternalRequestRouting(J1939Rm_ChannelIdxOfRxPduType srcChannelIdx, uint8 sourceAddress, uint8 destAddress,
                               uint32 requestedPgn, uint8 priority, uint8 specInstr,
                               const J1939Rm_ExtIdInfoType * extIdInfo, boolean isRequest2, boolean isGatewayUseCase,
                               boolean isCalledFromExternal)
{

  /* #10 If the Request/Request2 can not be assigned to a local node or it is a broadcast Request/Request2, route the
     Request/Request2 to all necessary channels. */
  if ((isCalledFromExternal == TRUE) && ((isGatewayUseCase == TRUE) || (destAddress == J1939RM_BROADCAST_ADDRESS)))
  {
    NetworkHandleType destComMChannel;

    /* #20 If the source channel of the Request/Request2 has a routing configuration to another channel, trigger the
       transmission of the Request/Request2 on the that channel. */
    if (J1939Nm_FindNodeChannelByAddress(J1939Rm_GetComMChannelIdOfChannel(srcChannelIdx), destAddress, /* VCA_J1939RM_UNDEF_FCTCALL_PTR2LOCAL */
                                         &destComMChannel) == E_OK)
    {
      if (J1939Rm_Channel_Valid(destComMChannel)) /* PRQA S 4304 */ /* AutosarBoolean */
      {
        J1939Rm_InternalRequestRoutingTransmit(J1939Rm_GetChannelIdxOfComMChannel(destComMChannel), sourceAddress,
                                               destAddress, requestedPgn, priority, specInstr, extIdInfo, isRequest2);
      }
    }
    /* #30 Otherwise: */
    else
    {
      J1939Rm_ChannelIterType destChannelIdx;
      NetworkHandleType comMChannelId = J1939Rm_GetComMChannelIdOfChannel(srcChannelIdx);

      /* #40 Check for each channel if there is a routing configuration in J1939Nm from the source channel of the
         Request/Request2 to the current explored channel. If the channels have a routing configuration, trigger the
         transmission of the Request/Request2 on the current explored channel. */
      for (destChannelIdx = 0; destChannelIdx < J1939Rm_GetSizeOfChannel(); destChannelIdx++)
      {
        if (srcChannelIdx != destChannelIdx)
        {
          if (J1939Nm_CheckNodeChannelByAddress(comMChannelId, sourceAddress,
                                                J1939Rm_GetComMChannelIdOfChannel(destChannelIdx)) == TRUE)
          {
            J1939Rm_InternalRequestRoutingTransmit(destChannelIdx, sourceAddress, destAddress, requestedPgn, priority,
                                                   specInstr, extIdInfo, isRequest2);
          }
        }
      }
    }
  }
} /* J1939Rm_InternalRequestRouting() */ /* PRQA S 6060, 6080 */ /* MD_MSR_STPAR, MD_MSR_STMIF */
#endif
 ...
 */
J1939RM_LOCAL_INLINE FUNC(void, J1939RM_CODE)
J1939Rm_InternalAckRouting(J1939Rm_ChannelIdxOfRxPduType channelIdx,
                           P2CONST(PduInfoType, AUTOMATIC, J1939RM_APPL_DATA) PduInfoPtr,
                           uint8 da, uint8 ackAddress, uint32 pgn, uint8 ackCb, boolean isGatewayUseCase,
                           boolean isCalledFromExternal, boolean extFrameFormat)
{
  J1939RM_DUMMY_STATEMENT(extFrameFormat); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */

  /* #10 If the Acknowledgement can not be assigned to a local node or it is a broadcast Acknowledgement, route the
     Acknowledgement to all necessary channels. */
  if ((isCalledFromExternal == TRUE) && ((isGatewayUseCase == TRUE) || (da == J1939RM_BROADCAST_ADDRESS)))
  {
    NetworkHandleType destComMChannel;
...
# if (J1939RM_CANFDCHANNELOFCHANNEL == STD_ON)
    if (extFrameFormat == FALSE)
    {
      priority = J1939RM_DEFAULT_PRIORITY;
    } 
    else
# endif
    {
      priority = J1939Rm_Get_Priority(PduInfoPtr->SduDataPtr[J1939RM_ACKM_PRI_POS]);
    }

    /* #20 If the source channel of the Acknowledgement has a routing configuration to another channel, trigger the
       transmission of the Acknowledgement on the that channel. */
    if (J1939Nm_FindNodeChannelByAddress(J1939Rm_GetComMChannelIdOfChannel(channelIdx), da, &destComMChannel) == E_OK) /* VCA_J1939RM_UNDEF_FCTCALL_PTR2LOCAL */
    {
      if (J1939Rm_Channel_Valid(destComMChannel)) /* PRQA S 4304 */ /* AutosarBoolean */
      {
...
# if (J1939RM_ISOBUSCHANNELOFCHANNEL == STD_ON)
        /* PRQA S 4558 3 */ /* MD_MSR_AutosarBoolean */
        if (J1939Rm_IsIsobusChannelOfChannel(channelIdx) &&
            J1939Rm_IsIsobusChannelOfChannel(J1939Rm_GetChannelIdxOfComMChannel(destComMChannel)) &&
            (da != J1939RM_BROADCAST_ADDRESS))
        {
          isBroadcast = FALSE;
        }
# endif

        (void) J1939Rm_InternalTransmitAck(J1939Rm_GetChannelIdxOfComMChannel(destComMChannel), pgn, ackCb, extId1,
                                           extId2, extId3, ackAddress, sa, priority, isBroadcast,
                                           J1939RM_UNUSED_NODE_CHANNEL_STATE_IDX);
      }
    }
    /* #30 Otherwise: */
    ...
    {
      J1939Rm_ChannelIterType destChannelIdx;
      NetworkHandleType comMChannelId = J1939Rm_GetComMChannelIdOfChannel(channelIdx);

      /* #40 Check for each channel if there is a routing configuration in J1939Nm from the source channel of the
         Acknowledgement to the current explored channel. If the channels have a routing configuration, trigger the
         transmission of the Acknowledgement on the current explored channel. */
      for (destChannelIdx = 0; destChannelIdx < J1939Rm_GetSizeOfChannel(); destChannelIdx++)
      {
        if (channelIdx != destChannelIdx)
        {
          if (J1939Nm_CheckNodeChannelByAddress(comMChannelId, sa,
                                                J1939Rm_GetComMChannelIdOfChannel(destChannelIdx)) == TRUE)
          {
            boolean isBroadcast = TRUE;

# if (J1939RM_ISOBUSCHANNELOFCHANNEL == STD_ON)
            /* PRQA S 4558 2 */ /* MD_MSR_AutosarBoolean */
            if (J1939Rm_IsIsobusChannelOfChannel(channelIdx) && J1939Rm_IsIsobusChannelOfChannel(destChannelIdx) &&
                (da != J1939RM_BROADCAST_ADDRESS))
            {
              isBroadcast = FALSE;
            }
# endif
            ...
            (void) J1939Rm_InternalTransmitAck(destChannelIdx, pgn, ackCb, extId1, extId2, extId3, ackAddress, sa,
                                               priority, isBroadcast, J1939RM_UNUSED_NODE_CHANNEL_STATE_IDX);
          }
        }
      }
    }
  }
} /* J1939Rm_InternalAckRouting() */ /* PRQA S 6060, 6080 */ /* MD_MSR_STPAR, MD_MSR_STMIF */
#endif
                                                                         ...
                                                                         uint8 destAddress, uint8 priority, uint8 ackCb)
{
  ...
  boolean isLocalUseCase = FALSE;

  /* #10 Check if the PGN of the received Request is valid: */
  if (J1939Rm_PGN_Valid(requestedPgn)) /* PRQA S 2985 */ /* MD_J1939Rm_2.2 */
  {
         ...
         channelNodeIdx < J1939Rm_GetChannelNodeNodeTableIndEndIdxOfChannel(channelIdx); channelNodeIdx++)
    {
      ...
      boolean isLocalNode = (destAddress == nodeAddr); /* PRQA S 4404 */ /* MD_MSR_AutosarBoolean */

      isLocalUseCase = isLocalUseCase || isLocalNode;
      ...
      if (((nodeChannelState == J1939RM_STATE_ONLINE) || (requestedPgn == J1939RM_PGN_AC)) &&
          ((destAddress == J1939RM_BROADCAST_ADDRESS) || (isLocalNode == TRUE)))
      {
        boolean found = FALSE;
          ...
          if (J1939Rm_GetUserTypeOfUser(userIdx) == J1939RM_USER_COM_USERTYPEOFUSER)
          {
            found =
              J1939Rm_InternalProcessRequestForComIPdu(channelIdx, userIdx, requestedPgn, extIdInfo,
                                                       nodeAddr, sourceAddress, destAddress, priority) || found;
          }
          else
#endif
          {
            found =
              J1939Rm_InternalProcessRequestIndication(channelIdx, nodeIdx, userIdx, requestedPgn,
                                                       extIdInfo, sourceAddress, destAddress, priority) || found;
          }
        }
         ...
         */
        if ((!found) && (destAddress != J1939RM_BROADCAST_ADDRESS)) /* PRQA S 4558, 4116 */ /* MD_MSR_AutosarBoolean */
        {
...
#if ((J1939RM_RUNTIME_ERROR_REPORT == STD_ON) && (J1939RM_ACKQUEUEINDUSEDOFCHANNEL == STD_ON))
          if (result != E_OK)
          {
            J1939Rm_ReportRuntimeError(J1939RM_SID_RXINDICATION, J1939RM_E_ACK_QUEUE_OVERRUN);
          }
#else
          J1939RM_DUMMY_STATEMENT(result); /* PRQA S 3112, 1338, 2983, 2982 */ /* MD_MSR_DummyStmt */
#endif
        }
      }
    }
  ...
  return !isLocalUseCase; /* PRQA S 4558, 4404, 4116 */ /* MD_MSR_AutosarBoolean */
 ...
 */
J1939RM_LOCAL_INLINE FUNC(void, J1939RM_CODE)
J1939Rm_InternalReceiveRequest(J1939Rm_ChannelIdxOfRxPduType channelIdx,
                               P2CONST(PduInfoType, AUTOMATIC, J1939RM_APPL_DATA) PduInfoPtr,
                               boolean isCalledFromExtern, boolean extFrameFormat)
{
...
# endif
...
#endif
  {
    uint8 destAddress;
    uint8 priority;
    boolean isGatewayUseCase = FALSE;

    /* #20 Get the data from the received Request. */
    uint32 requestedPgn = J1939Rm_Get_PGN(PduInfoPtr->SduDataPtr[J1939RM_RQST_PGN_LO], /* PRQA S 1891 */ /* MD_J1939Rm_10.7 */
    ...
    if (extFrameFormat == FALSE)
    {
      destAddress = J1939RM_BROADCAST_ADDRESS;
      priority = J1939RM_DEFAULT_PRIORITY;
    } 
    else
#endif
    {
      destAddress = PduInfoPtr->SduDataPtr[J1939RM_RQST_DA_POS];
      priority = J1939Rm_Get_Priority(PduInfoPtr->SduDataPtr[J1939RM_RQST_PRI_POS]);
    }
        ...
        (sourceAddress != J1939RM_BROADCAST_ADDRESS))
    {
      ...
      isGatewayUseCase = J1939Rm_InternalProcessRequest(channelIdx, requestedPgn, &extIdInfo, sourceAddress,
                                                        destAddress, priority, J1939RM_ACK_NEGATIVE);
    }
#if (J1939RM_RUNTIME_ERROR_REPORT == STD_ON)
    else
    {
...
#if (J1939RM_GATEWAY_SUPPORT == STD_ON)
    /* #40 Trigger the routing of the Request. */
    J1939Rm_InternalRequestRouting(channelIdx, sourceAddress, destAddress, requestedPgn, priority, J1939RM_SNA_VALUE,
                                   &extIdInfo, FALSE, isGatewayUseCase, isCalledFromExtern);
#else
    J1939RM_DUMMY_STATEMENT(isGatewayUseCase); /* PRQA S 3112, 2983 */ /* MD_MSR_DummyStmt */
#endif
  }
  ...
  J1939RM_DUMMY_STATEMENT(isCalledFromExtern); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
  J1939RM_DUMMY_STATEMENT(extFrameFormat); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
} /* J1939Rm_InternalReceiveRequest() */
 ...
 */
J1939RM_LOCAL_INLINE FUNC(void, J1939RM_CODE)
J1939Rm_InternalReceiveRequest2(J1939Rm_ChannelIdxOfRxPduType channelIdx,
                                P2CONST(PduInfoType, AUTOMATIC, J1939RM_APPL_DATA) PduInfoPtr,
                                boolean isCalledFromExtern, boolean extFrameFormat)
{
# if (J1939RM_CANIF_DLCCHECK == STD_OFF)
...
# endif
  {
    ...
    uint32 requestedPgn = J1939Rm_Get_PGN(PduInfoPtr->SduDataPtr[J1939RM_RQST2_PGN_LO], /* PRQA S 1891 */ /* MD_J1939Rm_10.7 */
    ...
    uint8 sourceAddress = PduInfoPtr->SduDataPtr[J1939RM_RQST2_SA_POS]; /* PRQA S 2841 */ /* MD_J1939Rm_2841 */
...
#endif
    {
      destAddress = PduInfoPtr->SduDataPtr[J1939RM_RQST2_DA_POS]; /* PRQA S 2841 */ /* MD_J1939Rm_2841 */
      priority = J1939Rm_Get_Priority(PduInfoPtr->SduDataPtr[J1939RM_RQST2_PRI_POS]); /* PRQA S 2841 */ /* MD_J1939Rm_2841 */
    }
        ...
        (J1939Rm_GetTransferType(specInstr) != J1939RM_RQST2_TRANSFER_YES))
    {
          ...
          (sourceAddress != J1939RM_BROADCAST_ADDRESS))
      {
        ...
        default: /* COV_J1939RM_MISRA */
          extIdInfo.ExtIdType = J1939RM_EXTID_NONE; /* MISRA */
          break;
        }
...
# if (J1939RM_GATEWAY_SUPPORT == STD_ON)
    /* #40 Trigger the routing of the Request2. */
    J1939Rm_InternalRequestRouting(channelIdx, sourceAddress, destAddress, requestedPgn, priority, specInstr,
                                   &extIdInfo, TRUE, isGatewayUseCase, isCalledFromExtern);
# else
    J1939RM_DUMMY_STATEMENT(isGatewayUseCase); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
# endif
  }
# if ((J1939RM_CANIF_DLCCHECK == STD_OFF) && (J1939RM_RUNTIME_ERROR_REPORT == STD_ON))
  else
 ...
 */
J1939RM_LOCAL_INLINE FUNC(boolean, J1939RM_CODE)
J1939Rm_InternalProcessAck(J1939Rm_ChannelIdxOfRxPduType channelIdx,
                           P2CONST(PduInfoType, AUTOMATIC, J1939RM_APPL_DATA) PduInfoPtr,
                           J1939Rm_AckCode ackCode, uint8 extIdCode, uint32 pgn, boolean extFrameFormat)
{
  /* ----- Local Variables ---------------------------------------------- */
  uint8 ackAddress = PduInfoPtr->SduDataPtr[J1939RM_ACKM_ADDR];
  uint8 sa = PduInfoPtr->SduDataPtr[J1939RM_ACKM_SA_POS]; /* PRQA S 2841 */ /* MD_J1939Rm_2841 */
  boolean isGatewayUseCase = TRUE;

  J1939RM_DUMMY_STATEMENT(pgn); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
  J1939RM_DUMMY_STATEMENT(extIdCode); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
  J1939RM_DUMMY_STATEMENT(ackCode); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
  J1939RM_DUMMY_STATEMENT(extFrameFormat); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
...
# endif
         ...
         channelNodeIdx < J1939Rm_GetChannelNodeNodeTableIndEndIdxOfChannel(channelIdx); channelNodeIdx++)
    {
      ...
      /* #30 If the Acknowledgement is addressed to the current explored node: */
      if (ackAddress == nodeAddr)
      {
# if (J1939RM_SUPPORT_ACK_INDICATION == STD_ON)
        ...
        if (nodeChannelState == J1939RM_STATE_ONLINE)
        {
          ...
          /* #40 Go through all user of the current explored node. */
          for (nodeUserIdx = J1939Rm_GetNodeUserUserTableIndStartIdxOfNode(nodeIdx);
               nodeUserIdx < J1939Rm_GetNodeUserUserTableIndEndIdxOfNode(nodeIdx); nodeUserIdx++)
          {
            J1939Rm_UserUserIdxOfNodeUserType userIdx = J1939Rm_GetUserUserIdxOfNodeUser(nodeUserIdx);

            /* #50 If the current explored user is configured to receive this Acknowledgment, process it. */
...
#  endif
              {
                priority = J1939Rm_Get_Priority(PduInfoPtr->SduDataPtr[J1939RM_ACKM_PRI_POS]); /* PRQA S 2841 */ /* MD_J1939Rm_2841 */
              }
...
# endif
        ...
        isGatewayUseCase = FALSE;
      }
    }
  }

  return isGatewayUseCase;
} /* J1939Rm_InternalProcessAck() */ /* PRQA S 6060, 6080 */ /* MD_MSR_STPAR, MD_MSR_STMIF */
#endif
 ...
 */
J1939RM_LOCAL_INLINE FUNC(void, J1939RM_CODE)
J1939Rm_InternalReceiveAck(J1939Rm_ChannelIdxOfRxPduType channelIdx,
                           P2CONST(PduInfoType, AUTOMATIC, J1939RM_APPL_DATA) PduInfoPtr, boolean isCalledFromExtern)
{
# if ((J1939RM_CANIF_DLCCHECK == STD_OFF) || (J1939RM_CANFDCHANNELOFCHANNEL == STD_ON))
  J1939Rm_MetaDataLengthOfRxPduType mdlSize = J1939Rm_GetMetaDataLengthOfRxPdu(J1939Rm_GetRxPduAckmIdxOfChannel(channelIdx));
# endif

# if (J1939RM_CANIF_DLCCHECK == STD_OFF)
  /* #10 If CanIf DLC check is disabled, check the length of the received acknowledgment and stop processing on error. */
  if (PduInfoPtr->SduLength == (uint8)(J1939RM_ACKM_FRAME_LENGTH + mdlSize))
# endif
  {
    boolean extFrameFormat = TRUE;
    boolean isGatewayUseCase = FALSE;
...
# if (((J1939RM_RUNTIME_ERROR_REPORT == STD_ON) && (J1939RM_ISOBUSCHANNELOFCHANNEL == STD_ON)) || (J1939RM_GATEWAY_SUPPORT == STD_ON))
    uint8 ackAddress = PduInfoPtr->SduDataPtr[J1939RM_ACKM_ADDR];
# endif
    /* PRQA S 2841 1 */ /* MD_J1939Rm_2841 */
    uint32 pgn = J1939Rm_Get_PGN(PduInfoPtr->SduDataPtr[J1939RM_ACKM_PGN_LO], /* PRQA S 1891 */ /* MD_J1939Rm_10.7 */
                                 PduInfoPtr->SduDataPtr[J1939RM_ACKM_PGN_MD],
                                 PduInfoPtr->SduDataPtr[J1939RM_ACKM_PGN_HI]);
# if ((J1939RM_RUNTIME_ERROR_REPORT == STD_ON) || (J1939RM_GATEWAY_SUPPORT == STD_ON))
    uint8 da;

#  if (J1939RM_CANFDCHANNELOFCHANNEL == STD_ON)
    if (mdlSize == J1939RM_MDL_SIZE_11BIT)
    {
      da = J1939RM_BROADCAST_ADDRESS;
      extFrameFormat = FALSE;
    }
...
#  endif
    {
      da = PduInfoPtr->SduDataPtr[J1939RM_ACKM_DA_POS]; /* PRQA S 2841 */ /* MD_J1939Rm_2841 */
    }
# endif
...
# endif
    ...
    if (J1939Rm_PGN_Valid(pgn)) /* PRQA S 2985 */ /* MD_J1939Rm_2.2 */
    {
...
# endif
      ...
      {
        isGatewayUseCase = J1939Rm_InternalProcessAck(channelIdx, PduInfoPtr, ackCode, extIdCode, pgn, extFrameFormat);
      }
    }
# if (J1939RM_RUNTIME_ERROR_REPORT == STD_ON)
    /* #70 Otherwise, report a runtime error. */
    else
    {
      J1939Rm_ReportRuntimeError(J1939RM_SID_RXINDICATION, J1939RM_E_BAD_PGN);
    }
...
# if (J1939RM_GATEWAY_SUPPORT == STD_ON)
    {
      /* #80 Trigger Acknowledgment routing. */
      J1939Rm_InternalAckRouting(channelIdx, PduInfoPtr, da, ackAddress, pgn, ackCb, isGatewayUseCase,
                                 isCalledFromExtern, extFrameFormat);
    }
# else
    J1939RM_DUMMY_STATEMENT(isGatewayUseCase); /* PRQA S 3112, 2983 */ /* MD_MSR_DummyStmt */
# endif
...
# if ((J1939RM_CANIF_DLCCHECK == STD_OFF) && (J1939RM_RUNTIME_ERROR_REPORT == STD_ON))
  /* #90 Otherwise, report a runtime error. */
  else
  {
    J1939Rm_ReportRuntimeError(J1939RM_SID_RXINDICATION, J1939RM_E_INVALID_PDU_SIZE);
  }
                                                                       ...
                                                                       uint8 serviceId)
{
  ...
  J1939RM_DUMMY_STATEMENT(serviceId); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */

  /* #10 Find first active message in the queue while discarding all queued messages of offline nodes: */
  while (channelState->AckQueueFree < J1939Rm_GetAckQueueSizeOfChannel(channelIdx))
  {
    /* #20 Enter J1939RM_EXCLUSIVE_AREA_ACKQUEUELOCK. */
    SchM_Enter_J1939Rm_J1939RM_EXCLUSIVE_AREA_ACKQUEUELOCK();

    /* #30 If active message was found: */
    if (channelState->AckQueueFree < J1939Rm_GetAckQueueSizeOfChannel(channelIdx)) /* COV_J1939RM_CONCURRENT_CHANGE */
    {
      /* #40 Get the oldest element from the acknowledgment queue. */
      const J1939Rm_AckQueueElementType *elem = &J1939Rm_GetAckQueue(channelState->AckQueueRead);
      ...
      channelState->AckQueueRead++;

      /* #50 If the removed element was on the last queue position, handle queue pointer wrap around. */
      if (channelState->AckQueueRead == J1939Rm_GetAckQueueIndEndIdxOfChannel(channelIdx))
      {
        channelState->AckQueueRead = J1939Rm_GetAckQueueIndStartIdxOfChannel(channelIdx);
      }
      ...
      if ((nodeChannelStateIdx == J1939RM_UNUSED_NODE_CHANNEL_STATE_IDX) ||
...
# if (J1939RM_RUNTIME_ERROR_REPORT == STD_ON)
        if (result != E_OK) /* COV_J1939RM_ACKQUEUE */
        {
                                                                        ...
                                                                        uint8 serviceId)
{
  ...
  /* #10 Find first active message in the queue while discarding all queued messages of offline nodes: */
  while (channelState->ReqQueueFree < J1939Rm_GetRequestQueueSizeOfChannel(channelIdx))
  {
    /* #20 Enter J1939RM_EXCLUSIVE_AREA_REQQUEUELOCK. */
    SchM_Enter_J1939Rm_J1939RM_EXCLUSIVE_AREA_REQQUEUELOCK();

    /* #30 If active message was found: */
    if (channelState->ReqQueueFree < J1939Rm_GetRequestQueueSizeOfChannel(channelIdx)) /* COV_J1939RM_CONCURRENT_CHANGE */
    {
      /* #40 Get the oldest queue element from the Request queue. */
      const J1939Rm_ReqQueueElementType *elem = &J1939Rm_GetReqQueue(channelState->ReqQueueRead);
      ...
      channelState->ReqQueueRead++;

      /* #50 If the removed element was on the last queue position, handle queue pointer wrap around. */
      if (channelState->ReqQueueRead == J1939Rm_GetReqQueueIndEndIdxOfChannel(channelIdx))
      {
        channelState->ReqQueueRead = J1939Rm_GetReqQueueIndStartIdxOfChannel(channelIdx);
      }
      ...
      /*
       * #70 If the queued element is an Request for address claim from the J1939Nm or if not, check if the node which
       * wants to send the message is still online:
       */
      if ((nodeChannelStateIdx == J1939RM_UNUSED_NODE_CHANNEL_STATE_IDX) ||
          (J1939Rm_GetNodeChannelState(nodeChannelStateIdx) == J1939RM_STATE_ONLINE))
      {
        /* #80 Send a Request message. */
        result = /* PRQA S 2983 */ /* MD_MSR_DummyStmt */
          J1939Rm_InternalTransmitRequest(channelIdx, requestedPgn, sourceAddress, destAddress, priority,
                                          nodeChannelStateIdx);

# if (J1939RM_RUNTIME_ERROR_REPORT == STD_ON)
        if (result != E_OK) /* COV_J1939RM_REQQUEUE */
        {
                                                                         ...
                                                                         uint8 serviceId)
{
  ...
  /* #10 Find first active message in the queue while discarding all queued messages of offline nodes: */
  while (channelState->Req2QueueFree < J1939Rm_GetRequest2QueueSizeOfChannel(channelIdx))
  {
    /* #20 Enter J1939RM_EXCLUSIVE_AREA_REQ2QUEUELOCK. */
    SchM_Enter_J1939Rm_J1939RM_EXCLUSIVE_AREA_REQ2QUEUELOCK();

    /* #30 If active message was found: */
    if (channelState->Req2QueueFree < J1939Rm_GetRequest2QueueSizeOfChannel(channelIdx)) /* COV_J1939RM_CONCURRENT_CHANGE */
    {
      /* #40 Get the oldest queue element from the Request2 queue. */
      const J1939Rm_Req2QueueElementType *elem = &J1939Rm_GetReq2Queue(channelState->Req2QueueRead);
      ...
      channelState->Req2QueueRead++;

      /* #50 If the removed element was on the last queue position, handle queue pointer wrap around. */
      if (channelState->Req2QueueRead == J1939Rm_GetReq2QueueIndEndIdxOfChannel(channelIdx))
      {
        channelState->Req2QueueRead = J1939Rm_GetReq2QueueIndStartIdxOfChannel(channelIdx);
      }
      ...
      /*
       * #70 If the queued element is an Request2 for address claim from the J1939Nm or if not, check if the node which
       * wants to send the message is still online:
       */
      if ((nodeChannelStateIdx == J1939RM_UNUSED_NODE_CHANNEL_STATE_IDX) ||
          (J1939Rm_GetNodeChannelState(nodeChannelStateIdx) == J1939RM_STATE_ONLINE))
...
# if (J1939RM_RUNTIME_ERROR_REPORT == STD_ON)
        if (result != E_OK) /* COV_J1939RM_REQ2QUEUE */
        {
...
J1939RM_LOCAL_INLINE FUNC(void, J1939RM_CODE) J1939Rm_InternalInit(void)
{
...
#if ((J1939RM_ACKQUEUEINDUSEDOFCHANNEL == STD_ON) || (J1939RM_REQQUEUEINDUSEDOFCHANNEL == STD_ON) || (J1939RM_REQ2QUEUEINDUSEDOFCHANNEL == STD_ON))
  ...
  {
    J1939Rm_GetTxPduState(txPduStateIdx).Locked = FALSE; /* VCA_J1939RM_TXPDUSTATE_CSL01 */
  }
...
# if (J1939RM_ACKQUEUEINDUSEDOFCHANNEL == STD_ON)
    J1939Rm_GetChannelState(channelStateIdx).AckQueueFree = J1939Rm_GetAckQueueSizeOfChannel(channelStateIdx); /* VCA_J1939RM_CHANNELSTATE_CSL01 */
    startPos = (uint16) J1939Rm_GetAckQueueIndStartIdxOfChannel(channelStateIdx);
    J1939Rm_GetChannelState(channelStateIdx).AckQueueRead = startPos; /* VCA_J1939RM_CHANNELSTATE_CSL01 */
    J1939Rm_GetChannelState(channelStateIdx).AckQueueWrite = startPos; /* VCA_J1939RM_CHANNELSTATE_CSL01 */
# endif

# if (J1939RM_REQQUEUEINDUSEDOFCHANNEL == STD_ON)
    J1939Rm_GetChannelState(channelStateIdx).ReqQueueFree = J1939Rm_GetRequestQueueSizeOfChannel(channelStateIdx); /* VCA_J1939RM_CHANNELSTATE_CSL01 */
    startPos = (uint16) J1939Rm_GetReqQueueIndStartIdxOfChannel(channelStateIdx);
    J1939Rm_GetChannelState(channelStateIdx).ReqQueueRead = startPos; /* VCA_J1939RM_CHANNELSTATE_CSL01 */
    J1939Rm_GetChannelState(channelStateIdx).ReqQueueWrite = startPos; /* VCA_J1939RM_CHANNELSTATE_CSL01 */
# endif

# if (J1939RM_REQ2QUEUEINDUSEDOFCHANNEL == STD_ON)
    J1939Rm_GetChannelState(channelStateIdx).Req2QueueFree = J1939Rm_GetRequest2QueueSizeOfChannel(channelStateIdx); /* VCA_J1939RM_CHANNELSTATE_CSL01 */
    startPos = (uint16) J1939Rm_GetReq2QueueIndStartIdxOfChannel(channelStateIdx);
    J1939Rm_GetChannelState(channelStateIdx).Req2QueueRead = startPos; /* VCA_J1939RM_CHANNELSTATE_CSL01 */
    J1939Rm_GetChannelState(channelStateIdx).Req2QueueWrite = startPos; /* VCA_J1939RM_CHANNELSTATE_CSL01 */
# endif
  }
#endif
  ...
  {
    J1939Rm_SetNodeChannelState(nodeChannelStateIdx, J1939RM_STATE_OFFLINE); /* VCA_J1939RM_NODECHANNELSTATE_CSL01 */
  }
...
J1939RM_LOCAL_INLINE FUNC(void, J1939RM_CODE) J1939Rm_InternalMainFunction(void)
{
  ...
  for (txPduStateIdx = 0; txPduStateIdx < J1939Rm_GetSizeOfTxPduState(); txPduStateIdx++)
  {
    J1939Rm_TxPduStateType *txPduState = &J1939Rm_GetTxPduState(txPduStateIdx);
    ...
    {
      --txPduState->ConfTimeout; /* VCA_J1939RM_TXPDUSTATE_CSL01 */
...
#if ((J1939RM_ACKQUEUEINDUSEDOFCHANNEL == STD_ON) || (((J1939RM_REQQUEUEINDUSEDOFCHANNEL == STD_ON) || (J1939RM_REQ2QUEUEINDUSEDOFCHANNEL == STD_ON)) && ((J1939RM_SUPPORT_REQUEST_TRANSMISSION == STD_ON) || (J1939RM_GATEWAY_SUPPORT == STD_ON))))
  {
 ...
 *
 */
J1939RM_LOCAL_INLINE FUNC(Std_ReturnType, J1939RM_CODE)
J1939Rm_InternalSendRequest(uint8 userId, NetworkHandleType channel, uint32 requestedPgn,
                            P2CONST(J1939Rm_ExtIdInfoType, AUTOMATIC, J1939RM_APPL_DATA) extIdInfo, uint8 destAddress,
                            uint8 priority, boolean checkTimeout)
{
  Std_ReturnType result = E_NOT_OK; /* PRQA S 2981 */ /* MD_MSR_RetVal */

  J1939RM_DUMMY_STATEMENT(userId); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
  J1939RM_DUMMY_STATEMENT(extIdInfo); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
  J1939RM_DUMMY_STATEMENT(checkTimeout); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */

  {
    uint8 sourceAddress;
# if (J1939RM_USERSENDREQUESTOFUSER == STD_ON) /* COV_J1939RM_SEND_REQUEST */
...
# endif
    {
# if (J1939RM_USERSENDREQUESTOFUSER == STD_ON) /* COV_J1939RM_SEND_REQUEST */
      nodeIdx = J1939RM_NO_NODEIDOFNODE; /* PRQA S 2983 */ /* MD_MSR_DummyStmt */
# endif
      sourceAddress = J1939RM_NULL_ADDRESS;
    }
# if (J1939RM_USERSENDREQUESTOFUSER == STD_ON) /* COV_J1939RM_SEND_REQUEST */
...
# endif

    {
      ...
      /* @ assert channelIdx < J1939Rm_GetSizeOfChannel(); */ /* VCA_J1939RM_CHANNEL_VIA_COMMCHANNEL_CSL03 */
# if (J1939RM_USERSENDREQUESTOFUSER == STD_ON) /* COV_J1939RM_SEND_REQUEST */
      J1939Rm_ChannelNodeNodeTableIndIterType channelNodeIdx;

      /* #10 Go through all nodes of the channel to send the Request on: */
      for (channelNodeIdx = J1939Rm_GetChannelNodeNodeTableIndStartIdxOfChannel(channelIdx);
           channelNodeIdx < J1939Rm_GetChannelNodeNodeTableIndEndIdxOfChannel(channelIdx); /* COV_J1939RM_END_OF_LOOP */
           channelNodeIdx++)
# endif
      {
# if (J1939RM_USERSENDREQUESTOFUSER == STD_ON) /* COV_J1939RM_SEND_REQUEST */
...
# if (J1939RM_USERSENDREQUESTOFUSER == STD_ON) /* COV_J1939RM_SEND_REQUEST */
          if (userId == J1939RM_NULLADDRESS_USER_ID)
          {
            nodeChannelStateIdx = J1939RM_UNUSED_NODE_CHANNEL_STATE_IDX;
          }
          else
          {
...
# if (J1939RM_SUPPORT_REQUEST2 == STD_ON)
            ...
            {
              uint8 specInstr = J1939RM_RQST2_EXTIDTYPE_NA; /* PRQA S 2981 */ /* MD_MSR_RetVal */
              uint8 extId1 = J1939RM_EXTID_UNUSED; /* PRQA S 2981 */ /* MD_MSR_RetVal */
              ...
              result = J1939Rm_InternalTransmitRequest2(channelIdx, requestedPgn, specInstr, extId1, extId2, extId3,
                                                        sourceAddress, destAddress, priority, nodeChannelStateIdx);
#  if ((J1939RM_RUNTIME_ERROR_REPORT == STD_ON) && (J1939RM_REQ2QUEUEINDUSEDOFCHANNEL == STD_ON))
              if (result != E_OK)
              {
...
# endif
              /* #50 Otherwise, trigger the transmission as Request message. \trace SPEC-2167415 */
            {
              result =
                J1939Rm_InternalTransmitRequest(channelIdx, requestedPgn, sourceAddress, destAddress, priority,
                                                nodeChannelStateIdx);
# if ((J1939RM_RUNTIME_ERROR_REPORT == STD_ON) && (J1939RM_REQQUEUEINDUSEDOFCHANNEL == STD_ON))
              if (result != E_OK)
              {
 ...
 */
J1939RM_LOCAL_INLINE FUNC(Std_ReturnType, J1939RM_CODE)
J1939Rm_InternalSendAck(uint8 userId, NetworkHandleType channel, uint32 ackPgn,
                        P2CONST(J1939Rm_ExtIdInfoType, AUTOMATIC, J1939RM_APPL_DATA) extIdInfo,
                        J1939Rm_AckCode ackCode, uint8 ackAddress, uint8 priority, boolean broadcast)
{
  Std_ReturnType result = E_NOT_OK;
 ...
 *
 */
J1939RM_LOCAL_INLINE FUNC(void, J1939RM_CODE) J1939Rm_InternalSetState(NetworkHandleType channel,
                                                                       uint8 node, J1939Rm_StateType newState)
{
       ...
       channelNodeIdx++)
  {
    if (nodeIdx == J1939Rm_GetNodeNodeIdxOfChannelNode(channelNodeIdx))
    {
      ...
      J1939Rm_NodeChannelStateIdxOfChannelNodeType nodeChannelStateIdx =
        J1939Rm_GetNodeChannelStateIdxOfChannelNode(channelNodeIdx);
      J1939Rm_SetNodeChannelState(nodeChannelStateIdx, newState); /* VCA_J1939RM_NODECHANNELSTATE_CSL03 */
 ...
 */
J1939RM_LOCAL_INLINE FUNC(void, J1939RM_CODE)
J1939Rm_InternalRxIndication(PduIdType RxPduId,
                             P2CONST(PduInfoType, AUTOMATIC, J1939RM_APPL_DATA) PduInfoPtr,
                             boolean isRxIndicationExtern)
{
  J1939Rm_ChannelIdxOfRxPduType channelIdx = J1939Rm_GetChannelIdxOfRxPdu(RxPduId);
  /* @ assert channelIdx < J1939Rm_GetSizeOfChannel(); */ /* VCA_J1939RM_CHANNEL_VIA_RXPDU_CSL03 */
  ...
  case J1939RM_PDU_RQST_PDUTYPEOFRXPDU:
    ...
    J1939Rm_InternalReceiveRequest(channelIdx, PduInfoPtr, isRxIndicationExtern, TRUE);
    break;

#if (J1939RM_CANFDCHANNELOFCHANNEL == STD_ON)
  case J1939RM_PDU_RQST_BC_PDUTYPEOFRXPDU:
    /* #30 If it is a Request Bc message, call the receive Request function. */
    J1939Rm_InternalReceiveRequest(channelIdx, PduInfoPtr, isRxIndicationExtern, FALSE);
    break;
#endif

#if (J1939RM_SUPPORT_REQUEST2 == STD_ON)
  case J1939RM_PDU_RQST2_PDUTYPEOFRXPDU:
    /* #40 If it is a Request2 message, call the receive Request2 function. */
    J1939Rm_InternalReceiveRequest2(channelIdx, PduInfoPtr, isRxIndicationExtern, TRUE);
    break;

# if (J1939RM_CANFDCHANNELOFCHANNEL == STD_ON)
  case J1939RM_PDU_RQST2_BC_PDUTYPEOFRXPDU:
    /* #50 If it is a Request2 Bc message, call the receive Request2 function. */
    J1939Rm_InternalReceiveRequest2(channelIdx, PduInfoPtr, isRxIndicationExtern, FALSE);
    break;
# endif
#endif
  ...
  case J1939RM_PDU_ACKM_PDUTYPEOFRXPDU:
    /* #60 If it is a Acknowledgment message, call the receive Acknowledgment function. */
    J1939Rm_InternalReceiveAck(channelIdx, PduInfoPtr, isRxIndicationExtern);
    break;
...
J1939RM_LOCAL_INLINE FUNC(void, J1939RM_CODE) J1939Rm_InternalTxConfirmation(PduIdType TxPduId)
{
  ...
  /* @ assert channelIdx < J1939Rm_GetSizeOfChannel(); */ /* VCA_J1939RM_CHANNEL_VIA_TXPDU_CSL03 */
#endif
  J1939Rm_TxPduStateType *txPduState = &J1939Rm_GetTxPduState(J1939Rm_GetTxPduStateIdxOfTxPdu(TxPduId));

  /* #10 Release the state of the confirmed Tx Pdu. */
  txPduState->Locked = FALSE; /* VCA_J1939RM_TXPDUSTATE_VIA_TXPDU_CSL03 */
...
{
  /* ----- Local Variables ---------------------------------------------- */
  uint8 errorId = J1939RM_E_NO_ERROR; /* PRQA S 2981 */ /* MD_MSR_RetVal */

#if (J1939RM_USE_INIT_POINTER == STD_ON)
  J1939Rm_ConfigDataPtr = config;
#endif
  J1939RM_DUMMY_STATEMENT(config); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
  ...
  {
    errorId = J1939RM_E_REINIT; /* PRQA S 2981 */ /* MD_MSR_RetVal */
  }
#if (J1939RM_USE_INIT_POINTER == STD_ON)
  ...
  {
# if (J1939RM_USE_ECUM_BSW_ERROR_HOOK == STD_ON) /* COV_J1939RM_INIT_POINTER */
...
# if (J1939RM_FINALMAGICNUMBER == STD_ON) /* COV_J1939RM_INIT_POINTER */
...
# endif
  ...
  else
  {
    ...
    if (config != NULL_PTR)
    {
      errorId = J1939RM_E_PARAM_POINTER; /* PRQA S 2981 */ /* MD_MSR_RetVal */
    }
#endif
    /* ----- Implementation ----------------------------------------------- */
...
#else
  J1939RM_DUMMY_STATEMENT(errorId); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
#endif
} /* J1939Rm_Init() */
...
FUNC(void, J1939RM_CODE) J1939Rm_DeInit(void)
{
  ...
  {
    errorId = J1939RM_E_UNINIT; /* PRQA S 2981 */ /* MD_MSR_RetVal */
  }
...
# endif
  {
    ...
    versionInfo->vendorID = J1939RM_VENDOR_ID; /* VCA_J1939RM_VERSIONINFO */
    versionInfo->moduleID = J1939RM_MODULE_ID; /* VCA_J1939RM_VERSIONINFO */
    versionInfo->sw_major_version = J1939RM_SW_MAJOR_VERSION; /* VCA_J1939RM_VERSIONINFO */
    versionInfo->sw_minor_version = J1939RM_SW_MINOR_VERSION; /* VCA_J1939RM_VERSIONINFO */
    versionInfo->sw_patch_version = J1939RM_SW_PATCH_VERSION; /* VCA_J1939RM_VERSIONINFO */
  }
 ...
 *
 */
FUNC(Std_ReturnType, J1939RM_CODE)
J1939Rm_SendRequest(uint8 userId, NetworkHandleType channel, uint32 requestedPgn,
                    P2CONST(J1939Rm_ExtIdInfoType, AUTOMATIC, J1939RM_APPL_DATA) extIdInfo, uint8 destAddress,
                    uint8 priority, boolean checkTimeout)
{
  /* ----- Local Variables ---------------------------------------------- */
  ...
  J1939RM_DUMMY_STATEMENT(userId); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
  J1939RM_DUMMY_STATEMENT(channel); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
  J1939RM_DUMMY_STATEMENT(requestedPgn); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
  J1939RM_DUMMY_STATEMENT(extIdInfo); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
  J1939RM_DUMMY_STATEMENT(destAddress); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
  J1939RM_DUMMY_STATEMENT(priority); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
  J1939RM_DUMMY_STATEMENT(checkTimeout); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
...
# endif
  ...
  {
    errorId = J1939RM_E_INVALID_USER; /* PRQA S 2981 */ /* MD_MSR_RetVal */
  }
  /*
   * #30 If required check that the user is the special case to send a Request with the NULL address as source address
   * or that the user is allowed to send Request messages.
   */
...
# endif
  ...
  {
    errorId = J1939RM_E_INVALID_API; /* PRQA S 2981 */ /* MD_MSR_RetVal */
  }
  /* #40 Check that the channel is valid. */
  else if (!J1939Rm_Channel_Valid(channel)) /* PRQA S 4304 */ /* AutosarBoolean */
  {
    errorId = J1939RM_E_INVALID_NETWORK_ID; /* PRQA S 2981 */ /* MD_MSR_RetVal */
  }
  /* #50 Check that the PGN is valid. */
  else if (!J1939Rm_PGN_Valid(requestedPgn)) /* PRQA S 2985 */ /* MD_J1939Rm_2.2 */
  {
    errorId = J1939RM_E_INVALID_PGN; /* PRQA S 2981 */ /* MD_MSR_RetVal */
  }
  /* #60 Check that the extended id information are valid. */
  else if (!J1939Rm_ReqExtIdInfo_Valid(extIdInfo))
  {
    errorId = J1939RM_E_INVALID_EXTID_INFO; /* PRQA S 2981 */ /* MD_MSR_RetVal */
  }
  /* #70 Check that the destination address is valid. */
  else if (!J1939Rm_DA_Valid(destAddress))
  {
    errorId = J1939RM_E_INVALID_ADDRESS; /* PRQA S 2981 */ /* MD_MSR_RetVal */
  }
  /* #80 Check that the priority is valid. */
  else if (!J1939Rm_Priority_Valid(priority))
  {
    errorId = J1939RM_E_INVALID_PRIO; /* PRQA S 2981 */ /* MD_MSR_RetVal */
  }
  /* #90 Check that the timeout check parameter is valid. */
  else if ((checkTimeout != TRUE) && (checkTimeout != FALSE)  /* PRQA S 2992, 2996 */ /* MD_J1939Rm_14.1 */)
  {/* PRQA S 2880 1 */ /* MD_J1939Rm_14.1 */
    errorId = J1939RM_E_INVALID_OPTION; /* PRQA S 2981 */ /* MD_MSR_RetVal */
  }
#endif
  ...
  else
  {
    ...
    /* @ assert J1939Rm_Channel_Valid(channel); */ /* VCA_J1939RM_COMMCHANNEL */
    /* @ assert extIdInfo; */ /* VCA_J1939RM_POINTERPASSEDTOPUBLICAPI */
 ...
 */
FUNC(Std_ReturnType, J1939RM_CODE)
J1939Rm_SendAck(uint8 userId, NetworkHandleType channel, uint32 ackPgn,
                P2CONST(J1939Rm_ExtIdInfoType, AUTOMATIC, J1939RM_APPL_DATA) extIdInfo, J1939Rm_AckCode ackCode,
                uint8 ackAddress, uint8 priority, boolean broadcast)
{
  /* ----- Local Variables ---------------------------------------------- */
  Std_ReturnType result = E_NOT_OK;
  uint8 errorId = J1939RM_E_NO_ERROR; /* PRQA S 2981 */ /* MD_MSR_RetVal */
  ...
  J1939RM_DUMMY_STATEMENT(userId); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
  J1939RM_DUMMY_STATEMENT(channel); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
  J1939RM_DUMMY_STATEMENT(ackPgn); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
  J1939RM_DUMMY_STATEMENT(ackCode); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
  J1939RM_DUMMY_STATEMENT(ackAddress); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
  J1939RM_DUMMY_STATEMENT(priority); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
  J1939RM_DUMMY_STATEMENT(broadcast); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
...
# endif
  ...
  /* #50 Check that the PGN is valid. */
  else if (!J1939Rm_PGN_Valid(ackPgn)) /* PRQA S 2985 */ /* MD_J1939Rm_2.2 */
  {
    errorId = J1939RM_E_INVALID_PGN; /* PRQA S 2981 */ /* MD_MSR_RetVal */
  }
  ...
  {
    errorId = J1939RM_E_INVALID_ACK_CODE; /* PRQA S 2981 */ /* MD_MSR_RetVal */
  }
...
FUNC(Std_ReturnType, J1939RM_CODE) J1939Rm_SetState(NetworkHandleType channel, uint8 node, J1939Rm_StateType newState)
{
  ...
  {
    errorId = J1939RM_E_INVALID_NODE; /* PRQA S 2981 */ /* MD_MSR_RetVal */
  }
  /* #40 Check that the state to set is valid. */
  else if (newState > J1939RM_STATE_ONLINE)
  { /* PRQA S 2880 */ /* MD_J1939Rm_14.1 */
    errorId = J1939RM_E_INVALID_STATE; /* PRQA S 2981 */ /* MD_MSR_RetVal */
  }
#endif
                                              ...
                                              P2CONST(PduInfoType, AUTOMATIC, J1939RM_APPL_DATA) PduInfoPtr)
{
  ...
  J1939RM_DUMMY_STATEMENT(PduInfoPtr); /* PRQA S 3112, 1338, 2983 */ /* MD_MSR_DummyStmt */
...
# endif
  ...
  {
    errorId = J1939RM_E_INVALID_PDU_SDU_ID; /* PRQA S 2981 */ /* MD_MSR_RetVal */
  }
  ...
  else
  {
    ...
    /* @ assert RxPduId < J1939Rm_GetSizeOfRxPdu(); */ /* VCA_J1939RM_RXPDU */
#if (J1939RM_INVALIDHNDOFRXPDU == STD_ON)
    /* @ assert !J1939Rm_IsInvalidHndOfRxPdu(RxPduId); */ /* VCA_J1939RM_RXPDU */
#endif
    J1939Rm_InternalRxIndication(RxPduId, PduInfoPtr, TRUE);
  }
...
/* Module specific MISRA deviations:
 ...
 MD_J1939Rm_10.7
      ...
      Risk:       No risk, because the typecast change the uint8 parameter to uint32 before the shift operator.
      Prevention: N/A
  ...
  MD_J1939Rm_14.1
      ...
      Risk:       No risk, because newState and J1939RM_STATE_ONLINE have the same type.
      Prevention: N/A

  MD_J1939Rm_2841
      Reason:     The access of the PduInfoPtr->SduDataPtr seems to be a dereference of an invalid pointer value.
      Risk:       There is no risk because the length is checked when J1939RM_CANIF_DLCCHECK is STD_OFF by J1939Rm. This define is always set
                  to STD_OFF if J1939RmSafeBswChecks is enabled.
                  When J1939RM_CANIF_DLCCHECK is STD_ON and thus the length check is disabled in J1939Rm then CanIf checks the length. 
      Prevention: N/A
...
\ID VCA_J1939RM_CHANNEL_VIA_COMMCHANNEL_CSL03
 \DESCRIPTION Access to Channel via indirection over ComMChannel
 \COUNTERMEASURE \N Qualified use-case CSL03 of ComStackLib

\ID VCA_J1939RM_CHANNEL_VIA_RXPDU_CSL03
 \DESCRIPTION Access to Channel via indirection over RxPdu
 \COUNTERMEASURE \N Qualified use-case CSL03 of ComStackLib

\ID VCA_J1939RM_CHANNEL_VIA_TXPDU_CSL03
 \DESCRIPTION Access to Channel via indirection over TxPdu
 \COUNTERMEASURE \N Qualified use-case CSL03 of ComStackLib

\ID VCA_J1939RM_CHANNELSTATE_CSL01
 \DESCRIPTION Access of ChannelState using ComStackLib
 \COUNTERMEASURE \N Qualified use-case CSL01 of ComStackLib

\ID VCA_J1939RM_CHANNELSTATE_VIA_CHANNEL_CSL03
 \DESCRIPTION Access of ChannelState via indirection over channel
 \COUNTERMEASURE \N Qualified use-case CSL03 of ComStackLib

\ID VCA_J1939RM_COMMCHANNEL
...
\ID VCA_J1939RM_NODECHANNELSTATE_CSL01
 \DESCRIPTION Access of NodeChannelState using ComStackLib
 \COUNTERMEASURE \N Qualified use-case CSL01 of ComStackLib

\ID VCA_J1939RM_POINTERPASSEDTOPUBLICAPI
...
\ID VCA_J1939RM_PTR2LOCAL
 \DESCRIPTION Pointer to a local variable.
 \COUNTERMEASURE \N Pointers to local variables can be safely considered to be valid.

\ID VCA_J1939RM_NODECHANNELSTATE_CSL03
 \DESCRIPTION Access of nodeChannelState via indirection over channel
 \COUNTERMEASURE \N Qualified use-case CSL03 of ComStackLib

\ID VCA_J1939RM_QUEUE
 \DESCRIPTION Access of Req-, Req2- or AckQueue and their Write, Read or Free index.
 \COUNTERMEASURE \R Runtime checks make sure that the indexes are within bounds.

\ID VCA_J1939RM_RXPDU
...
\ID VCA_J1939RM_UNDEF_FCTCALL_PTR2LOCAL
 \DESCRIPTION Function call with a pointer to a local variable as argument.
 \COUNTERMEASURE \N Pointers to local variables can be safely considered to be valid.

\ID VCA_J1939RM_VERSIONINFO
 \DESCRIPTION The function J1939Rm_GetVersionInfo writes to the object referenced by parameter VersionInfo
...
\ID COV_J1939RM_MISRA
  \ACCEPT XX
  \REASON [J1939RM_COV_MISRA]

\ID COV_J1939RM_END_OF_LOOP
  \ACCEPT TX
  \REASON The end of the loop will never be reached because there is always an item in the node list that always checks the if condition above.
          And the if condition above contains a break.

\ID COV_J1939RM_CONCURRENT_CHANGE
  \ACCEPT TX
  \REASON The if condition will never be false because the while loop above checks the same condition.
          To test this if condition a test system that interrupts the execution of the function and invalidates the condition would be necessary.

\ID COV_J1939RM_REQ2QUEUE
  \ACCEPT XF
  \REASON The if condition can only be true when the Request 2 queue is full and J1939Rm_InternalTransmitRequest2 therefore returns E_NOT_OK.
          This can only happen, when this function (J1939Rm_InternalProcessRqst2Queue) is interrupted between the operations to remove a element from the queue and
          the call to J1939Rm_InternalTransmitRequest2. In this interruption, new elements must be added to the Request 2 queue to fill it.
          The scenario with an interruption of a executed function can not be tested with the J1939Rm Test Suite.

\ID COV_J1939RM_REQQUEUE
  \ACCEPT XF
  \REASON The if condition can only be true when the Request queue is full and J1939Rm_InternalTransmitRequest therefore returns E_NOT_OK.
          This can only happen, when this function (J1939Rm_InternalProcessRqstQueue) is interrupted between the operations to remove a element from the queue and
          the call to J1939Rm_InternalTransmitRequest. In this interruption, new elements must be added to the Request queue to fill it.
          The scenario with an interruption of a executed function can not be tested with the J1939Rm Test Suite.

\ID COV_J1939RM_ACKQUEUE
  \ACCEPT XF
  \REASON The if condition can only be true when the Acknoledgment queue is full and J1939Rm_InternalTransmitAck therefore returns E_NOT_OK.
          This can only happen, when this function (J1939Rm_InternalProcessAckQueue) is interrupted between the operations to remove a element from the queue and
          the call to J1939Rm_InternalTransmitAck. In this interruption, new elements must be added to the Acknowledgment queue to fill it.
          The scenario with an interruption of a executed function can not be tested with the J1939Rm Test Suite.

\ID COV_J1939RM_RTEUSERTYPE
  \ACCEPT TX
  \REASON In configurations with J1939RM_RTEACKINDICATION == STD_ON and J1939RM_ACKINDICATION == STD_OFF it is not possible to test with
          userType != J1939RM_USER_RTE_USERTYPEOFUSER because there are only valid ackPgns for a RteUser and validity of the transferred
          pgn is checked in the previous if condition.


--- Preprocessor Coverage Justifications ------------------------------------------------------------------------------

\ID COV_J1939RM_SEND_REQUEST
  \ACCEPT TX
  \REASON The false path of J1939RM_USERSENDREQUESTOFUSER == STD_ON is not relevant for safety considerations without J1939NM.
          The not executed code line is duplicated and tested a few lines above.

\ID COV_J1939RM_LOCAL_TESTSUITE_INSTRUMENTATION
  \ACCEPT TX
  \REASON Not all branches covered because the following preprocessor defines are necessary for test execution: J1939RM_LOCAL, J1939RM_LOCAL_INLINE

\ID COV_J1939RM_INIT_POINTER
  \ACCEPT TX
  \REASON J1939RM_USE_ECUM_BSW_ERROR_HOOK and J1939RM_FINALMAGICNUMBER are always STD_ON when the parent preprocessor define J1939RM_USE_INIT_POINTER is STD_ON.
