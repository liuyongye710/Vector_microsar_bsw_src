 ...
 *  2.02.05  2017-09-29  visgsi  ESCAN00096349  Application receives an acknowledgement that does not refer to the ECU.
 *  2.03.00  2017-11-29  visgsi  ESCAN00088401  Request for multiplexed COM I-PDUs with PduR fan-out to more than one
 *                                              channel fails on all but one of the channels.
 *  3.00.00  2018-04-11  visgsi  STORYC-3893    Routing of RQST/RQST2/ACKM
 *                               ESCAN00099076  J1939Rm transmits wrong Request2 PGs after queuing.
 *  3.00.01  2018-05-14  visgsi   -             Refactored source code.
 *  3.00.02  2018-10-31  visgsi  ESCAN00101101  Acknowledgment message is not routed
 *  4.00.00  2020-05-11  viswca  STORYC-878     Checked J1939_AsrJ1939Rm according to MISRA-C:2012
 *                       visgsi  ESCAN00106175  DA of routed ISOBUS ACKM is always set to broadcast
 *                               ESCAN00106249  J1939Rm does not route a request message in a gateway scenario
 *  4.00.01  2020-07-23  viswca  PERMIL-1986    Fixed Review Findings
 *           2020-09-30  viscnw  ESCAN00107520  Exception in J1939Rm generator during Generation of J1939Rm_PBcfg.c encountered
 *  4.01.00  2021-07-12  visncw  PERMIL-3053    Silent Analysis with new VCA version.
 *                       viscnw  ESCAN00101961  Compiler warning: warning C4100 : unreferenced formal parameter
 *  5.00.00  2021-10-15  viscnw  PERMIL-3561    Solve limitations of J1939-22 CAN-FD
 *  5.00.01  2022-01.28  viscnw  ESCAN00111191  Rqst/Rqst2 Pdus are not transmitted on a CanFD channel using 11bit Can identifier 
 *  5.00.02  2022-02-08  viscnw  ESCAN00111114  BETA version - the BSW module is in BETA state
 *                               ESCAN00111193  BETA version - the BSW module is in BETA state
 *********************************************************************************************************************/
...
# define J1939RM_SW_MAJOR_VERSION               (5u)
# define J1939RM_SW_MINOR_VERSION               (0u)
# define J1939RM_SW_PATCH_VERSION               (2u)
 ...
 *  \spec
 *    requires config == J1939Rm_Config_Ptr;
 *  \endspec
 *********************************************************************************************************************/
 ...
 *  \synchronous TRUE
 *  \spec
 *     requires !extIdInfo || $external(extIdInfo);
 *  \endspec
 *********************************************************************************************************************/
 ...
 * \exclude        J1939Rm_InternalSendRequest, J1939Rm_InternalSetState.
 ...
 * \exclude        J1939Rm_InternalSendAck, J1939Rm_InternalSetState.
 * \length         SHORT Only a few flags are checked. No calls to functions.
 * \endexclusivearea
 */
/*!
 ...
 * \exclude        J1939Rm_InternalRxIndication, J1939Rm_InternalSetState.
 * \length         SHORT Only a few flags are checked. No calls to functions.
 * \endexclusivearea
 */
#endif /* J1939RM_H */
