...
# define ETHTRCV_BAUD_RATE_2500MBIT                 (0x03U)
# define ETHTRCV_BAUD_RATE_5000MBIT                 (0x04U)
# define ETHTRCV_BAUD_RATE_10000MBIT                (0x05U)
...
# define ETHTRCV_CABLEDIAG_PENDING                  (0x04U) /* Cable diagnostic is still running */
# define ETHTRCV_CABLEDIAG_WRONG_POLARITY           (0x05U) /* Wrong polarity detected */
