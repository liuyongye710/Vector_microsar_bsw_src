 ...
 *  02.04.00  2018-01-04  virgmi  STORY-3133    Detect and Create Define Macros for 3rd-party API Infixes in Dualtarget Projects
 *  02.05.00  2018-08-03  virbmz  STORY-7352    Perform MISRA analysis and consider solution (all MCAL components)
 *                                ESCAN00100221 Parameter ChannelGroupId is not used if DIO_DEV_ERROR_DETECT is STD_OFF
 *  02.05.01  2018-08-30  virchl  ESCAN00100560 Compiler error: Dio.c(427): error C2181: illegal else without matching if
 **********************************************************************************************************************/
...
# define DIO_SW_MINOR_VERSION                    (5u)
...
/* ----- Error codes ----- */
# define DIO_E_NO_ERROR                          (0x00u)   /*!< used to check if no error occurred - use a value unequal to any error code */
# define DIO_E_PARAM_INVALID_CHANNEL_ID          (0x0Au)   /* Invalid channel name requested */
# define DIO_E_PARAM_CONFIG                      (0x10u)   /* Invalid config pointer given */
