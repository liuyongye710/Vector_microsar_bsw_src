 ...
 *  02.05.00  2017-01-13  virbmz  FEAT-1824     Support a component-specific SafeBSW configuration switch
 *  02.06.00  2017-12-14  virbmz  STORY-3133    Version number incremented
 *  02.06.01  2018-08-09  virchl  ESCAN00100226 Uninitialized local variable 'TsData' used if ICU_DEV_ERROR_DETECT
 *                                              is STD_OFF
 *                                ESCAN00098179 Icu_Disable/EnableEdgeCount resets EdgeCountValue which contradicts
 *                                              Asr Requirement
 *                                STORYC-6224   Perform MISRA analysis and consider solution (all MCAL components)
 *  02.06.02  2018-08-30  virchl ESCAN00100563  Compiler error: Icu.c(1158): error C2143
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
# define DRVICU_VTTCANOE01ASR_VERSION            (0x0206u)
# define DRVICU_VTTCANOE01ASR_RELEASE_VERSION    (0x02u)
...
# define ICU_SW_MINOR_VERSION                    (DRVICU_VTTCANOE01ASR_VERSION & 0x00FFu)
...
/* ----- Error codes ----- */
# define ICU_E_NO_ERROR                          (0x00u)   /*!< used to check if no error occurred - use a value unequal to any error code */
...
# define ICU_MODE_EDGE_DETECTION                 (0x00u)
# define ICU_MODE_SIGNAL_MEASUREMENT             (0x40u)
# define ICU_MODE_TIMESTAMP                      (0x80u)
# define ICU_MODE_EDGE_COUNTER                   (0xC0u)
...
# if defined (ICU_IRQ_SOURCE) || defined (ICU_SOURCE)
