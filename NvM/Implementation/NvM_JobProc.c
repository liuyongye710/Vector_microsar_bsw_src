...
#else
        NVM_ACT_ID_InitReadAll, NVM_STATE_READALL_PROC_RAM_BLOCK, NVM_READ_ALL
#endif /* (NVM_DYNAMIC_CONFIGURATION == STD_ON) */
    },
#if(NVM_PRE_READALL_API == STD_ON)
    /* NVM_INT_FID_PRE_READ_ALL */
    {
        NVM_ACT_ID_InitPreReadAll, NVM_STATE_PREREADALL_PREP, NVM_PRE_READ_ALL
    },
#else
    /* NVM_INT_FID_PRE_READ_ALL */
    {
        NVM_ACT_ID_Nop, NVM_STATE_FSM_FINISHED, NVM_PRE_READ_ALL
    },
#endif
#if (NVM_REPAIR_REDUNDANT_BLOCKS_API == STD_ON)
