...
/*====================================================================================================
                                             LOCAL MACROS
====================================================================================================*/
#define CRYPTO_MEMMAP_SECTION_NOTMATCH_ERROR   "Crypto_MemMap.h, start - stop section defined not match."
#define MEM_ERROR
...
*/
#ifdef CRYPTO_START_SEC_CONFIG_DATA
    #undef CRYPTO_START_SEC_CONFIG_DATA
    #define ENTERED_CRYPTO_START_SEC_CONFIG_DATA
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef CRYPTO_STOP_SEC_CONFIG_DATA
            #error CRYPTO_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
        #ifdef MEM_MAP
            __attribute__((section(".mcal_crypto_rodata")))
        #endif
#endif

#ifdef CRYPTO_STOP_SEC_CONFIG_DATA
    #ifdef ENTERED_CRYPTO_START_SEC_CONFIG_DATA
        #undef ENTERED_CRYPTO_START_SEC_CONFIG_DATA
    #else
        #error CRYPTO_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    ...
    #endif
    #undef CRYPTO_STOP_SEC_CONFIG_DATA
    #undef MEM_ERROR
...
*/
    ...
    #undef MEM_ERROR
        #ifdef MEM_MAP
            __attribute__((section(".mcal_crypto_text")))
        #endif
#endif
...
*/
#ifdef CRYPTO_START_SEC_VAR_NO_INIT
    #undef CRYPTO_START_SEC_VAR_NO_INIT
    #define ENTERED_CRYPTO_START_SEC_VAR_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef CRYPTO_STOP_SEC_VAR_NO_INIT
            #error CRYPTO_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
        #ifdef MEM_MAP
            __attribute__((section(".mcal_crypto_bss")))
        #endif
#endif

#ifdef CRYPTO_STOP_SEC_VAR_NO_INIT
    #ifdef ENTERED_CRYPTO_START_SEC_VAR_NO_INIT
        #undef ENTERED_CRYPTO_START_SEC_VAR_NO_INIT
    #else
        #error CRYPTO_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef CRYPTO_STOP_SEC_VAR_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef CRYPTO_START_SEC_VAR_INIT
    #undef CRYPTO_START_SEC_VAR_INIT
    #define ENTERED_CRYPTO_START_SEC_VAR_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef CRYPTO_STOP_SEC_VAR_INIT
            #error CRYPTO_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
        #ifdef MEM_MAP
            __attribute__((section(".mcal_crypto_data")))
        #endif
#endif

#ifdef CRYPTO_STOP_SEC_VAR_INIT
    #ifdef ENTERED_CRYPTO_START_SEC_VAR_INIT
        #undef ENTERED_CRYPTO_START_SEC_VAR_INIT
    #else
        #error CRYPTO_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef CRYPTO_STOP_SEC_VAR_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef CRYPTO_START_SEC_VAR_SHARED_INIT
    #undef CRYPTO_START_SEC_VAR_SHARED_INIT
    #define ENTERED_CRYPTO_START_SEC_VAR_SHARED_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef CRYPTO_STOP_SEC_VAR_SHARED_INIT
            #error CRYPTO_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
        ...
        #else
            __attribute__((section(".mcal_crypto_share")))
        #endif
#endif

#ifdef CRYPTO_STOP_SEC_VAR_SHARED_INIT
    #ifdef ENTERED_CRYPTO_START_SEC_VAR_SHARED_INIT
        #undef ENTERED_CRYPTO_START_SEC_VAR_SHARED_INIT
    #else
        #error CRYPTO_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef CRYPTO_STOP_SEC_VAR_SHARED_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef CRYPTO_START_SEC_VAR_SHARED_NO_INIT
    #undef CRYPTO_START_SEC_VAR_SHARED_NO_INIT
    #define ENTERED_CRYPTO_START_SEC_VAR_SHARED_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifdef CRYPTO_STOP_SEC_VAR_SHARED_NO_INIT
            #error CRYPTO_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
        ...
        #else
            __attribute__((section(".mcal_crypto_bss_share")))
        #endif
#endif

#ifdef CRYPTO_STOP_SEC_VAR_SHARED_NO_INIT
    #ifdef ENTERED_CRYPTO_START_SEC_VAR_SHARED_NO_INIT
        #undef ENTERED_CRYPTO_START_SEC_VAR_SHARED_NO_INIT
    #else
        #error CRYPTO_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef CRYPTO_STOP_SEC_VAR_SHARED_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
    ...
    #undef MEM_ERROR
        ...
        #else
            __attribute__((section(".mcal_crypto_ramcode")))
        #endif
#endif
...
*/
    ...
    #undef MEM_ERROR
        ...
        #else
            #pragma ghs section rodata=".mcal_crypto_rodata"
        #endif
#endif
...
*/
    ...
    #undef MEM_ERROR
        ...
        #else
            #pragma ghs section text=".mcal_crypto_text"
        #endif
#endif
...
*/
    ...
    #undef MEM_ERROR
        ...
        #else
            #pragma ghs section bss=".mcal_crypto_bss"
        #endif
#endif
...
*/
    ...
    #undef MEM_ERROR
        ...
        #else
            #pragma ghs section data = ".mcal_crypto_data"
        #endif
#endif
...
*/
    ...
    #undef MEM_ERROR
        ...
        #else
            #pragma ghs section text=".mcal_crypto_ramcode"
            #pragma ghs inlineprologue
            #pragma ghs callmode=far
        #endif
#endif
...
*/
    ...
    #undef MEM_ERROR
        ...
        #else
            #pragma section ".mcal_crypto_rodata" a
        #endif
#endif
...
*/
    ...
    #undef MEM_ERROR
        ...
        #else
            #pragma section ".mcal_crypto_text" avx
        #endif
#endif
...
*/
    ...
    #undef MEM_ERROR
            ...
            #pragma section ".bss"
        #else
            #pragma section ".mcal_crypto_bss"
        #endif
#endif
...
*/
    ...
    #undef MEM_ERROR
            ...
            #pragma section ".data"
        #else
            #pragma section ".mcal_crypto_data"
        #endif
#endif
...
*/
    ...
    #undef MEM_ERROR
            ...
            #pragma section ".data_share"
        #else
            #pragma section ".mcal_crypto_share"
        #endif
#endif
...
*/
    ...
    #undef MEM_ERROR
        ...
        #else
            #pragma section ".mcal_crypto_bss_share"
        #endif
#endif
...
*/
    ...
    #undef MEM_ERROR
        ...
        #else
            #pragma section ".mcal_crypto_ramcode" avx
        #endif
#endif
