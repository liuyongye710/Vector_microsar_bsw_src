...
#define RTE_START_SEC_CODE
#include "Rte_MemMap.h"
TASK(Task_Init_Core0_QM)
{
    RunnableInit_Core0();
    Test_Runnable_Core0_Init();

    (void)TerminateTask();
}

TASK(Task_2ms_Core0_QM)
{
    Runnable2ms_Core0();
    Test_Runnable_Core0_2ms();

    (void)TerminateTask();
}

TASK(Task_10ms_Core0_QM)
{
    Runnable10ms_Core0();
    Test_Runnable_Core0_10ms();

    (void)TerminateTask();
}

TASK(Task_20ms_Core0_QM)
{
    Runnable20ms_Core0();
    Test_Runnable_Core0_20ms();

    (void)TerminateTask();
}

TASK(Task_50ms_Core0_QM)
{
    Runnable50ms_Core0();
    Test_Runnable_Core0_50ms();

    (void)TerminateTask();
}

TASK(Task_100ms_Core0_QM)
{
    Runnable100ms_Core0();
    Test_Runnable_Core0_100ms();

    (void)TerminateTask();
}

TASK(Task_200ms_Core0_QM)
{
    Runnable200ms_Core0();
    Test_Runnable_Core0_200ms();

    (void)TerminateTask();
}

TASK(Task_500ms_Core0_QM)
{
    Runnable500ms_Core0();
    Test_Runnable_Core0_500ms();

    (void)TerminateTask();
}

TASK(Task_1000ms_Core0_QM)
{
    Runnable1000ms_Core0();
    Test_Runnable_Core0_1000ms();
