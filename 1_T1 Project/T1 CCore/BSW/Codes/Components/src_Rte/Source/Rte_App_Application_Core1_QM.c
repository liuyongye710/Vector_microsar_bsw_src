...
#define RTE_START_SEC_CODE
#include "Rte_MemMap.h"
TASK(Task_Init_Core1_QM)
{
    RunnableInit_Core1();
    Test_Runnable_Core1_Init();

    (void)TerminateTask();
}

TASK(Task_5ms_Core1_QM)
{
    Runnable5ms_Core1();
    Test_Runnable_Core1_5ms();

    (void)TerminateTask();
}

TASK(Task_10ms_Core1_QM)
{
    Runnable10ms_Core1();
    Test_Runnable_Core1_10ms();

    (void)TerminateTask();
}

TASK(Task_20ms_Core1_QM)
{
    Runnable20ms_Core1();
    Test_Runnable_Core1_20ms();

    (void)TerminateTask();
}

TASK(Task_50ms_Core1_QM)
{
    Runnable50ms_Core1();
    Test_Runnable_Core1_50ms();

    (void)TerminateTask();
}

TASK(Task_100ms_Core1_QM)
{
    Runnable100ms_Core1();
    Test_Runnable_Core1_100ms();

    (void)TerminateTask();
}

TASK(Task_200ms_Core1_QM)
{
    Runnable200ms_Core1();
    Test_Runnable_Core1_200ms();

    (void)TerminateTask();
}

TASK(Task_500ms_Core1_QM)
{
    Runnable500ms_Core1();
    Test_Runnable_Core1_500ms();

    (void)TerminateTask();
}

TASK(Task_1000ms_Core1_QM)
{
    Runnable1000ms_Core1();
    Test_Runnable_Core1_1000ms();
