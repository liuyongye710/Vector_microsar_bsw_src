#ifndef RTW_HEADER_SWC_BCC_IG_h_
#define RTW_HEADER_SWC_BCC_IG_h_
#include <math.h>
#ifndef SWC_BCC_IG_COMMON_INCLUDES_
#define SWC_BCC_IG_COMMON_INCLUDES_
#include "rtwtypes.h"
#endif

#include "SWC_BCC_IG_types.h"

#ifndef SWC_BCC_IG_MDLREF_HIDE_CHILD_
...
} ConstB_SWC_BCC_IG_h_T;

#endif

#ifndef SWC_BCC_IG_MDLREF_HIDE_CHILD_

struct tag_RTM_SWC_BCC_IG_T {
...
typedef struct {
  RT_MODEL_SWC_BCC_IG_T rtm;
} MdlrefDW_SWC_BCC_IG_T;

#endif

extern real32_T BCC_tIGBTTj;
extern real32_T BCC_tCoolantTj;
extern real32_T VAR_UTjpwr_f32;
extern real32_T VAR_UCoolantTj_f32;
extern real32_T VAR_UihTjtIGBT_f32;
extern real32_T VAR_BCC_iDcLnkEst_f32;
extern real32_T VAR_BCC_iDcLnkEstFlt_f32;
extern real32_T BCE_iDcLnkEst;
extern boolean_T VAR_BCC_flgstGateDrv_b;
extern void SWC_BCC_IG_Disable(void);
extern void SWC_BCC_IG(const real32_T *rtu_MCF_BUS_MCF_dycU, const real32_T
...
extern void SWC_BCC_IG_initialize(const char_T **rt_errorStatus);
...
extern MdlrefDW_SWC_BCC_IG_T SWC_BCC_IG_MdlrefDW;

#endif

#ifndef SWC_BCC_IG_MDLREF_HIDE_CHILD_

extern B_SWC_BCC_IG_c_T SWC_BCC_IG_B;
extern DW_SWC_BCC_IG_f_T SWC_BCC_IG_DW;
