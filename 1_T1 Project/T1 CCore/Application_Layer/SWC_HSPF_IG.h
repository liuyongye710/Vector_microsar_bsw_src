#ifndef RTW_HEADER_SWC_HSPF_IG_h_
#define RTW_HEADER_SWC_HSPF_IG_h_
#include <math.h>
#ifndef SWC_HSPF_IG_COMMON_INCLUDES_
#define SWC_HSPF_IG_COMMON_INCLUDES_
#include "rtwtypes.h"
#endif

#include "SWC_HSPF_IG_types.h"
...
#ifndef SWC_HSPF_IG_MDLREF_HIDE_CHILD_
...
typedef struct {
  ...
  uint8_T UnitDelay2_DSTATE_n;
  uint8_T UnitDelay2_DSTATE_g;
  uint8_T UnitDelay2_DSTATE_gn;
  ...
  uint8_T is_active_c6_SWC_HSPF_IG;
  uint8_T is_c6_SWC_HSPF_IG;
  uint8_T is_active_c4_SWC_HSPF_IG;
  uint8_T is_c4_SWC_HSPF_IG;
  uint8_T is_active_c3_SWC_HSPF_IG;
  uint8_T is_c3_SWC_HSPF_IG;
} DW_SWC_HSPF_IG_f_T;
...
} ConstB_SWC_HSPF_IG_h_T;

#endif

#ifndef SWC_HSPF_IG_MDLREF_HIDE_CHILD_

struct tag_RTM_SWC_HSPF_IG_T {
...
typedef struct {
  RT_MODEL_SWC_HSPF_IG_T rtm;
} MdlrefDW_SWC_HSPF_IG_T;

#endif

extern real32_T VAR_Hspf_uKl30_f32;
extern boolean_T VAR_Bsw_bt15_b;
extern real32_T HSPF_uKl30Flt;
extern real32_T VAR_Hspf_tDBCTempU_f32;
extern real32_T HSPF_tDBCTempUFlt;
extern real32_T VAR_Hspf_tDBCTempV_f32;
extern real32_T HSPF_tDBCTempVFlt;
extern real32_T VAR_Hspf_tDBCTempW_f32;
extern real32_T HSPF_tDBCTempWFlt;
extern real32_T HSPF_tStrrTemp1Flt;
extern real32_T HSPF_tStrrTemp2Flt;
extern real32_T HSPF_nSlowFlt;
extern real32_T HSPF_tCoolantTempFlt;
extern real32_T HSPF_tDrvBoardTempFlt;
extern real32_T HSPF_iDcLnkEstFlt;
extern real32_T VAR_Hspf_uDcLnk_f32;
extern real32_T HSPF_uDcLnkSlowFlt;
extern real32_T HSPF_PwrDcLnk;
extern real32_T HSPF_tStrrTempFlt;
extern real32_T HSPF_tIGBTTjFlt;
extern real32_T HSPF_tCoolantTjFlt;
extern real32_T VAR_Bsw_tCoolantTemp_f32;
extern real32_T VAR_Hspf_tCoolantTemp_f32;
extern real32_T VAR_Hspf_tDrvBoardTemp_f32;
extern real32_T HSPF_iPhaWOffset;
extern real32_T HSPF_iPhaVOffset;
extern real32_T HSPF_iPhaUOffset;
extern uint16_T VAR_Bsw_tDBCTempU_u16;
extern uint16_T VAR_Bsw_tDBCTempV_u16;
extern uint16_T VAR_Bsw_tDBCTempW_u16;
extern uint16_T VAR_Bsw_tStrrTemp1_u16;
extern uint16_T VAR_Bsw_tStrrTemp2_u16;
extern uint16_T VAR_Bsw_tDrvBoardTemp_u16;
extern int16_T VAR_Hspf_tStrrTemp2_s16;
extern int16_T VAR_Hspf_tStrrTemp1_s16;
extern uint8_T HSPF_tDBCTempCmpErrSt;
extern uint8_T HSPF_MotorOpenErrSt;
extern uint8_T HSPF_InvOpenErrSt;
extern uint8_T HSPF_stIphaOffCal;
extern uint8_T HSPF_checkstatus;
extern boolean_T VAR_Hspf_bSwtTempSttr2_b;
extern boolean_T HSPF_bt15;
extern boolean_T HSPF_Crash;
extern boolean_T HSPF_INV_Open;
extern boolean_T HSPF_Motor_Open;
extern boolean_T HSPF_Wake;
extern boolean_T VAR_Hspf_tDBCCmpErrDelay_b;
extern boolean_T VAR_Hspf_bSwtTempSttr1_b;
extern boolean_T VAR_Bsw_Wake_b;
extern boolean_T VAR_Bsw_Crash_b;
extern boolean_T VAR_Bsw_INV_Open_b;
extern boolean_T VAR_Bsw_Motor_Open_b;
extern boolean_T VAR_Hspf_flgSttr1NoErr_b;
extern boolean_T VAR_Hspf_flgSttr2NoErr_b;
extern void SWC_HSPF_IG_Init(void);
extern void SWC_HSPF_IG(const real32_T *rtu_BSW_uDcLnk, const real32_T
...
extern void SWC_HSPF_IG_initialize(const char_T **rt_errorStatus);
...
extern MdlrefDW_SWC_HSPF_IG_T SWC_HSPF_IG_MdlrefDW;

#endif

#ifndef SWC_HSPF_IG_MDLREF_HIDE_CHILD_

extern B_SWC_HSPF_IG_c_T SWC_HSPF_IG_B;
extern DW_SWC_HSPF_IG_f_T SWC_HSPF_IG_DW;
