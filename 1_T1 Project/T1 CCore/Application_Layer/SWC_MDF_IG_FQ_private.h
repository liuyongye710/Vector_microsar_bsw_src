...
#ifndef RTW_HEADER_SWC_MDF_IG_FQ_private_h_
#define RTW_HEADER_SWC_MDF_IG_FQ_private_h_
#include "rtwtypes.h"
#ifndef UCHAR_MAX
#include <limits.h>
#endif
...
#define rtCP_DirectLookupTablenD_table rtCP_pooled_5tL1grgvQpCw  /* Computed Parameter: rtCP_DirectLookupTablenD_table
                                                                  * Referenced by: '<S21>/Direct Lookup Table (n-D)'
                                                                  */

/* Invariant block signals (default storage) */
extern const ConstB_SWC_MDF_IG_FQ_h_T SWC_MDF_IG_FQ_ConstB;

#endif                                 /* RTW_HEADER_SWC_MDF_IG_FQ_private_h_ */
