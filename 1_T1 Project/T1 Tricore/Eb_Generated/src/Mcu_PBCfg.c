...
static const Mcu_ClockCfgType Mcu_kClockConfiguration0[] =
{
    /*McuClockSettingConfig_0*/
  {
    ...
    {
      1000U,  /* ramp up delay for K2 div step 1*/
      2000U, /* ramp up delay for K2 div step 2*/
      3000U, /* ramp up delay for K2 div step 3*/
      3000U, /* ramp up delay for K2 div step 4*/
    ...
    /*
      ...
      SPB Clock     = 100.0MHz
    */
    (uint32)0x033301aaU, /* CCUCON0 Register Configuration*/
    (uint32)0x0ff1f313U, /* CCUCON1 Register Configuration*/
