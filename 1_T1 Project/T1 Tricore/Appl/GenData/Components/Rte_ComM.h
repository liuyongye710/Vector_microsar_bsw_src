...
FUNC(Std_ReturnType, ComM_CODE) ComM_GetInhibitionStatus(uint8 parg0, P2VAR(ComM_InhibitionStatusType, AUTOMATIC, RTE_COMM_APPL_VAR) Status); /* PRQA S 0850, 1330, 3451 */ /* MD_MSR_19.8, MD_Rte_1330, MD_Rte_3451 */
...
FUNC(Std_ReturnType, ComM_CODE) ComM_LimitChannelToNoComMode(uint8 parg0, boolean Status); /* PRQA S 0850, 1330, 3451 */ /* MD_MSR_19.8, MD_Rte_1330, MD_Rte_3451 */
FUNC(Std_ReturnType, ComM_CODE) ComM_LimitECUToNoComMode(boolean Status); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
FUNC(Std_ReturnType, ComM_CODE) ComM_PreventWakeUp(uint8 parg0, boolean Status); /* PRQA S 0850, 1330, 3451 */ /* MD_MSR_19.8, MD_Rte_1330, MD_Rte_3451 */
