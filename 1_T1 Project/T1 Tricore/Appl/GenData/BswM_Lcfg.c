...
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN00_d9752b68_TX_Disable(void);
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN00_d9752b68_TX_EnableNoinit(void);
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN00_d9752b68_Disable_DM(void);
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN00_d9752b68_Enable_DM(void);
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN00_d9752b68_RX_Disable(void);
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN00_d9752b68_RX_EnableNoinit(void);
 ...
 * \synchronous TRUE
 */
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CN_CAN00_d9752b68_TX(void);
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CN_CAN00_d9752b68_RX_DM(void);
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CN_CAN00_d9752b68_RX(void);
...
CONST(BswM_ActionListsType, BSWM_CONST) BswM_ActionLists[19] = {
  ...
  { /*     1 */ BswM_ActionList_CC_AL_CN_CAN00_d9752b68_TX_Disable      },  /* [Priority: 0] */  /* [AL_CC_AL_CN_CAN00_d9752b68_TX_Disable] */
  { /*     2 */ BswM_ActionList_CC_AL_CN_CAN00_d9752b68_TX_EnableNoinit },  /* [Priority: 0] */  /* [AL_CC_AL_CN_CAN00_d9752b68_TX_EnableNoinit] */
  { /*     3 */ BswM_ActionList_CC_AL_CN_CAN00_d9752b68_Disable_DM      },  /* [Priority: 0] */  /* [AL_CC_AL_CN_CAN00_d9752b68_Disable_DM] */
  { /*     4 */ BswM_ActionList_CC_AL_CN_CAN00_d9752b68_Enable_DM       },  /* [Priority: 0] */  /* [AL_CC_AL_CN_CAN00_d9752b68_Enable_DM] */
  { /*     5 */ BswM_ActionList_CC_AL_CN_CAN00_d9752b68_RX_Disable      },  /* [Priority: 0] */  /* [AL_CC_AL_CN_CAN00_d9752b68_RX_Disable] */
  { /*     6 */ BswM_ActionList_CC_AL_CN_CAN00_d9752b68_RX_EnableNoinit },  /* [Priority: 0] */  /* [AL_CC_AL_CN_CAN00_d9752b68_RX_EnableNoinit] */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
CONST(BswM_DeferredRulesType, BSWM_CONST) BswM_DeferredRules[6] = {
...
CONST(BswM_ImmediateUserType, BSWM_CONST) BswM_ImmediateUser[2] = {
  ...
  { /*     0 */      0x01U,             3U,               0U },  /* [Name: CC_CanSMIndication_CN_CAN00_d9752b68] */  /* [MRP_CC_CanSMIndication_CN_CAN00_d9752b68, CANSM_CHANNEL_0] */
...
CONST(BswM_RulesType, BSWM_CONST) BswM_Rules[14] = {
  ...
  { /*     0 */  2U, BswM_Rule_CC_CN_CAN00_d9752b68_TX    },  /* [R_CC_CN_CAN00_d9752b68_TX, MRP_CC_CanSMIndication_CN_CAN00_d9752b68, NoPartitions] */
  { /*     1 */  1U, BswM_Rule_CC_CN_CAN00_d9752b68_RX_DM },  /* [R_CC_CN_CAN00_d9752b68_RX_DM, MRP_CC_CanSMIndication_CN_CAN00_d9752b68, NoPartitions] */
  { /*     2 */  0U, BswM_Rule_CC_CN_CAN00_d9752b68_RX    },  /* [R_CC_CN_CAN00_d9752b68_RX, MRP_CC_CanSMIndication_CN_CAN00_d9752b68, NoPartitions] */
  { /*     3 */  8U, BswM_Rule_ESH_RunToPostRun           },  /* [R_ESH_RunToPostRun, MRP_ESH_State, MRP_ESH_ComMIndication_CN_CAN00_d9752b68, MRP_ESH_RunRequest_0, MRP_ESH_RunRequest_1, MRP_ESH_SelfRunRequestTimer, NoPartitions] */
  ...
  { /*     6 */ 12U, BswM_Rule_ESH_WakeupToPrep           },  /* [R_ESH_WakeupToPrep, MRP_ESH_State, MRP_ESH_EcuM_GetPendingWakeupEvents, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests, NoPartitions] */
  ...
  { /*     8 */ 13U, BswM_Rule_ESH_WakeupToRun            },  /* [R_ESH_WakeupToRun, MRP_ESH_State, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests, NoPartitions] */
  ...
  { /*    12 */  4U, BswM_Rule_ESH_PostRun                },  /* [R_ESH_PostRun, MRP_ESH_State, MRP_ESH_SelfRunRequestTimer, NoPartitions] */
  { /*    13 */  7U, BswM_Rule_ESH_PrepToWait             }   /* [R_ESH_PrepToWait, MRP_ESH_State, NoPartitions] */
};
#define BSWM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
...
CONST(BswM_RulesIndType, BSWM_CONST) BswM_RulesInd[11] = {
  ...
  /*     0 */       0U,  /* [MRP_CC_CanSMIndication_CN_CAN00_d9752b68] */
  /*     1 */       1U,  /* [MRP_CC_CanSMIndication_CN_CAN00_d9752b68] */
  /*     2 */       2U,  /* [MRP_CC_CanSMIndication_CN_CAN00_d9752b68] */
  /*     3 */       3U,  /* [MRP_ESH_State] */
  /*     4 */       5U,  /* [MRP_ESH_State] */
  /*     5 */       6U,  /* [MRP_ESH_State] */
  /*     6 */       7U,  /* [MRP_ESH_State] */
...
VAR(uBswM_ActionListQueueType, BSWM_VAR_NOINIT) BswM_ActionListQueue;  /* PRQA S 0759 */  /* MD_CSL_18.4 */
  ...
  /*     1 */  /* [AL_CC_AL_CN_CAN00_d9752b68_TX_Disable] */
  /*     2 */  /* [AL_CC_AL_CN_CAN00_d9752b68_TX_EnableNoinit] */
  /*     3 */  /* [AL_CC_AL_CN_CAN00_d9752b68_Disable_DM] */
  /*     4 */  /* [AL_CC_AL_CN_CAN00_d9752b68_Enable_DM] */
  /*     5 */  /* [AL_CC_AL_CN_CAN00_d9752b68_RX_Disable] */
  /*     6 */  /* [AL_CC_AL_CN_CAN00_d9752b68_RX_EnableNoinit] */
  /*     7 */  /* [AL_ESH_AL_ExitRun] */
...
VAR(CanSM_BswMCurrentStateType, BSWM_VAR_NOINIT) BswM_CanSMChannelState[1];
  /* Index        Referable Keys  */
  /*     0 */  /* [CANSM_CHANNEL_0, MRP_CC_CanSMIndication_CN_CAN00_d9752b68] */
...
VAR(ComM_ModeType, BSWM_VAR_NOINIT) BswM_ComMChannelState[1];
  /* Index        Referable Keys  */
  /*     0 */  /* [COMM_CHANNEL_0, MRP_ESH_ComMIndication_CN_CAN00_d9752b68] */
...
VAR(BswM_ModeRequestQueueType, BSWM_VAR_NOINIT) BswM_ModeRequestQueue[2];
  /* Index        Referable Keys  */
  /*     0 */  /* [MRP_CC_CanSMIndication_CN_CAN00_d9752b68, CANSM_CHANNEL_0] */
...
VAR(BswM_RuleStatesType, BSWM_VAR_NOINIT) BswM_RuleStates[14];
  /* Index        Referable Keys  */
  /*     0 */  /* [R_CC_CN_CAN00_d9752b68_TX, MRP_CC_CanSMIndication_CN_CAN00_d9752b68, NoPartitions] */
  /*     1 */  /* [R_CC_CN_CAN00_d9752b68_RX_DM, MRP_CC_CanSMIndication_CN_CAN00_d9752b68, NoPartitions] */
  /*     2 */  /* [R_CC_CN_CAN00_d9752b68_RX, MRP_CC_CanSMIndication_CN_CAN00_d9752b68, NoPartitions] */
  /*     3 */  /* [R_ESH_RunToPostRun, MRP_ESH_State, MRP_ESH_ComMIndication_CN_CAN00_d9752b68, MRP_ESH_RunRequest_0, MRP_ESH_RunRequest_1, MRP_ESH_SelfRunRequestTimer, NoPartitions] */
  ...
  /*     6 */  /* [R_ESH_WakeupToPrep, MRP_ESH_State, MRP_ESH_EcuM_GetPendingWakeupEvents, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests, NoPartitions] */
  /*     7 */  /* [R_ESH_WaitToWakeup, MRP_ESH_State, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests, NoPartitions] */
  /*     8 */  /* [R_ESH_WakeupToRun, MRP_ESH_State, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests, NoPartitions] */
  ...
  /*    12 */  /* [R_ESH_PostRun, MRP_ESH_State, MRP_ESH_SelfRunRequestTimer, NoPartitions] */
  /*    13 */  /* [R_ESH_PrepToWait, MRP_ESH_State, NoPartitions] */
...
/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CN_CAN00_d9752b68_TX_Disable
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN00_d9752b68_TX_Disable(void)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduGroup(ComConf_ComIPduGroup_iECU_oCAN00_Tx_f55b9750, FALSE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduDMGroup(ComConf_ComIPduGroup_iECU_oCAN00_Tx_f55b9750, FALSE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
...
/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CN_CAN00_d9752b68_TX_EnableNoinit
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN00_d9752b68_TX_EnableNoinit(void)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduGroup(ComConf_ComIPduGroup_iECU_oCAN00_Tx_f55b9750, TRUE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduDMGroup(ComConf_ComIPduGroup_iECU_oCAN00_Tx_f55b9750, TRUE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  BswM_MarkPduGroupControlInvocation(BSWM_GROUPCONTROL_NORMAL);
  return E_OK;
}/* PRQA S 6010, 6030, 6050 */ /* MD_MSR_STPTH, MD_MSR_STCYC, MD_MSR_STCAL */
...
/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CN_CAN00_d9752b68_Disable_DM
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN00_d9752b68_Disable_DM(void)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduDMGroup(ComConf_ComIPduGroup_iECU_oCAN00_Rx_a30130d6, FALSE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
...
/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CN_CAN00_d9752b68_Enable_DM
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN00_d9752b68_Enable_DM(void)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduDMGroup(ComConf_ComIPduGroup_iECU_oCAN00_Rx_a30130d6, TRUE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  BswM_MarkDmControlInvocation();
  return E_OK;
}/* PRQA S 6010, 6030, 6050 */ /* MD_MSR_STPTH, MD_MSR_STCYC, MD_MSR_STCAL */
...
/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CN_CAN00_d9752b68_RX_Disable
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN00_d9752b68_RX_Disable(void)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduGroup(ComConf_ComIPduGroup_iECU_oCAN00_Rx_a30130d6, FALSE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduDMGroup(ComConf_ComIPduGroup_iECU_oCAN00_Rx_a30130d6, FALSE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
...
/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CN_CAN00_d9752b68_RX_EnableNoinit
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_CAN00_d9752b68_RX_EnableNoinit(void)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduGroup(ComConf_ComIPduGroup_iECU_oCAN00_Rx_a30130d6, TRUE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduDMGroup(ComConf_ComIPduGroup_iECU_oCAN00_Rx_a30130d6, TRUE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
...
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_ESH_AL_RunToPostRun(void)
{
  ComM_CommunicationAllowed(ComMConf_ComMChannel_CN_CAN00_d9752b68, FALSE);
  /*lint -save -e534 *//* PRQA S 3109, 3200 1 */ /* MD_MSR_14.3, MD_BswM_3200 */
...
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_ESH_AL_WakeupToRun(void)
{
  ComM_CommunicationAllowed(ComMConf_ComMChannel_CN_CAN00_d9752b68, TRUE);
...
/**********************************************************************************************************************
 *  BswM_Rule_CC_CN_CAN00_d9752b68_TX
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CN_CAN00_d9752b68_TX(void)
{
  BswM_HandleType retVal = BSWM_NO_ACTIONLIST;
  /* Evaluate logical expression CC_LE_CN_CAN00_d9752b68_TX. */
  if(BswM_GetCanSMChannelState(0) == CANSM_BSWM_FULL_COMMUNICATION)
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CN_CAN00_d9752b68_TX) != BSWM_TRUE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CN_CAN00_d9752b68_TX, BSWM_TRUE);
      /* Return triggered action list BswM_ActionList_CC_AL_CN_CAN00_d9752b68_TX_EnableNoinit. */
      retVal = BSWM_ID_AL_CC_AL_CN_CAN00_d9752b68_TX_EnableNoinit;
    }
  }
  else
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CN_CAN00_d9752b68_TX) != BSWM_FALSE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CN_CAN00_d9752b68_TX, BSWM_FALSE);
      /* Return triggered action list BswM_ActionList_CC_AL_CN_CAN00_d9752b68_TX_Disable. */
      retVal = BSWM_ID_AL_CC_AL_CN_CAN00_d9752b68_TX_Disable;
    }
  }
  return retVal;
}
...
/**********************************************************************************************************************
 *  BswM_Rule_CC_CN_CAN00_d9752b68_RX_DM
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CN_CAN00_d9752b68_RX_DM(void)
{
  BswM_HandleType retVal = BSWM_NO_ACTIONLIST;
  /* Evaluate logical expression CC_LE_CN_CAN00_d9752b68_RX_DM. */
  if(BswM_GetCanSMChannelState(0) == CANSM_BSWM_FULL_COMMUNICATION)
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CN_CAN00_d9752b68_RX_DM) != BSWM_TRUE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CN_CAN00_d9752b68_RX_DM, BSWM_TRUE);
      /* Return triggered action list BswM_ActionList_CC_AL_CN_CAN00_d9752b68_Enable_DM. */
      retVal = BSWM_ID_AL_CC_AL_CN_CAN00_d9752b68_Enable_DM;
    }
  }
  else
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CN_CAN00_d9752b68_RX_DM) != BSWM_FALSE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CN_CAN00_d9752b68_RX_DM, BSWM_FALSE);
      /* Return triggered action list BswM_ActionList_CC_AL_CN_CAN00_d9752b68_Disable_DM. */
      retVal = BSWM_ID_AL_CC_AL_CN_CAN00_d9752b68_Disable_DM;
    }
  }
  return retVal;
}
...
/**********************************************************************************************************************
 *  BswM_Rule_CC_CN_CAN00_d9752b68_RX
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CN_CAN00_d9752b68_RX(void)
{
  BswM_HandleType retVal = BSWM_NO_ACTIONLIST;
  /* Evaluate logical expression CC_LE_CN_CAN00_d9752b68_RX. */
  if(BswM_GetCanSMChannelState(0) != CANSM_BSWM_NO_COMMUNICATION)
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CN_CAN00_d9752b68_RX) != BSWM_TRUE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CN_CAN00_d9752b68_RX, BSWM_TRUE);
      /* Return triggered action list BswM_ActionList_CC_AL_CN_CAN00_d9752b68_RX_EnableNoinit. */
      retVal = BSWM_ID_AL_CC_AL_CN_CAN00_d9752b68_RX_EnableNoinit;
    }
  }
  else
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CN_CAN00_d9752b68_RX) != BSWM_FALSE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CN_CAN00_d9752b68_RX, BSWM_FALSE);
      /* Return triggered action list BswM_ActionList_CC_AL_CN_CAN00_d9752b68_RX_Disable. */
      retVal = BSWM_ID_AL_CC_AL_CN_CAN00_d9752b68_RX_Disable;
    }
  }
  return retVal;
}
...
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_ESH_RunToPostRun(void)
{
  ...
  if((BswM_GetGenericState(0) == BSWM_GENERICVALUE_ESH_State_ESH_RUN) && (BswM_GetComMChannelState(0) == COMM_NO_COMMUNICATION) && ((Request_ESH_RunRequest_0_requestedMode == RELEASED) && (Request_ESH_RunRequest_1_requestedMode == RELEASED)) && (BswM_GetTimerState(0) == BSWM_TIMER_EXPIRED))
  {
...
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_ESH_WakeupToPrep(void)
{
  ...
  if((BswM_GetGenericState(0) == BSWM_GENERICVALUE_ESH_State_ESH_WAKEUP) && (EcuM_GetPendingWakeupEvents() == 0u) && ((EcuM_GetValidatedWakeupEvents() == 0u) && (BswM_GetGenericState(1) == BSWM_GENERICVALUE_ESH_ComMPendingRequests_ESH_COMM_NO_REQUEST)))
  {
...
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_ESH_WakeupToRun(void)
{
  ...
  if((BswM_GetGenericState(0) == BSWM_GENERICVALUE_ESH_State_ESH_WAKEUP) && ((EcuM_GetValidatedWakeupEvents() != 0u) || (BswM_GetGenericState(1) == BSWM_GENERICVALUE_ESH_ComMPendingRequests_ESH_COMM_PENDING_REQUEST)))
  {
...
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_ESH_PostRun(void)
{
  ...
  if((BswM_GetGenericState(0) == BSWM_GENERICVALUE_ESH_State_ESH_POST_RUN) && (BswM_GetTimerState(0) == BSWM_TIMER_EXPIRED))
  {
...
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_ESH_PrepToWait(void)
{
  ...
  if(BswM_GetGenericState(0) == BSWM_GENERICVALUE_ESH_State_ESH_PREP_SHUTDOWN)
  {
