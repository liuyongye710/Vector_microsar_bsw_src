 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_CtAp_FAWDemo_Core0_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <CtAp_FAWDemo_Core0> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_CTAP_FAWDEMO_CORE0_TYPE_H
# define _RTE_CTAP_FAWDEMO_CORE0_TYPE_H
...
#endif /* _RTE_CTAP_FAWDEMO_CORE0_TYPE_H */
