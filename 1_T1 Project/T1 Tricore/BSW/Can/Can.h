...
| 2018-05-16 3.16.00 Hzo  - ESCAN00099419: Update to R20 with Mirror Mode supported
|                    Hzo  - ESCAN00098877: When both MultiCAN and MultiCANR are used, CAN_PROTECTED_AREA_ENDINIT is not sufficient during protect peripheral wirte access 
|                    Hzo  - ESCAN00097867: Compiling error when SafeBSW check is on and post build selectable is configured
|************************************************************************** */
...
#define DRVCAN_TRICOREMULTICANASR_VERSION 0x0316
