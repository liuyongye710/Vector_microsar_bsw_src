...
/**********************************************************************************************************************
  VERSION CHECK
**********************************************************************************************************************/
#if ((COM_SW_MAJOR_VERSION != 14U) || (COM_SW_MINOR_VERSION != 0U) || (COM_SW_PATCH_VERSION != 1U))
...
**********************************************************************************************************************/
/*! \brief    This function shall perform the processing of the AUTOSAR COM receive processing that are not directly
              initiated by the calls from the RTE and PDU-R. All Rx Pdus are checked, whether a deferred processing is required.
    \details  -
...
# if ((COM_FILTERINFO_FLOAT32 == STD_ON) &&(COM_EXISTS_FLOAT32_APPLTYPEOFTXSIGINFO == STD_ON))
    case (COM_FLOAT32_APPLTYPEOFTXSIGINFO):
    {
      ...
      if(Com_IsFilterInitValueUsedOfTxSigInfo(idxTxSigInfo))    /* COV_COM_FEATURE_ALWAYS_TRUE_TX */
      {
        P2CONST(float32, AUTOMATIC, AUTOMATIC) oldValuePtr = Com_GetOldValuePtr(idxTxSigInfo);
        oldValue = *oldValuePtr;
      }
      filterState = Com_Signal_Float32_EvaluateFilter((Com_FilterInfo_Float32IterType) idxFilterInfo, *((P2CONST(float32, AUTOMATIC, AUTOMATIC)) newValuePtr), oldValue, FALSE);
      break;
    }
# endif
...
# if ((COM_FILTERINFO_FLOAT64 == STD_ON) &&(COM_EXISTS_FLOAT64_APPLTYPEOFTXSIGINFO == STD_ON))
    case (COM_FLOAT64_APPLTYPEOFTXSIGINFO):
    {
      ...
      if(Com_IsFilterInitValueUsedOfTxSigInfo(idxTxSigInfo))    /* COV_COM_FEATURE_ALWAYS_TRUE_TX */
      {
        P2CONST(float64, AUTOMATIC, AUTOMATIC) oldValuePtr = Com_GetOldValuePtr(idxTxSigInfo);
        oldValue = *oldValuePtr;
      }
      filterState = Com_Signal_Float64_EvaluateFilter((Com_FilterInfo_Float64IterType) idxFilterInfo, *((P2CONST(float64, AUTOMATIC, AUTOMATIC)) newValuePtr), oldValue, FALSE);
      break;
    }
# endif
...
#  endif
      filterState = Com_Signal_UInt8_N_EvaluateFilter((Com_FilterInfo_UInt8_NIterType) idxFilterInfo, ((P2CONST(uint8, AUTOMATIC, AUTOMATIC)) newValuePtr), oldValuePtr, (PduLengthType) Com_GetByteLengthOfTxSigInfo(idxTxSigInfo), FALSE);    /* SBSW_COM_COMST_PTR */
      break;
    }
# endif
    default:   /* COV_COM_MISRA */
...
#  endif
  ...
  COM_DUMMY_STATEMENT(idxDestValue);
}       /* PRQA S 3112, 3199, 6030 */ /* MD_MSR_14.2 */ /* lint -e{438} */ /* MD_MSR_STCYC */
# endif
...
# if (COM_EXISTS_FLOAT32_APPLTYPEOFRXACCESSINFO == STD_ON)
    ...
    {
      SchM_Enter_Com_COM_EXCLUSIVE_AREA_RX();
      *((P2VAR(float32, AUTOMATIC, COM_APPL_VAR)) SignalDataPtr) = Com_GetRxSigBufferFloat32(Com_GetBufferIdxOfRxAccessInfo(idxRxAccessInfo));  /* SBSW_COM_PTR_API */
      SchM_Exit_Com_COM_EXCLUSIVE_AREA_RX();
      break;
    }
# endif
# if (COM_EXISTS_FLOAT64_APPLTYPEOFRXACCESSINFO == STD_ON)
    ...
    {
      SchM_Enter_Com_COM_EXCLUSIVE_AREA_RX();
      *((P2VAR(float64, AUTOMATIC, COM_APPL_VAR)) SignalDataPtr) = Com_GetRxSigBufferFloat64(Com_GetBufferIdxOfRxAccessInfo(idxRxAccessInfo));  /* SBSW_COM_PTR_API */
      SchM_Exit_Com_COM_EXCLUSIVE_AREA_RX();
      break;
    }
# endif
...
#  if (COM_RXSIGBUFFERFLOAT32 == STD_ON)
      ...
      {
        (void) Com_SendSignal_Processing(txSigId, Com_GetAddrRxSigBufferFloat32(Com_GetRoutingBufferIdxOfRxAccessInfo(idxRxAccessInfo)), 0);    /* SBSW_COM_FCTCALL_WITH_P2CONST */
        break;
      }
#  endif
#  if (COM_RXSIGBUFFERFLOAT64 == STD_ON)
      ...
      {
        (void) Com_SendSignal_Processing(txSigId, Com_GetAddrRxSigBufferFloat64(Com_GetRoutingBufferIdxOfRxAccessInfo(idxRxAccessInfo)), 0);    /* SBSW_COM_FCTCALL_WITH_P2CONST */
        break;
      }
#  endif
# endif
...
# if (COM_INVVALUEUSEDOFRXACCESSINFO == STD_ON)
  processState = Com_RxInv_Sig_Float32_EvaluateInvalidValue(idxRxAccessInfo, tmpNewValue);      /* SBSW_COM_FCTCALL_STACKPTR */
  if(processState == VALID)     /* COV_COM_INVALIDATION_TX */
# endif
...
#  endif
      filterState = Com_Signal_Float32_EvaluateFilter((Com_FilterInfo_Float32IterType) Com_GetFilterInfoIdxOfRxAccessInfo(idxRxAccessInfo), tmpNewValue, Com_GetRxSigBufferFloat32(Com_GetBufferIdxOfRxAccessInfo(idxRxAccessInfo)), hasToutOccurred);  /* SBSW_COM_FCTCALL_WITH_P2CONST */
...
# if (COM_INVVALUEUSEDOFRXACCESSINFO == STD_ON)
  processState = Com_RxInv_Sig_Float64_EvaluateInvalidValue(idxRxAccessInfo, tmpNewValue);      /* SBSW_COM_FCTCALL_STACKPTR */
  if(processState == VALID)     /* COV_COM_INVALIDATION_TX */
# endif
...
#  endif
      filterState = Com_Signal_Float64_EvaluateFilter((Com_FilterInfo_Float64IterType) Com_GetFilterInfoIdxOfRxAccessInfo(idxRxAccessInfo), tmpNewValue, Com_GetRxSigBufferFloat64(Com_GetBufferIdxOfRxAccessInfo(idxRxAccessInfo)), hasToutOccurred);  /* SBSW_COM_FCTCALL_WITH_P2CONST */
      if(filterState == FALSE)  /* COV_COM_FLOAT_TYPE_FILTER */
      {
        processState = FILTERED;
      }
...
#  if ((COM_CONSTVALUEFLOAT32 == STD_ON) && (COM_EXISTS_FLOAT32_APPLTYPEOFTXSIGINFO == STD_ON))
      case COM_FLOAT32_APPLTYPEOFTXSIGINFO:
      {
        retVal = Com_SendSignal_Processing(idxTxSigInfo, Com_GetAddrConstValueFloat32(idxInvValue), 0); /* SBSW_COM_FCTCALL_WITH_P2CONST */
        break;
      }
#  endif
#  if ((COM_CONSTVALUEFLOAT64 == STD_ON) && (COM_EXISTS_FLOAT64_APPLTYPEOFTXSIGINFO == STD_ON))
      case COM_FLOAT64_APPLTYPEOFTXSIGINFO:
      {
        retVal = Com_SendSignal_Processing(idxTxSigInfo, Com_GetAddrConstValueFloat64(idxInvValue), 0); /* SBSW_COM_FCTCALL_WITH_P2CONST */
        break;
      }
#  endif
      default: /* COV_COM_MISRA */
...
#  if (COM_TXFILTERINITVALUEFLOAT32 == STD_ON)
      case COM_FLOAT32_APPLTYPEOFTXSIGINFO:
      {
        oldValuePtr = (P2CONST(void, AUTOMATIC, AUTOMATIC)) Com_GetAddrTxFilterOldValueFloat32(idxTxFilterOldValue);
        break;
      }
#  endif
#  if (COM_TXFILTERINITVALUEFLOAT64 == STD_ON)
      case COM_FLOAT64_APPLTYPEOFTXSIGINFO:
      {
        oldValuePtr = (P2CONST(void, AUTOMATIC, AUTOMATIC)) Com_GetAddrTxFilterOldValueFloat64(idxTxFilterOldValue);
        break;
      }
#  endif
      default: /* COV_COM_MISRA */
...
#  if (COM_TXFILTERINITVALUEFLOAT32 == STD_ON)
      case COM_FLOAT32_APPLTYPEOFTXSIGINFO:
      {
        Com_SetTxFilterOldValueFloat32(idxTxFilterOldValue, *((P2CONST(float32, AUTOMATIC, COM_APPL_DATA)) SignalDataPtr));     /* SBSW_COM_CSL02 */
        break;
      }
#  endif
#  if (COM_TXFILTERINITVALUEFLOAT64 == STD_ON)
      case COM_FLOAT64_APPLTYPEOFTXSIGINFO:
      {
        Com_SetTxFilterOldValueFloat64(idxTxFilterOldValue, *((P2CONST(float64, AUTOMATIC, COM_APPL_DATA)) SignalDataPtr));     /* SBSW_COM_CSL02 */
        break;
      }
#  endif
      default: /* COV_COM_MISRA */
