...
#  define OS_HAL_ISR0_DEFINE(IsrName)   __attribute__((interrupt_handler)) void IsrName(void)                           /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define OS_HAL_ISR1_DEFINE(IsrName)   __attribute__((interrupt_handler)) void IsrName(void)                           /* PRQA S 3453 */ /* MD_MSR_19.7 */

# elif defined (OS_CFG_COMPILER_TASKING)   

#  define OS_HAL_ISR0_DEFINE(IsrName) \
   void __interrupt(OS_CFG_HAL_ISR_##IsrName##_LEVEL)  __vector_table(OS_CFG_HAL_ISR_##IsrName##_CORE) IsrName(void)    /* PRQA S 0342, 0881, 3410 */ /* MD_MSR_19.13_0342, MD_Os_Hal_0881, MD_Os_Hal_3410 */
