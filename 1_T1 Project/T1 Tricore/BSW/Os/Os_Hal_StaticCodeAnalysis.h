 ...
 *  \pre           -
 */
# define Os_Hal_Mta9(x)           (void)Os_Hal_DummyRead(x)                                                             /* PRQA S 3453 */ /* MD_MSR_19.7 */
 ...
 *  \pre           -
 */
# define Os_Hal_Mta0(x)           (void)Os_Hal_DummyRead(x)                                                             /* PRQA S 3453 */ /* MD_MSR_19.7 */
 ...
 *  \pre           -
 */
# define Os_Hal_Mta1(x)           (void)Os_Hal_DummyRead(x)                                                             /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE uint32, OS_CODE, OS_ALWAYS_INLINE, Os_Hal_Mfa9, (void))                    /* PRQA S 3219 */ /* MD_Os_Hal_3219 */
{
  return 0;
}
...
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE uint32, OS_CODE, OS_ALWAYS_INLINE, Os_Hal_Mfa0, (void))                    /* PRQA S 3219 */ /* MD_Os_Hal_3219 */
{
  return 0;
}
...
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE uint32, OS_CODE, OS_ALWAYS_INLINE, Os_Hal_Mfa1, (void))                    /* PRQA S 3219 */ /* MD_Os_Hal_3219 */
{
  return 0;
}
