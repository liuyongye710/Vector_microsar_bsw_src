 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE boolean, OS_CODE, OS_ALWAYS_INLINE,                                         /* PRQA S 3219 */ /* MD_Os_Hal_3219 */
Os_Hal_CoreGetPrivilegedModeFromPcxi,
(
  uint32 Param
))
{
  ...
  Param = *(uint32*)(Param + OS_HAL_CSA_PSW_OFFSET);                                                                     /* PRQA S 0306 */ /* MD_Os_Hal_0306 */
  /* #50 Return privileged mode flag. 0 = user mode, !0 = supervisor mode */ 
  return (boolean)((Param & OS_HAL_PSW_IO_MASK) == OS_HAL_PSW_IO_SUPERVISOR);
}
