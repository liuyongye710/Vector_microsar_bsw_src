...
LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_Bm_Init_TxBufferInstance(void)
{
  ...
  for(bmTxBufferInstanceRomIdx = 0; bmTxBufferInstanceRomIdx < PduR_GetSizeOfBmTxBufferInstanceRam(); bmTxBufferInstanceRomIdx++)
  {
...
FUNC(void, PDUR_CODE) PduR_Bm_AssignAssociatedBuffer2DestinationInstance(PduR_BmTxBufferRomIterType bmTxBufferRomIdx, PduR_BmTxBufferInstanceRomIterType bmTxBufferInstanceRomIdx)
{
  ...
  PduR_SetBmTxBufferArrayRamInstanceStopIdxOfBmTxBufferRam(bmTxBufferRomIdx, (bmTxBufferInstanceRomIdx + 1));   /* SBSW_PDUR_IDX_PARAM_INTERNAL_FUNCTION */
}
#endif
...
FUNC(void, PDUR_CODE) PduR_Bm_CopyData(PduR_BmTxBufferInstanceRomIterType bmTxBufferInstanceRomIdx, PduR_BmTxBufferArrayRamIterType pduLength, CONST(SduDataPtrType, AUTOMATIC) sduDataPtr)     /* COV_PDUR_IF_ONLY */
{
  ...
  /* Dequeue Data */
  PduR_Core_MemCpyRamToRam(sduDataPtr, PduR_GetAddrBmTxBufferArrayRam(PduR_GetBmTxBufferArrayRamReadIdxOfBmTxBufferRam(bmTxBufferRomIdx)), pduLength);  /* SBSW_PDUR_MEM_CPY_FIFOMGR */
}
#endif
...
LOCAL_INLINE FUNC(PduR_BmTxBufferArrayRamIterType, PDUR_CODE) PduR_Bm_GetLinearBufferSize(PduR_BmTxBufferRomIterType bmTxBufferRomIdx)
{
  PduR_BmTxBufferArrayRamIterType retVal = 0;
                                                                        ...
                                                                        CONST(SduDataPtrType, AUTOMATIC) sduDataPtr)
{
  ...
  {
    /* Dequeue Data */
    PduR_Core_MemCpyRamToRam(sduDataPtr, PduR_GetAddrBmTxBufferArrayRam(PduR_GetBmTxBufferArrayRamReadIdxOfBmTxBufferInstanceRam(bmTxBufferInstanceRomIdx)), pduLength);        /* SBSW_PDUR_MEM_CPY_RAM2RAM */
                                                                        ...
                                                                        CONST(SduDataPtrType, AUTOMATIC) sduDataPtr)
{
  ...
  {
    /* Dequeue Data */
    PduR_Core_MemCpyRamToRam(PduR_GetAddrBmTxBufferArrayRam(PduR_GetBmTxBufferArrayRamWriteIdxOfBmTxBufferRam(txBufferElementStateIdx)), sduDataPtr, pduLength);        /* SBSW_PDUR_MEM_CPY_RAM2RAM */
...
LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_Bm_Switch_WriteIdx_And_PutData(PduR_BmTxBufferRomIterType txBufferElementStateIdx, PduR_BmTxBufferArrayRamIterType pduLength, SduDataPtrType sduDataPtr)
{
  ...
  PduR_Bm_Switch_WriteIdx(txBufferElementStateIdx);
  sduDataPtr = &sduDataPtr[pduLengthTail];
...
FUNC(void, PDUR_CODE) PduR_Bm_ResetTxBufferInstance(PduR_BmTxBufferInstanceRomIterType bmTxBufferInstanceRomIdx)
{
  ...
  PDUR_DUMMY_STATEMENT(bmTxBufferInstanceRomIdx);       /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /* lint -e{438} */
  PDUR_DUMMY_STATEMENT(txBufferElementStateIdx);       /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /* lint -e{438} */
}
#endif
