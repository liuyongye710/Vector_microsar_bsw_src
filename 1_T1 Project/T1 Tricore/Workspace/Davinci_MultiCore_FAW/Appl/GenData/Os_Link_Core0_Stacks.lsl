 ...
 *   Generation Time: 2020-07-28 16:23:24
...
/* Stack: OsCore0_Task_Prio51 (1024 Byte) */
group OS_STACK_OSCORE0_TASK_PRIO51_VAR_NOINIT_GROUP(ordered, contiguous, fill, align=8)
{
  select ".bss.OS_STACK_OSCORE0_TASK_PRIO51_VAR_NOINIT";
  reserved ".pad.OS_STACK_OSCORE0_TASK_PRIO51_VAR_NOINIT" (size=16);
}
"_OS_STACK_OSCORE0_TASK_PRIO51_VAR_NOINIT_START" = "_lc_gb_OS_STACK_OSCORE0_TASK_PRIO51_VAR_NOINIT_GROUP";
"_OS_STACK_OSCORE0_TASK_PRIO51_VAR_NOINIT_END" = "_lc_ub__pad_OS_STACK_OSCORE0_TASK_PRIO51_VAR_NOINIT";

/* Stack: OsCore0_Task_Prio52 (1024 Byte) */
group OS_STACK_OSCORE0_TASK_PRIO52_VAR_NOINIT_GROUP(ordered, contiguous, fill, align=8)
{
  select ".bss.OS_STACK_OSCORE0_TASK_PRIO52_VAR_NOINIT";
  reserved ".pad.OS_STACK_OSCORE0_TASK_PRIO52_VAR_NOINIT" (size=16);
}
"_OS_STACK_OSCORE0_TASK_PRIO52_VAR_NOINIT_START" = "_lc_gb_OS_STACK_OSCORE0_TASK_PRIO52_VAR_NOINIT_GROUP";
"_OS_STACK_OSCORE0_TASK_PRIO52_VAR_NOINIT_END" = "_lc_ub__pad_OS_STACK_OSCORE0_TASK_PRIO52_VAR_NOINIT";

/* Stack: OsCore0_Task_Prio53 (1024 Byte) */
group OS_STACK_OSCORE0_TASK_PRIO53_VAR_NOINIT_GROUP(ordered, contiguous, fill, align=8)
{
  select ".bss.OS_STACK_OSCORE0_TASK_PRIO53_VAR_NOINIT";
  reserved ".pad.OS_STACK_OSCORE0_TASK_PRIO53_VAR_NOINIT" (size=16);
}
"_OS_STACK_OSCORE0_TASK_PRIO53_VAR_NOINIT_START" = "_lc_gb_OS_STACK_OSCORE0_TASK_PRIO53_VAR_NOINIT_GROUP";
"_OS_STACK_OSCORE0_TASK_PRIO53_VAR_NOINIT_END" = "_lc_ub__pad_OS_STACK_OSCORE0_TASK_PRIO53_VAR_NOINIT";

/* Stack: OsCore0_Task_Prio54 (1024 Byte) */
group OS_STACK_OSCORE0_TASK_PRIO54_VAR_NOINIT_GROUP(ordered, contiguous, fill, align=8)
{
  select ".bss.OS_STACK_OSCORE0_TASK_PRIO54_VAR_NOINIT";
  reserved ".pad.OS_STACK_OSCORE0_TASK_PRIO54_VAR_NOINIT" (size=16);
}
"_OS_STACK_OSCORE0_TASK_PRIO54_VAR_NOINIT_START" = "_lc_gb_OS_STACK_OSCORE0_TASK_PRIO54_VAR_NOINIT_GROUP";
"_OS_STACK_OSCORE0_TASK_PRIO54_VAR_NOINIT_END" = "_lc_ub__pad_OS_STACK_OSCORE0_TASK_PRIO54_VAR_NOINIT";
...
group OS_STACK_OSCORE0_TASK_PRIO55_VAR_NOINIT_GROUP(ordered, contiguous, fill, align=8)
{
  ...
  reserved ".pad.OS_STACK_OSCORE0_TASK_PRIO55_VAR_NOINIT" (size=16);
}
"_OS_STACK_OSCORE0_TASK_PRIO55_VAR_NOINIT_START" = "_lc_gb_OS_STACK_OSCORE0_TASK_PRIO55_VAR_NOINIT_GROUP";
"_OS_STACK_OSCORE0_TASK_PRIO55_VAR_NOINIT_END" = "_lc_ub__pad_OS_STACK_OSCORE0_TASK_PRIO55_VAR_NOINIT";
...
/* Stack: OsCore0_Task_Prio57 (1024 Byte) */
group OS_STACK_OSCORE0_TASK_PRIO57_VAR_NOINIT_GROUP(ordered, contiguous, fill, align=8)
{
  select ".bss.OS_STACK_OSCORE0_TASK_PRIO57_VAR_NOINIT";
  reserved ".pad.OS_STACK_OSCORE0_TASK_PRIO57_VAR_NOINIT" (size=16);
}
"_OS_STACK_OSCORE0_TASK_PRIO57_VAR_NOINIT_START" = "_lc_gb_OS_STACK_OSCORE0_TASK_PRIO57_VAR_NOINIT_GROUP";
"_OS_STACK_OSCORE0_TASK_PRIO57_VAR_NOINIT_END" = "_lc_ub__pad_OS_STACK_OSCORE0_TASK_PRIO57_VAR_NOINIT";

/* Stack: OsCore0_Task_Prio58 (1024 Byte) */
group OS_STACK_OSCORE0_TASK_PRIO58_VAR_NOINIT_GROUP(ordered, contiguous, fill, align=8)
{
  select ".bss.OS_STACK_OSCORE0_TASK_PRIO58_VAR_NOINIT";
  reserved ".pad.OS_STACK_OSCORE0_TASK_PRIO58_VAR_NOINIT" (size=16);
}
"_OS_STACK_OSCORE0_TASK_PRIO58_VAR_NOINIT_START" = "_lc_gb_OS_STACK_OSCORE0_TASK_PRIO58_VAR_NOINIT_GROUP";
"_OS_STACK_OSCORE0_TASK_PRIO58_VAR_NOINIT_END" = "_lc_ub__pad_OS_STACK_OSCORE0_TASK_PRIO58_VAR_NOINIT";
...
/* Stack: TaskSchM_Core0 (1024 Byte) */
group OS_STACK_TASKSCHM_CORE0_VAR_NOINIT_GROUP(ordered, contiguous, fill, align=8)
{
  select ".bss.OS_STACK_TASKSCHM_CORE0_VAR_NOINIT";
  reserved ".pad.OS_STACK_TASKSCHM_CORE0_VAR_NOINIT" (size=16);
}
"_OS_STACK_TASKSCHM_CORE0_VAR_NOINIT_START" = "_lc_gb_OS_STACK_TASKSCHM_CORE0_VAR_NOINIT_GROUP";
"_OS_STACK_TASKSCHM_CORE0_VAR_NOINIT_END" = "_lc_ub__pad_OS_STACK_TASKSCHM_CORE0_VAR_NOINIT";
