...
/* Event masks */
# define Rte_Ev_Cyclic2_TaskSchM_Core0_0_10ms     ((EventMaskType)1ULL)
# define Rte_Ev_Cyclic2_TaskSchM_Core0_0_20ms     ((EventMaskType)2ULL)
