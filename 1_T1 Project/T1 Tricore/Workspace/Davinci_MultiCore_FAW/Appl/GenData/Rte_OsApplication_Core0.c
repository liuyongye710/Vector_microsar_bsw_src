...
FUNC(void, RTE_CODE) Rte_InitMemory_OsApplication_Core0(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
}
...
/**********************************************************************************************************************
 * Task:     Task1000ms_Core0
 * Priority: 51
 * Schedule: FULL
 * Alarm:    Cycle Time 1 s Alarm Offset 0 s
 *********************************************************************************************************************/
TASK(Task1000ms_Core0) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{

  /* call runnable */
  Runnable1000ms_Core0();

  (void)TerminateTask(); /* PRQA S 3417 */ /* MD_Rte_Os */
} /* PRQA S 6010, 6030, 6050, 6080 */ /* MD_MSR_STPTH, MD_MSR_STCYC, MD_MSR_STCAL, MD_MSR_STMIF */

/**********************************************************************************************************************
 * Task:     Task100ms_Core0
 * Priority: 54
 * Schedule: FULL
 * Alarm:    Cycle Time 0.1 s Alarm Offset 0 s
 *********************************************************************************************************************/
TASK(Task100ms_Core0) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{
 ...
 *********************************************************************************************************************/
TASK(Task10ms_Core0) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{
 ...
 *********************************************************************************************************************/
TASK(Task1ms_Core0) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{
...
/**********************************************************************************************************************
 * Task:     Task200ms_Core0
 * Priority: 53
 * Schedule: FULL
 * Alarm:    Cycle Time 0.2 s Alarm Offset 0 s
 *********************************************************************************************************************/
TASK(Task200ms_Core0) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{
 ...
 *********************************************************************************************************************/
TASK(Task20ms_Core0) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{
...
/**********************************************************************************************************************
 * Task:     Task500ms_Core0
 * Priority: 52
 * Schedule: FULL
 * Alarm:    Cycle Time 0.5 s Alarm Offset 0 s
 *********************************************************************************************************************/
TASK(Task500ms_Core0) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{
 ...
 *********************************************************************************************************************/
TASK(Task50ms_Core0) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{
 ...
 *********************************************************************************************************************/
TASK(Task5ms_Core0) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{
 ...
 * Schedule: FULL
 *********************************************************************************************************************/
TASK(TaskSchM_Core0) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{
  EventMaskType ev;

  for(;;)
  {
    (void)WaitEvent(Rte_Ev_Cyclic2_TaskSchM_Core0_0_10ms | Rte_Ev_Cyclic2_TaskSchM_Core0_0_20ms); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)GetEvent(TaskSchM_Core0, &ev); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)ClearEvent(ev & (Rte_Ev_Cyclic2_TaskSchM_Core0_0_10ms | Rte_Ev_Cyclic2_TaskSchM_Core0_0_20ms)); /* PRQA S 3417 */ /* MD_Rte_Os */

    if ((ev & Rte_Ev_Cyclic2_TaskSchM_Core0_0_10ms) != (EventMaskType)0)
    {
      /* call runnable */
      BswM_MainFunction();
    ...
    if ((ev & Rte_Ev_Cyclic2_TaskSchM_Core0_0_20ms) != (EventMaskType)0)
    {
      /* call runnable */
      ComM_MainFunction_0();
    }
