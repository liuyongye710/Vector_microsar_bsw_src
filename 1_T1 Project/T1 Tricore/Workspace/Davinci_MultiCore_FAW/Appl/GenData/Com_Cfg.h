 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: Com_Cfg.h
 *   Generation Time: 2020-07-28 16:47:23
...
#endif
#ifndef COM_PROCESSOR_TC297
#define COM_PROCESSOR_TC297
#endif
...
#define COM_TXMODETRUEUSEDOFTXMODEINFO                                STD_OFF  /**< Deactivateable: 'Com_TxModeInfo.TxModeTrueUsed' Reason: 'All indirection targets are deactivated in all variants.' */
...
#define ComConf_ComSignal_New_Signal_7_oT1_RxMsg_oCAN00_8f249b77_Rx   0
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define ComConf_ComSignal_New_Signal_6_oT1_TxMsg_oCAN00_8f4b8876_Tx   0
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define ComConf_ComIPduGroup_iECU_oCAN00_Rx_a30130d6                  0
#define ComConf_ComIPduGroup_iECU_oCAN00_Tx_f55b9750                  1
/**\} */
...
#define Com_GetSizeOfRxSigBufferSInt8OfPCConfig()                     1U  /**< the number of accomplishable value elements in Com_RxSigBufferSInt8 */
...
#define Com_GetApplTypeOfRxAccessInfo(Index)                          ((Com_ApplTypeOfRxAccessInfoType)(((Index) + 0x01U)))  /**< Application data type. */
#define Com_GetBitLengthOfRxAccessInfo(Index)                         ((Com_BitLengthOfRxAccessInfoType)(((Index) + 8U)))  /**< Bit length of the signal or group signal. */
...
#define Com_GetBusAccOfRxAccessInfo(Index)                            ((Com_BusAccOfRxAccessInfoType)(((Index) + 0x01U)))  /**< BUS access algorithm for signal or group signal packing / un-packing. */
...
#define Com_GetRxAccessInfoIndEndIdxOfRxPduInfo(Index)                ((Com_RxAccessInfoIndEndIdxOfRxPduInfoType)(((Index) + 1U)))  /**< the end index of the 0:n relation pointing to Com_RxAccessInfoInd */
...
#define Com_GetRxDefPduBufferEndIdxOfRxPduInfo(Index)                 ((Com_RxDefPduBufferEndIdxOfRxPduInfoType)(((Index) + 8U)))  /**< the end index of the 0:n relation pointing to Com_RxDefPduBuffer */
#define Com_GetRxDefPduBufferLengthOfRxPduInfo(Index)                 ((Com_RxDefPduBufferLengthOfRxPduInfoType)(((Index) + 8U)))  /**< the number of relations pointing to Com_RxDefPduBuffer */
...
#define Com_IsRxPduCalloutFuncPtrUsedOfRxPduInfo(Index)               Com_IsRxAccessInfoIndUsedOfRxPduInfo(Index)  /**< TRUE, if the 0:1 relation has minimum 1 relation pointing to Com_RxPduCalloutFuncPtr */
#define Com_GetRxSigInfoEndIdxOfRxPduInfo(Index)                      ((Com_RxSigInfoEndIdxOfRxPduInfoType)(((Index) + 1U)))  /**< the end index of the 0:n relation pointing to Com_RxSigInfo */
...
#define Com_GetValidDlcOfRxSigInfo(Index)                             ((Com_ValidDlcOfRxSigInfoType)(((Index) + 1U)))  /**< Minimum length of PDU required to completely receive the signal or signal group. */
...
#define Com_GetPduWithMetaDataLengthOfTxPduInfo(Index)                ((Com_PduWithMetaDataLengthOfTxPduInfoType)(((Index) + 8U)))  /**< Length of Pdu with MetaData. */
...
#define Com_GetTxBufferLengthOfTxPduInfo(Index)                       ((Com_TxBufferLengthOfTxPduInfoType)(((Index) + 8U)))  /**< the number of relations pointing to Com_TxBuffer */
...
#define Com_GetApplTypeOfTxSigInfo(Index)                             ((Com_ApplTypeOfTxSigInfoType)(((Index) + 0x01U)))  /**< Application data type. */
#define Com_GetBitLengthOfTxSigInfo(Index)                            ((Com_BitLengthOfTxSigInfoType)(((Index) + 8U)))  /**< Bit length of the signal or group signal. */
...
#define Com_GetBusAccOfTxSigInfo(Index)                               ((Com_BusAccOfTxSigInfoType)(((Index) + 0x01U)))  /**< BUS access algorithm for signal or group signal packing / un-packing. */
#define Com_GetByteLengthOfTxSigInfo(Index)                           ((Com_ByteLengthOfTxSigInfoType)(((Index) + 1U)))  /**< Byte length of the signal or group signal. */
...
{
  Com_HandleRxPduDeferredType T1_RxMsg_oCAN00_c2c93374_Rx[1];
...
{
  Com_RxDefPduBufferType T1_RxMsg_oCAN00_c2c93374_Rx[8];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern VAR(Com_RxSigBufferSInt8Type, COM_VAR_NOINIT) Com_RxSigBufferSInt8[1];
#define COM_STOP_SEC_VAR_NOINIT_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
