  ...
  )
{
  ...
  {
    lRetValue = (boolean)(Dem_Cfg_GetEventMemoryEntryStorageTriggerOfMemoryInfoTable(Dem_Cfg_EventDestination(EventId)) == DEM_MEMORY_STORAGE_TRIGGER_CONFIRMED);
  }
  else
  {
    /* This function should not be called for internal events */
    Dem_Internal_AssertAlways(DEM_E_INCONSISTENT_STATE);
  }
  return lRetValue;
}
  ...
  )
{
  ...
  if (Dem_Cfg_EventUdsDtc(EventId) != DEM_CFG_DTC_UDS_INVALID)
  {
    lRetValue = (boolean)(Dem_Cfg_GetEventMemoryEntryStorageTriggerOfMemoryInfoTable(Dem_Cfg_EventDestination(EventId)) == DEM_MEMORY_STORAGE_TRIGGER_FAILED);
  }
  else
  {
    /* This function should not be called for internal events */
  ...
  )
{
  ...
  if (Dem_Cfg_EventUdsDtc(EventId) != DEM_CFG_DTC_UDS_INVALID)
  {
    lRetValue = (boolean)(Dem_Cfg_GetEventMemoryEntryStorageTriggerOfMemoryInfoTable(Dem_Cfg_EventDestination(EventId)) == DEM_MEMORY_STORAGE_TRIGGER_PENDING);
  }
  else
  {
    /* This function should not be called for internal events */
  ...
  )
{
  ...
  if (Dem_Cfg_EventUdsDtc(EventId) != DEM_CFG_DTC_UDS_INVALID)
  {
    lRetValue = (boolean)(Dem_Cfg_GetEventMemoryEntryStorageTriggerOfMemoryInfoTable(Dem_Cfg_EventDestination(EventId)) == DEM_MEMORY_STORAGE_TRIGGER_FDC);
  }
  else
  {
    /* This function should not be called for internal events */
...
)
{
  ...
  if (Dem_Cfg_EventUdsDtc(EventId) != DEM_CFG_DTC_UDS_INVALID)
  {
    lRetValue = (boolean)((DtcEffects & Dem_Cfg_GetEventMemoryEntryStorageTriggerOfMemoryInfoTable(Dem_Cfg_EventDestination(EventId))) != 0u);
  }
  else
  {
    /* This function should not be called for internal events */
