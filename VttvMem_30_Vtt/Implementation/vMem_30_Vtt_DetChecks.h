 ...
 *  FILE DESCRIPTION
 *  ------------------------------------------------------------------------------------------------------------------*/
/*!        \file  vMem_30_Vtt_DetChecks.h
 *        \brief  Header file for declaration of DET checks functions for vMem_30_Vtt.
 *      \details  Provides the declarations for DET check functions of API parameters. These checks may be useful for
 *                hardware specific services for all subcomponents of vMem_30_Vtt.
 *********************************************************************************************************************/
 ...
 **********************************************************************************************************************/
#if !defined (VMEM_30_VTT_DETCHECKS_H)
# define VMEM_30_VTT_DETCHECKS_H
 ...
 * \details     -
 * \param[in]   InstanceId       id equal to index of the related vMem_30_Vtt instance in configuration structure.
 ...
 * \details     Calls LowLevel GetJobResult service, to retrieve current state of vMem_30_Vtt instance.
 * \param[in]   InstanceId        Id of vMem_30_Vtt instance is passed on to LowLevel, must be valid.
 ...
 * \synchronous TRUE
 */
FUNC(boolean, VMEM_30_VTT_CODE) vMem_30_Vtt_IsBlankLengthCheck(vMem_30_Vtt_InstanceIdType InstanceId, vMem_30_Vtt_AddressType Address, vMem_30_Vtt_LengthType Length);
 ...
 * \synchronous TRUE
 */
FUNC(boolean, VMEM_30_VTT_CODE) vMem_30_Vtt_EraseLengthCheck(vMem_30_Vtt_InstanceIdType InstanceId, vMem_30_Vtt_AddressType Address, vMem_30_Vtt_LengthType Length);
/**********************************************************************************************************************
...
#endif /* VMEM_30_VTT_DETCHECKS_H */
/**********************************************************************************************************************
 *  END OF FILE: vMem_30_Vtt_DetChecks.h
 *********************************************************************************************************************/
